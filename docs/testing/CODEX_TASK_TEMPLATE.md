...
- Само сжатие не разрешает commit/push, удаление файлов или новые worktrees.
  ...
  основная задача заменяется свежей в том же проекте по `docs/testing/SESSION_ROLLOVER.md`.
...
`docs/testing/SESSION_ROLLOVER.md`. Адаптер сам не читает историю, не пишет файлы,
