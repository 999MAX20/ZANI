...
>
> Original path: `docs/product/competitive-regression-report.md`. Source: `4ba3cbf9fddcc6e1baa172b494c781550c090693`.
> Майский аудит и проценты готовности устарели; повторяют уже реализованные automations, entitlements, quotas и QA. Не весь конкурентный wishlist принят в pilot scope.
