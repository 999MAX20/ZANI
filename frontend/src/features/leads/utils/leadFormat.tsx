...
import { sourceLabels, statusLabels, type LeadAiInsight, type Translate } from "../types";
...
export function leadTitle(lead: Lead | null | undefined, clients: Client[], t: Translate) {
