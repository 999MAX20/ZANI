export const ru: Record<string, string> = {
  ...
  "actions.errorValidation": "Проверьте поля и повторите действие. {detail}",
  ...
  "actions.errorConflict": "Запись изменилась во время работы. Обновите данные и повторите действие. {detail}",
