...
CORS_ALLOW_CREDENTIALS = env("CORS_ALLOW_CREDENTIALS") or IS_PRODUCTION_LIKE_ENVIRONMENT
...
JWT_REFRESH_COOKIE_NAME = env("JWT_REFRESH_COOKIE_NAME", default="zani_refresh_token")
JWT_REFRESH_COOKIE_PATH = env("JWT_REFRESH_COOKIE_PATH", default="/api/auth/token/refresh/")
JWT_REFRESH_COOKIE_SAMESITE = env(
    "JWT_REFRESH_COOKIE_SAMESITE",
    default="None" if IS_PRODUCTION_LIKE_ENVIRONMENT else "Lax",
)
JWT_REFRESH_COOKIE_SECURE = env.bool("JWT_REFRESH_COOKIE_SECURE", default=IS_PRODUCTION_LIKE_ENVIRONMENT)
JWT_EXPOSE_REFRESH_TOKEN = env.bool("JWT_EXPOSE_REFRESH_TOKEN", default=False)
