...
const ru: Dictionary = {
  ...
  "integrations.telegram.webhook": "Webhook",
  "integrations.telegram.webhookConfigured": "Webhook подготовлен",
  ...
  "integrations.telegram.betaNotice": "Реальный Telegram-трафик включается только после webhook secret, очередей и мониторинга. Сейчас подключение безопасно работает как beta foundation.",
...
const kk: Dictionary = {
  ...
  "integrations.telegram.webhook": "Webhook",
  "integrations.telegram.webhookConfigured": "Webhook дайын",
  ...
  "integrations.telegram.betaNotice": "Нақты Telegram трафигі webhook secret, кезектер және мониторинг дайын болғаннан кейін ғана қосылады. Қазір қосылым қауіпсіз beta foundation ретінде жұмыс істейді.",
  ...
  "integrations.request.saved": "Өтінім сақталды. Платформа қолдауы оны қосылу өтінімі ретінде көреді.",
...
const en: Dictionary = {
  ...
  "integrations.telegram.webhook": "Webhook",
  "integrations.telegram.webhookConfigured": "Webhook prepared",
  ...
  "integrations.telegram.betaNotice": "Real Telegram traffic is enabled only after webhook secret, queues and monitoring are ready. For now this connection works safely as a beta foundation.",
