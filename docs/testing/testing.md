...
Use only the canonical source folder named in AGENTS.md, with one repository-wide
writer. Isolate test databases, loopback ports and worker queues, not source edits.
