...
export const en: Record<string, string> = {
  ...
  "auth.signInAppCopy": "Sign in to your workspace and continue managing leads, clients, bots and sales.",
  "auth.emailDivider": "or sign in with email",
  "auth.emailPlaceholder": "Enter your email",
  "auth.passwordPlaceholder": "Enter your password",
  "auth.backToSite": "Back to site",
  "auth.brandTagline": "Business runs itself",
  "auth.alreadyHaveAccount": "Already have an account?",
  "auth.noAccount": "No account?",
  "auth.create": "Create",
  "auth.heroAria": "ZANI capabilities",
  "auth.signupHeroPrefix": "Your business starts working in",
  "auth.signupHeroTime": "2 minutes",
  "auth.loginHeroPrefix": "Return to business control in",
  "auth.loginHeroTime": "1 minute",
  "auth.signupHeroText": "Create an account and get CRM, AI bots, marketplaces, outreach and analytics in one system.",
  "auth.loginHeroText": "Open the workspace and continue sales, bookings, outreach and team control without extra switching.",
  "auth.featureCrmTitle": "Free CRM",
  "auth.featureCrmText": "Full access to core features",
  "auth.featureAiTitle": "AI assistant",
  "auth.featureAiText": "Analyzes and suggests next steps",
  "auth.featureBotsTitle": "Bots and outreach",
  "auth.featureBotsText": "Reply, book and sell",
  "auth.featureIntegrationsTitle": "Marketplaces and integrations",
  "auth.featureIntegrationsText": "Kaspi, Wildberries, Ozon and more",
  "auth.proofText": "CRM, tasks and channels work in one workspace",
  "auth.trustSecurity": "Your data is protected",
  "auth.trustServers": "Servers in Kazakhstan",
  "auth.previewWelcome": "Welcome, Atlas Dental",
  "auth.previewScanned": "AI has already scanned the inbox",
  "auth.previewNewLeads": "New leads",
  "auth.previewBookings": "Bookings today",
  "auth.previewRevenue": "Revenue",
  "auth.previewPipeline": "Sales pipeline",
  "auth.previewAiTip": "AI recommends launching a campaign at 15:00",
  "auth.previewConversion": "Conversion is growing for the third week",
  ...
  "signup.progressAria": "Registration steps",
  "signup.accountStep": "Account",
  "signup.businessStep": "Business",
  ...
  "signup.createCompanyTitle": "Create company",
  "signup.createCompanyText": "Start free. No card, no specialists, setup takes a couple of minutes.",
  "signup.passwordMinCheck": "Min. 8 characters",
  "signup.passwordLettersNumbersCheck": "Letters and numbers",
  "signup.passwordNoSpacesCheck": "No spaces",
  "signup.namePlaceholder": "For example: Maksim",
  "signup.passwordPlaceholder": "Create a password",
  "signup.businessNamePlaceholder": "For example: Atlas Dental",
  "signup.cityPlaceholder": "Almaty",
  "signup.afterSignInHelper": "After sign-in, add employees and connect channels. Tap connect, authorize, and the system starts working.",
  "signup.freeSubmit": "Create company for free",
  "signup.terms": "By clicking “Create company”, you agree to the terms of use and privacy policy.",
  ...
  "clients.priorityLow": "Low",
  "clients.priorityNormal": "Normal",
  "clients.priorityHigh": "High",
  "clients.priorityUrgent": "Urgent",
  "clients.lastContact": "Last contact",
  "clients.managerNumber": "Manager {id}",
  "clients.unassigned": "Unassigned",
  "clients.selectClient": "Select {name}",
  "clients.tableScrollArea": "Clients table scroll area",
  "clients.tableAria": "Client list",
  ...
  "clients.advanced": "Advanced",
  "clients.filtersAria": "Client filters",
  "clients.clearSearch": "Clear search",
  "clients.noDealsYet": "No deals yet.",
  "clients.noDueDate": "No due date",
  "clients.noFilesYet": "No files added yet.",
  "clients.outboundContact": "Outbound contact",
  "clients.inboundContact": "Inbound contact",
  "clients.favorite": "Favorite",
  "clients.dealsCount": "Deals {count}",
  "clients.tasksCount": "Tasks {count}",
  "clients.files": "Files",
  "clients.contacts": "Contacts",
  "clients.latestDeal": "Latest deal",
  "clients.negotiations": "Negotiation",
  "clients.noDealsOpenValue": "No deals yet. Open: {value}",
  "clients.nextTask": "Next task",
  "clients.viewAll": "View all",
  "clients.aiHintTitle": "AI hint",
  "clients.aiHintActive": "The client has already interacted with CRM. Check the next step and contact.",
  "clients.aiHintInactive": "The client has not received an offer for a while. Contact today is recommended.",
  "clients.contactNow": "Contact now",
  ...
  "tasks.noLinkedEntities": "The task is not linked to a client, lead, deal or booking yet.",
  "tasks.dates": "Dates",
  ...
  "conversations.emptyText": "Connect WhatsApp, Telegram, Instagram, or website chat. New inquiries will appear here automatically.",
  "conversations.connectChannel": "Connect a channel",
  ...
  "analytics.label.business": "Business",
  "analytics.label.estimate_from_completed_appointments": "Estimate from completed bookings",
  "analytics.label.tracked_without_cost": "Tracked without cost",
  "analytics.label.website": "Website",
  "analytics.label.manual": "Manual",
  "analytics.label.landing": "Landing",
  ...
  "settings.planChangeRequested": "Plan change requested #{id}",
  "settings.pauseSubscription": "Pause",
  "settings.resumeSubscription": "Resume",
  "settings.cancelSubscription": "Cancel",
  "settings.invoicesAndPayments": "Invoices and payment",
  "settings.paymentMethod": "Payment method",
  "settings.paymentMethodNone": "Not selected",
  "settings.paymentMethodInvoice": "Invoice",
  "settings.paymentMethodCard": "Bank card",
  "settings.paymentMethodBankTransfer": "Bank transfer",
  "settings.invoiceRecipient": "Invoice recipient",
  ...
  "businessForm.language": "Business language",
  "businessForm.currency": "Currency",
  "businessForm.slaMinutes": "Response SLA, minutes",
  "businessForm.legalName": "Legal name",
  "businessForm.taxId": "Tax ID",
  "businessForm.invoiceEmail": "Invoice email",
  "businessForm.bookingBufferMinutes": "Booking buffer, minutes",
  "businessForm.brandColor": "Brand color",
  "businessForm.logoUrl": "Logo URL",
  "businessForm.cancellationPolicy": "Cancellation policy",
  "businessForm.prepaymentPolicy": "Prepayment and payment",
  ...
  "aiNavigator.source.sale.recorded": "Sale recorded",
  "aiNavigator.source.excel_csv.sale.recorded": "Excel/CSV · sale",
  "aiNavigator.source.excel_csv.channel_connected": "Excel/CSV channel connected",
  "aiNavigator.source.website.channel_connected": "Website channel connected",
  "aiNavigator.source.telegram.channel_ready_for_setup": "Telegram ready for setup",
  "aiNavigator.source.whatsapp.channel_ready_for_setup": "WhatsApp ready for setup",
  ...
  "automations.trigger.botMessageReceived": "New bot message",
  ...
  "deals.noPipelineTitle": "Set up your first pipeline",
  "deals.noPipeline": "ZANI will create a clear sales flow: new deal, contact, proposal, won or lost.",
  "deals.createPipeline": "Create standard pipeline",
  "deals.defaultPipelineName": "Core sales",
  "deals.pipelineStageNew": "New",
  "deals.pipelineStageContact": "Contacted",
  "deals.pipelineStageProposal": "Proposal",
  "deals.pipelineStageWon": "Won",
  "deals.pipelineStageLost": "Lost",
  "deals.pipelineCreated": "Pipeline created. You can add deals now.",
  ...
  "deals.aiSuggestion": "AI suggestion",
  ...
  "timeline.category.appointment": "Booking",
  "timeline.category.task": "Task",
  "timeline.category.automation": "Automation",
  "timeline.category.system": "System",
  "timeline.category.crm": "CRM",
  "timeline.eventType.deal_stage_changed": "Deal stage changed",
  "timeline.eventType.task_comment_added": "Task comment added",
  "timeline.eventType.task_reopened": "Task reopened",
  "timeline.eventType.task_cancelled": "Task cancelled",
  "timeline.eventType.task_completed": "Task completed",
  "timeline.eventType.task_created": "Task created",
  "timeline.eventType.task_updated": "Task updated",
  "timeline.eventType.lead_created": "Lead created",
  "timeline.eventType.appointment_created": "Booking created",
  "timeline.eventType.appointment_rescheduled": "Booking rescheduled",
  "timeline.eventType.message_received": "Message received",
  "timeline.eventType.message_sent": "Message sent",
  "timeline.eventType.bot_message_received": "Bot message received",
  ...
  "landing.experience.nav.top": "Home",
  "landing.experience.nav.pain": "Problem",
  "landing.experience.nav.agent": "AI agent",
  "landing.experience.nav.crm": "CRM",
  "landing.experience.nav.marketplace": "Marketplaces",
  "landing.experience.nav.ecosystem": "Ecosystem",
  "landing.experience.nav.owner": "Owner",
  "landing.experience.nav.integrations": "Integrations",
  "landing.experience.nav.proof": "Cases",
  "landing.experience.nav.cta": "Start",
  "landing.experience.nav.aria": "Main sections",
  "landing.experience.login": "Sign in",
  "landing.experience.tryFree": "Try for free",
  "landing.experience.getCrmFree": "Get CRM free",
  "landing.experience.watchHow": "See how it works",
  "landing.experience.today": "Today",
  "landing.experience.person.anna": "Anna Smirnova",
  "landing.experience.channel.whatsapp": "New client",
  "landing.experience.channel.instagram": "Please reply",
  "landing.experience.channel.telegram": "Booking question",
  "landing.experience.channel.kaspi": "New question",
  "landing.experience.channel.ai": "Answers 24/7",
  "landing.experience.channel.crm": "Card created",
  "landing.experience.channel.reply": "in 4 seconds",
  "landing.experience.channel.lead": "Anna Smirnova, 16:30",
  ...
  "landing.experience.phone.inbox.instagram": "Hello! I want to book today.",
  "landing.experience.phone.inbox.telegram": "Hi! Is there time today?",
  "landing.experience.phone.inbox.kaspi": "New buyer question",
  "landing.experience.phone.online": "online",
  "landing.experience.phone.chat.client1": "Hello! Can I book today?",
  "landing.experience.phone.chat.bot1": "Hello. Today we have 16:30 and 18:00. Which works for you?",
  "landing.experience.phone.chat.client2": "16:30 works",
  "landing.experience.phone.chat.bot2": "Done. You are booked for 16:30. A reminder will arrive one hour before.",
  "landing.experience.phone.chat.input": "Message...",
  "landing.experience.phone.dashboard.recommendation": "AI recommendation",
  "landing.experience.phone.dashboard.action": "Launch campaign at 15:00",
  "landing.experience.heroFlow.leadTitle": "New lead",
  "landing.experience.heroFlow.leadText": "Anna Smirnova",
  "landing.experience.heroFlow.bookingTitle": "Booking created",
  "landing.experience.heroFlow.bookingText": "Today · 16:30",
  "landing.experience.heroFlow.channelsAria": "Choose a channel for the scenario",
  "landing.experience.heroFlow.status.waiting": "Waiting for a client message",
  "landing.experience.heroFlow.status.message": "Message received",
  "landing.experience.heroFlow.status.replied": "ZANI replied",
  "landing.experience.heroFlow.status.lead": "Lead created in CRM",
  "landing.experience.heroFlow.status.time": "Client selected a time",
  "landing.experience.heroFlow.status.booked": "Booking confirmed for 16:30",
  "landing.demo.kicker": "Try it yourself",
  "landing.demo.title": "Message the bot. Watch the CRM build itself",
  "landing.demo.text": "One short scenario shows how ZANI replies, books the customer and hands a ready task to the team.",
  "landing.demo.mode.aria": "Demo mode",
  "landing.demo.mode.guided": "Show me",
  "landing.demo.mode.manual": "I'll try",
  "landing.demo.chat.aria": "Demo conversation with ZANI bot",
  "landing.demo.chat.welcome": "Hello! I will help you choose a time and book your visit.",
  "landing.demo.chat.client": "I would like to book a consultation today.",
  "landing.demo.chat.slots": "Today we have 16:30 and 18:00 available. Which works for you?",
  "landing.demo.chat.confirmed": "Done. Your booking is created and a reminder will arrive one hour before.",
  "landing.demo.chat.typing": "ZANI is typing",
  "landing.demo.chat.quickAppointment": "Book today",
  "landing.demo.chat.quickPrice": "Check the price",
  "landing.demo.chat.guidedHint": "Watch how ZANI works",
  "landing.demo.chat.greetingReply": "Hello! Choose a ready question below or tell us what you need.",
  "landing.demo.chat.priceReply": "The price depends on the service. Choose booking in the demo to see the full path into CRM.",
  "landing.demo.chat.unknownReply": "This is a demonstration dialogue for now. Choose a ready option below to see the CRM workflow.",
  "landing.demo.transfer": "data is already in CRM",
  "landing.demo.crm.aria": "Interactive ZANI CRM demo",
  "landing.demo.crm.live": "updates instantly",
  "landing.demo.crm.ready": "card is ready",
  "landing.demo.crm.waiting": "waiting for a message",
  "landing.demo.crm.client": "Customer",
  "landing.demo.crm.newClient": "New customer",
  "landing.demo.crm.request": "Request",
  "landing.demo.crm.consultation": "Consultation",
  "landing.demo.crm.appointment": "Booking",
  "landing.demo.crm.todayTime": "Today, 16:30",
  "landing.demo.crm.responsible": "Owner",
  "landing.demo.crm.manager": "Alex",
  "landing.demo.crm.notAssigned": "Not assigned",
  "landing.demo.crm.stage": "Sales stage",
  "landing.demo.crm.stageNew": "New",
  "landing.demo.crm.stageWork": "In progress",
  "landing.demo.crm.stageBooked": "Booked",
  "landing.demo.crm.assign": "Assign Alex",
  "landing.demo.crm.assigned": "Alex assigned",
  "landing.demo.crm.createTask": "Create task",
  "landing.demo.crm.taskReady": "Task created",
  "landing.demo.result.client": "New customer",
  "landing.demo.result.appointment": "Booking time",
  "landing.demo.result.value": "Expected value",
  "landing.demo.result.progress": "ZANI builds the result as the conversation develops",
  "landing.demo.result.complete": "Customer booked. The team received a task",
  "landing.demo.result.ownerTitle": "Owner result",
  "landing.demo.result.progressTitle": "Scenario in progress",
  "landing.demo.repeat": "Run again",
  "landing.demo.scenario.aria": "Business type for the demo",
  "landing.demo.scenario.label": "Show an example for",
  "landing.demo.privacy": "The demo does not send or save anything",
  "landing.demo.scenario.beauty.welcome": "Hello! I will help you choose a service and a convenient time.",
  "landing.demo.scenario.beauty.client": "I would like to book a manicure today.",
  "landing.demo.scenario.beauty.slots": "Manicure is available today at 16:30 and 18:00. Which time works?",
  "landing.demo.scenario.beauty.confirmed": "Done. Your manicure is booked and a reminder will arrive one hour before.",
  "landing.demo.scenario.beauty.name": "Anna Smirnova",
  "landing.demo.scenario.beauty.request": "Manicure",
  "landing.demo.scenario.beauty.manager": "Marina",
  "landing.demo.scenario.beauty.time1": "Today, 16:30",
  "landing.demo.scenario.beauty.time2": "Today, 18:00",
  "landing.demo.scenario.medical.welcome": "Hello! I will clarify the specialty and find a doctor's time.",
  "landing.demo.scenario.medical.client": "I need a dentist consultation.",
  "landing.demo.scenario.medical.slots": "The dentist is available today at 18:00 and tomorrow at 10:30. Which time works?",
  "landing.demo.scenario.medical.confirmed": "Your visit is confirmed. We will send a short reminder before it.",
  "landing.demo.scenario.medical.name": "Dmitry Kim",
  "landing.demo.scenario.medical.request": "Dentist consultation",
  "landing.demo.scenario.medical.manager": "Aigul",
  "landing.demo.scenario.medical.time1": "Today, 18:00",
  "landing.demo.scenario.medical.time2": "Tomorrow, 10:30",
  "landing.demo.scenario.services.welcome": "Hello! I will clarify the job and find an available technician.",
  "landing.demo.scenario.services.client": "I need an air conditioner installed.",
  "landing.demo.scenario.services.slots": "A technician can come tomorrow at 11:00 or 15:00. Which time works?",
  "landing.demo.scenario.services.confirmed": "The visit is scheduled. The technician received the address and task.",
  "landing.demo.scenario.services.name": "Maxim Orlov",
  "landing.demo.scenario.services.request": "Air conditioner installation",
  "landing.demo.scenario.services.manager": "Alex",
  "landing.demo.scenario.services.time1": "Tomorrow, 11:00",
  "landing.demo.scenario.services.time2": "Tomorrow, 15:00",
  "landing.demo.hint.message": "Write a message or choose a ready option",
  "landing.demo.hint.time": "Choose a convenient time",
  "landing.demo.hint.assign": "Assign a team member",
  "landing.demo.hint.task": "Create a task for the team",
  "landing.demo.hint.complete": "Done: the owner can see the result",
  "landing.demo.guide.play": "Continue the tour",
  "landing.demo.guide.pause": "Pause the tour",
  "landing.demo.guide.next": "Next step",
  "landing.demo.mobileTabs.aria": "Demo screens",
  "landing.demo.mobileTabs.chat": "Chat",
  "landing.demo.mobileTabs.crm": "CRM",
  "landing.demo.mobileTabs.result": "Result",
  "landing.demo.ai.live": "Answer generated by AI in the demo environment",
  "landing.demo.ai.fallback": "Safe demonstration response",
  "landing.demo.cta": "Create a free CRM",
  "landing.demo.proof.title": "What you have just seen",
  "landing.demo.proof.text": "No growth promises or decorative numbers. Only capabilities shown in the demo.",
  "landing.demo.proof.bot": "The bot is always available",
  "landing.demo.proof.botText": "The conversation continues even while the administrator is busy.",
  "landing.demo.proof.noCodeValue": "No code",
  "landing.demo.proof.noCode": "Fast launch",
  "landing.demo.proof.noCodeText": "A basic connection does not require a developer or integrator.",
  "landing.demo.proof.freeCrm": "Free CRM",
  "landing.demo.proof.freeCrmText": "Customers, deals, tasks and the team are available in the core CRM.",
  "landing.experience.metric.leads": "leads",
  "landing.experience.metric.records": "bookings",
  "landing.experience.metric.newLeads": "new leads",
  "landing.experience.metric.deals": "deals",
  "landing.experience.metric.revenue": "revenue",
  "landing.experience.metric.channels": "channels",
  "landing.experience.metric.connected": "connected",
  "landing.experience.metric.requestsProcessed": "requests processed",
  "landing.experience.metric.teamOnline": "team online",
  "landing.experience.metric.working": "working",
  "landing.experience.metric.profitToday": "profit today",
  "landing.experience.hero.kicker": "For owners and teams",
  "landing.experience.hero.titlePrefix": "Clients message. ZANI takes them",
  "landing.experience.hero.titleLine1": "Clients message.",
  "landing.experience.hero.titleLine2": "ZANI takes them",
  "landing.experience.hero.titleAccent": "to a booking",
  "landing.experience.hero.note": "while the team is busy",
  "landing.experience.hero.tryMessage": "Try with your own message",
  "landing.experience.hero.text": "ZANI collects requests from WhatsApp, Instagram, Telegram, Kaspi and the website, helps reply on time and shows the owner the picture of the day.",
  "landing.experience.hero.proof": "More than 14,000 companies already grow with ZANI",
  "landing.experience.pain.kicker": "Problem",
  "landing.experience.pain.title": "Clients leave not because of price",
  "landing.experience.pain.text": "While the team switches between messengers, calls and spreadsheets, the client already gets an answer somewhere else.",
  "landing.experience.pain.story.client": "Client wrote",
  "landing.experience.pain.story.noAnswer": "No answer",
  "landing.experience.pain.story.competitor": "Chose a competitor",
  "landing.experience.pain.story.money": "Money left",
  "landing.experience.pain.zani": "ZANI replies before the client cools down",
  "landing.experience.pain.compact.timer": "without a reply",
  "landing.experience.pain.compact.text": "The client does not wait — they keep searching.",
  "landing.experience.pain.compact.action": "See ZANI reply",
  "landing.experience.pain.calendar.record": "10:00 Booking: Anna",
  "landing.experience.pain.calendar.meeting": "11:30 Meeting",
  "landing.experience.pain.calendar.callback": "14:00 Call client back",
  "landing.experience.pain.calendar.consult": "16:30 Consultation",
  "landing.experience.pain.note": "Nothing forgotten!",
  "landing.experience.pain.channelsAria": "Channels where requests get lost",
  "landing.experience.agent.kicker": "AI agent",
  "landing.experience.agent.title": "AI brings the client to booking",
  "landing.experience.agent.text": "ZANI does not just answer. It clarifies, offers time, saves the contact and gives the team a ready result.",
  "landing.experience.agent.ability.reply": "Replied instantly",
  "landing.experience.agent.ability.replyText": "the client does not wait for a manager",
  "landing.experience.agent.ability.details": "Clarified details",
  "landing.experience.agent.ability.detailsText": "service, time and contact in the dialog",
  "landing.experience.agent.ability.record": "Created booking",
  "landing.experience.agent.ability.recordText": "visit and reminder appeared automatically",
  "landing.experience.agent.ability.return": "Brought client back",
  "landing.experience.agent.ability.returnText": "asks for review and offers the next step",
  "landing.experience.agent.cardCreated": "New booking created",
  "landing.experience.agent.cardTime": "Today, 16:30 · Consultation",
  "landing.experience.agent.openCard": "Open card",
  "landing.experience.agent.dialog.clientStart": "Hi! I want to book a consultation today.",
  "landing.experience.agent.dialog.botSlots": "Hello. Today we have 16:30 and 18:00 available. Which time works better?",
  "landing.experience.agent.dialog.clientTime": "16:30 works",
  "landing.experience.agent.dialog.botContact": "Great. Please send a phone number to confirm the booking.",
  "landing.experience.agent.dialog.clientPhone": "+7 777 418 22 10",
  "landing.experience.agent.dialog.botBooked": "Anna, you are booked for 16:30. A reminder will arrive one hour before.",
  "landing.experience.agent.dialog.autoReminder": "Auto: reminder will be sent at 15:30",
  "landing.experience.agent.dialog.autoCampaign": "Auto: after the visit, review request + next booking offer will be sent",
  "landing.experience.agent.modal.close": "Close client card",
  "landing.experience.agent.modal.status": "Client card opened",
  "landing.experience.agent.modal.contact": "Contact",
  "landing.experience.agent.modal.source": "Source",
  "landing.experience.agent.modal.automation": "Automation",
  "landing.experience.agent.modal.automationText": "Reminder one hour before, review after visit, repeat booking in 21 days.",
  "landing.experience.agent.modal.next": "Next step",
  "landing.experience.agent.modal.nextText": "The manager sees the ready booking and full dialog history.",
  "landing.experience.crm.title": "CRM appears automatically",
  "landing.experience.crm.text": "The manager does not transfer data by hand. A message becomes a client, deal, task and booking in one workspace.",
  "landing.experience.crm.flow.message": "Message",
  "landing.experience.crm.flow.client": "Client",
  "landing.experience.crm.flow.deal": "Deal",
  "landing.experience.crm.flow.task": "Task",
  "landing.experience.crm.flow.calendar": "Calendar",
  "landing.experience.crm.flow.payment": "Payment",
  "landing.experience.crm.sidebar.home": "Home",
  "landing.experience.crm.sidebar.clients": "Clients",
  "landing.experience.crm.sidebar.deals": "Deals",
  "landing.experience.crm.sidebar.tasks": "Tasks",
  "landing.experience.crm.card.new": "New card",
  "landing.experience.crm.card.source": "Source: WhatsApp",
  "landing.experience.crm.card.record": "Booking for today, 16:30",
  "landing.experience.crm.tasks.title": "Manager tasks",
  "landing.experience.crm.tasks.confirm": "Confirm booking · 5 min",
  "landing.experience.crm.tasks.remind": "Send reminder · 45 min",
  "landing.experience.crm.tasks.review": "Ask for review · after visit",
  "landing.experience.market.kicker": "Marketplaces",
  "landing.experience.market.title": "Margin and stock without manual sheets",
  "landing.experience.market.text": "Orders, stock, prices and cost sync in ZANI. AI sees drops and suggests what to change today.",
  "landing.experience.market.dumping": "Dumping bot 24/7",
  "landing.experience.market.dumpingText": "Watches competitor prices and suggests the optimal price.",
  "landing.experience.market.stock": "Warehouse and stock",
  "landing.experience.market.stockText": "Stock and cost are pulled in automatically.",
  "landing.experience.market.chain.stock": "Stock",
  "landing.experience.market.chain.prices": "Prices",
  "landing.experience.market.chain.analytics": "Analytics",
  "landing.experience.market.chain.outreach": "Campaigns",
  "landing.experience.ecosystem.kicker": "Ecosystem",
  "landing.experience.ecosystem.title": "One conversation. Every action connected",
  "landing.experience.ecosystem.text": "A message becomes a lead, a booking and a team task without entering the same data twice.",
  "landing.experience.ecosystem.ai": "AI answers clients",
  "landing.experience.ecosystem.aiText": "First reply, booking, clarification and repeat sale.",
  "landing.experience.ecosystem.market": "Marketplaces in work",
  "landing.experience.ecosystem.marketText": "Kaspi, WB, Ozon, stock and prices in one loop.",
  ...
  "landing.experience.owner.growth": "Growth is clear",
  "landing.experience.owner.growthText": "AI highlights where more money can be earned.",
  "landing.experience.integrations.kicker": "Integrations",
  "landing.experience.integrations.title": "Not logos. A network where data moves",
  "landing.experience.integrations.text": "Channels, stock, ads, email and telephony are connected into one working picture.",
  "landing.experience.integration.moysklad": "MoySklad",
  "landing.experience.integration.telephony": "Telephony",
  "landing.experience.proof.kicker": "Proof",
  "landing.experience.proof.title": "Few words. Visible result",
  "landing.experience.proof.repeat": "repeat sales growth",
  "landing.experience.proof.missed": "missed leads",
  "landing.experience.proof.connectTime": "15 min",
  "landing.experience.proof.connect": "to first connection",
  "landing.experience.proof.salon": "Service salon",
  "landing.experience.proof.medical": "Medical center",
  "landing.experience.proof.retail": "Retail",
  "landing.experience.proof.quoteRepeat": "Clients return after reminders and personal offers.",
  "landing.experience.proof.quoteMissed": "AI replies immediately, even when the admin is busy.",
  "landing.experience.proof.quoteConnect": "Channels were connected without an integrator or long rollout.",
  "landing.experience.cta.titlePrefix": "Start with free CRM and configure",
  "landing.experience.cta.titleAccent": "your workflow",
  "landing.experience.cta.text": "Create a workspace without a bank card. Add channels and your team inside ZANI.",
  "landing.experience.proof.noCardValue": "No card",
  "landing.experience.proof.noCard": "Start freely",
  "landing.experience.proof.noCardText": "No payment details are required to create a workspace.",
  "landing.experience.proof.demoValue": "In browser",
  "landing.experience.proof.demo": "A testable scenario",
  "landing.experience.proof.demoText": "Try the conversation, CRM and result directly on this page.",
  "landing.experience.cta.email": "Your email",
  "landing.experience.cta.noCard": "No card",
  "landing.experience.cta.fastStart": "Fast start",
  "landing.experience.cta.freeCrm": "Free CRM",
  "landing.experience.footer.text": "AI ecosystem for communications, sales, marketplaces and team control.",
  "landing.experience.footer.aria": "Footer navigation",
  "landing.experience.footer.rights": "© 2026 ZANI. All rights reserved.",
};
