...
const ru: Dictionary = {
  ...
  "dashboard.aiNavigator": "AI-навигатор",
  ...
  "crmCard.snapshotNoTasks": "Нет открытой задачи. Если клиент требует действия, создайте follow-up.",
  ...
  "settings.roleDescription.admin": "Почти полный доступ к операционной CRM без передачи владения бизнесом.",
  ...
  "aiAssistant.chatTitle": "Чат с AI",
...
const kk: Dictionary = {
  ...
  "crmCard.snapshotNoTasks": "Ашық тапсырма жоқ. Клиент бойынша әрекет керек болса, follow-up жасаңыз.",
  ...
  "settings.roleDescription.admin": "Бизнес иелігін бермей, операциялық CRM бойынша кең қолжетімділік.",
...
const en: Dictionary = {
  ...
  "crmCard.snapshotNoTasks": "No open task. Create a follow-up if the client needs action.",
  ...
  "settings.roleDescription.admin": "Broad operational CRM access without transferring business ownership.",
