...
class DealStageHistoryAdmin(admin.ModelAdmin):
    list_display = ("deal", "business", "from_stage", "to_stage", "from_status", "to_status", "actor", "created_at")
    list_filter = ("business", "from_status", "to_status", "source", "created_at")
    search_fields = ("deal__title", "business__name", "actor__email")
    readonly_fields = ("created_at", "updated_at")


@admin.register(DealValueHistory)
class DealValueHistoryAdmin(admin.ModelAdmin):
    list_display = ("deal", "business", "amount_before", "amount_after", "currency_before", "currency_after", "actor", "created_at")
    list_filter = ("business", "currency_before", "currency_after", "source", "created_at")
    search_fields = ("deal__title", "business__name", "actor__email")
    readonly_fields = ("created_at", "updated_at")
