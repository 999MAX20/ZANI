export const ru: Record<string, string> = {
  ...
  "aiAgents.control.pipelineTitle": "Автодействия в CRM",
  "aiAgents.control.pipelineText": "Настройте, как агент квалифицирует диалог, создает CRM-объекты и когда может отправлять ответ.",
  "aiAgents.control.mode": "Режим автопайплайна",
  "aiAgents.control.mode.off": "Выключено",
  "aiAgents.control.mode.triage": "Только квалификация",
  "aiAgents.control.mode.leadTask": "Заявка и задача",
  "aiAgents.control.mode.draftDeal": "Черновик сделки",
  "aiAgents.control.maxReplyChars": "Максимум символов в автоответе",
  "aiAgents.control.leadConfidence": "Порог заявки: {value}",
  "aiAgents.control.dealConfidence": "Порог сделки: {value}",
