...
export const kk: Record<string, string> = {
  ...
  "landing.experience.channel.kaspi": "Жаңа тапсырыс",
  ...
  "landing.experience.hero.kicker": "Бизнеске арналған AI-экожүйе",
  "landing.experience.hero.titlePrefix": "Бизнесіңіз енді",
  "landing.experience.hero.titleAccent": "тыныш жұмыс істейді",
  "landing.experience.hero.note": "команда бос болмаса да",
  "landing.experience.hero.text": "ZANI клиенттерге жауап береді, өтінім жасайды, CRM жүргізеді, маркетплейстерді қосады және иесіне күннің толық көрінісін қолмен бақылаусыз көрсетеді.",
