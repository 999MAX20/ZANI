...
const ru: Dictionary = {
  ...
  "aiAgents.description": "Профили поведения для черновиков ответов. Они помогают готовить ответы, но не отправляют сообщения автоматически.",
  ...
  "integrations.overview.description": "Сначала подключите каналы сообщений, затем источники данных. Сложные настройки скрыты внутри карточек.",
  ...
  "integrations.overview.guideStep1": "1. Подключите сайт, Telegram или WhatsApp, чтобы не терять обращения.",
  "integrations.overview.guideStep2": "2. Добавьте Excel/CSV, склад или маркетплейсы, чтобы аналитика видела продажи и остатки.",
  "integrations.overview.guideStep3": "3. Оставьте только нужные каналы включенными. Остальное можно подключить позже.",
...
const en: Dictionary = {
  ...
  "calendar.aiHint": "AI schedule hint",
  ...
  "conversations.aiTriageTitle": "AI message hint",
  ...
  "deals.risks": "Risks",
  "deals.aiPipelineHint": "AI deal hint",
  ...
  "integrations.overview.description": "Connect message channels first, then data sources. Complex settings stay inside each service card.",
  ...
  "integrations.overview.guideStep1": "1. Connect website, Telegram or WhatsApp so customer requests are not lost.",
  "integrations.overview.guideStep2": "2. Add Excel/CSV, inventory or marketplaces so analytics can see sales and stock.",
  "integrations.overview.guideStep3": "3. Keep only needed channels enabled. Everything else can be connected later.",
