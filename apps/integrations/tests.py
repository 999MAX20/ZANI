...
class TelegramIntegrationSkeletonTests(TestCase):
    ...
    def test_telegram_webhook_saves_inbound_message(self):
        ...
        event = BusinessEvent.objects.get(business=self.business, source=BusinessConnector.Providers.TELEGRAM, event_type="message.received")
        self.assertEqual(event.external_id, "5")
    ...
    def test_telegram_webhook_is_idempotent_for_repeated_message(self):
        ...
        self.assertEqual(BusinessEvent.objects.filter(source=BusinessConnector.Providers.TELEGRAM, event_type="message.received").count(), 1)
    ...
    def test_merchant_can_configure_telegram_but_disabled_provider_does_not_connect_webhook(self):
        ...
        self.assertNotIn("webhook_secret", channel_response.data["config_json"])
        self.assertTrue(channel_response.data["config_json"]["webhook_secret_configured"])
