...
export const kk: Record<string, string> = {
  ...
  "actions.errorValidation": "Өрістерді тексеріп, әрекетті қайталаңыз. {detail}",
  ...
  "actions.errorConflict": "Жазба жұмыс барысында өзгерді. Деректерді жаңартып, қайталаңыз. {detail}",
