...
export const kk: Record<string, string> = {
  ...
  "auth.proofText": "14 000-нан астам компания ZANI арқылы өсіп жатыр",
  ...
  "landing.experience.hero.titlePrefix": "Клиент жауап алады, тіпті",
  "landing.experience.hero.titleLine1": "Клиент жауап алады,",
  "landing.experience.hero.titleLine2": "тіпті",
  "landing.experience.hero.titleAccent": "команда бос болмаса да",
  "landing.experience.hero.note": "команда бос болмаса да",
  ...
  "landing.experience.ecosystem.title": "ZANI CRM емес. Бұл бизнес операциялық жүйесі",
  "landing.experience.ecosystem.text": "Бизнес бөлек сервистерден қолмен жиналмауы үшін барлық өнімдер өзара байланысқан.",
  ...
  "landing.experience.cta.titlePrefix": "ZANI-ді бірнеше минутта қосып, бизнесті",
  "landing.experience.cta.titleAccent": "өздігінен жұмыс істетіңіз",
  "landing.experience.cta.text": "CRM тегін. Карта қажет емес. Қосылу тіркелгеннен кейін бірден басталады.",
