...
export const kk: Record<string, string> = {
  ...
  "aiAgents.control.pipelineTitle": "CRM автоәрекеттері",
  "aiAgents.control.pipelineText": "Агент диалогты қалай анықтайтынын, CRM жазбаларын қалай жасайтынын және қашан жауап жібере алатынын баптаңыз.",
  "aiAgents.control.mode": "Автопайплайн режимі",
  "aiAgents.control.mode.off": "Өшірулі",
  "aiAgents.control.mode.triage": "Тек анықтау",
  "aiAgents.control.mode.leadTask": "Өтінім және тапсырма",
  "aiAgents.control.mode.draftDeal": "Мәміле черновигі",
  "aiAgents.control.maxReplyChars": "Автожауаптағы ең көп таңба",
  "aiAgents.control.leadConfidence": "Өтінім шегі: {value}",
  "aiAgents.control.dealConfidence": "Мәміле шегі: {value}",
