...
function KpiCard({
  ...
  return (
    <div className="rounded-lg border border-slate-200 bg-white px-3 py-2.5 shadow-sm transition-shadow hover:shadow-md">
      <div className="mb-1.5 flex items-start justify-between gap-3">
        <div className={cn("grid h-8 w-8 shrink-0 place-items-center rounded-lg", tones[tone])}>
      ...
      <p className="text-lg font-bold leading-none text-slate-950">{value.toLocaleString("ru-RU")}</p>
