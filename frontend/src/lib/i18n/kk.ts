...
export const kk: Record<string, string> = {
  "aiSetup.dentalEscalation": "Шағымдарды, медициналық сұрақтарды және адаммен сөйлесу өтініштерін әкімшіге бер.\nМәлімет жоқ немесе қайшы болса, әкімшіден нақтыла.",
  "aiSetup.advanced": "Қосымша баптаулар",
  "aiSetup.advancedText": "Нұсқаулар, модель және жауаптардың өзгермелілігі.",
  "aiSetup.handoffRules": "Әкімшіге қашан беру керек",
  "aiSetup.dentalRole": "Стоматология әкімшісі",
  "aiSetup.dentalPrompt": "Сен стоматология әкімшісісің. Таңдалған тіл мен қарым-қатынас мәнерін қолдан. Тек клиниканың қызметтері, бағалары, мамандары, бос уақыттары мен білім қорын пайдалан. Диагноз қойма және ем тағайындама. Мәлімет жетіспесе, нақтылаушы сұрақ қой. Шағымдарды, медициналық сұрақтарды және адаммен сөйлесу өтініштерін әкімшіге бер. Жазылуды, ауыстыруды, бас тартуды және соңғы бағаны қызметкер растайды; бұл әрекеттерді орындадым деп айтпа.",
  "aiSetup.applyDentalRole": "Стоматология әкімшісі рөлін қолдану",
  "aiSetup.previewTitle": "Сынақ диалогы",
  "aiSetup.previewScope": "Сақталған баптаулар мен клиника деректері қолданылады. Клиенттерге хабар жіберілмейді, CRM жазбалары жасалмайды. Сынақ ЖИ сұрауларын пайдаланады және ЖИ журналына сақталады.",
  "aiSetup.previewForbidden": "Сынақ үшін ЖИ агентін басқару және ЖИ көмекшісін пайдалану құқықтары қажет.",
  "aiSetup.saveBeforeTest": "Сынақ алдында баптауларды сақтаңыз",
  "aiSetup.scenario.price": "Баға",
  "aiSetup.scenario.booking": "Жазылу",
  "aiSetup.scenario.complaint": "Шағым",
  "aiSetup.example.price": "Қандай қызметтер бар және олардың бағасы қанша?",
  "aiSetup.example.booking": "Ертеңге жазылғым келеді. Қай уақыт бос?",
  "aiSetup.example.complaint": "Шағым бергім келеді. Әкімшімен байланыстырыңыз.",
  "aiSetup.handoff": "Әкімші қажет",
  "aiSetup.automatic": "Іске қосылғаннан кейін ережелер автоматты жауапқа рұқсат береді",
  "aiSetup.draftOnly": "Автоматты жауап өшірулі — сынақ жауабы көрсетілді",
  "aiSetup.message": "Сынақ клиентінің хабарламасы",
  "aiSetup.testReply": "Жауапты тексеру",
  "aiSetup.resetTest": "Жаңа сынақ",
  "aiSetup.launchHelp": "Іске қосу үшін сақталған профиль, білім және белсенді арна қажет. Жоғарыдағы қосқышпен іске қосыңыз немесе тоқтатыңыз. Арнаны қоспай тұрып сынауға болады.",
  "aiSetup.next": "Келесі: {section}",
  "aiSetup.sourceTitle": "CRM қызметтері, бағалары және кестелері",
  "aiSetup.sourceText": "Агент белсенді қызметтер мен мамандардың жеке бос уақытын автоматты түрде пайдаланады. Мұнда мекенжайды, клиника ережелерін және жиі қойылатын сұрақтарды қосыңыз. Бағалар мен кестелерді CRM бөлімдерінде жүргізіңіз.",
  ...
  "payments.title": "Қолмен есепке алу",
  "finance.title": "Есеп жүйесіндегі қаржы",
  "finance.unavailable": "Қаржылық деректер жоқ",
  "finance.stale": "Деректер жаңартылмаған.",
  "finance.receipts": "Түсімдер",
  "finance.refunds": "Қайтарымдар",
  "finance.net_receipts": "Түсімдер − қайтарымдар",
  "finance.source": "Дереккөз: {name}",
  "finance.period": "Кезең: {start} — {end}",
  "finance.asOf": "Жаңартылды: {at}",
  "finance.serviceEstimate": "Қызмет құнын бағалау",
  "finance.averageServiceEstimate": "Клиентке шаққандағы қызметтің орташа бағасы",
  "finance.reason.no_source": "Тексерілген қаржы дереккөзі қосылмаған.",
  "finance.reason.unsupported_source": "Дереккөз қаржылық деректерді растамайды.",
  "finance.reason.multiple_sources": "Бірнеше қаржы дереккөзі: біріктіру бапталмаған.",
  "finance.reason.permission_denied": "Бизнестің қаржылық деректеріне рұқсат жоқ.",
  "finance.reason.source_unavailable": "Қаржы дереккөзі қолжетімсіз.",
  "finance.reason.initial_sync": "Кезеңді бастапқы жүктеу аяқталмаған.",
  "finance.reason.no_verified_snapshot": "Бұл кезеңге тексерілген деректер жоқ.",
  "finance.reason.sync_failed": "Жаңарту қатемен аяқталды.",
  "finance.reason.sync_stopped": "Дереккөзді жаңарту тоқтатылды.",
  "finance.reason.updating": "Жаңарту әлі аяқталмады.",
  "finance.reason.snapshot_not_refreshed": "Соңғы жаңарту бұл кезеңді растамады.",
  "finance.reason.sync_overdue": "Жоспарланған жаңарту кешігіп жатыр.",
  "analytics.roiStatus.service_price_estimate_not_receipts": "Қызмет бағалары, нақты түсімдер емес",
  "payments.add": "Төлем қосу",
  "payments.client": "Клиент",
  "payments.deal": "Мәміле",
  "payments.appointment": "Жазылу",
  "payments.link": "Жазылу / мәмілемен байланыс",
  "payments.standalone": "Байланыссыз — жеке төлем",
  "payments.amount": "Сома",
  "payments.date": "Төлем күні мен уақыты",
  "payments.method": "Төлем тәсілі",
  "payments.method.cash": "Қолма-қол",
  "payments.method.card": "Карта",
  "payments.method.transfer": "Банк аударымы",
  "payments.method.other": "Басқа",
  "payments.note": "Түсініктеме (міндетті емес)",
  "payments.reason": "Қайтару себебі",
  "payments.refund": "Қайтарымды тіркеу",
  "payments.recordRefund": "Қайтарымды растау",
  "payments.record": "Төлемді тіркеу",
  "payments.refundLimit": "Қайтаруға болады: {amount} {currency}",
  "payments.manualNotice": "Алынған ақшаны қолмен есепке алу. Бұл банктің растауы немесе төлем жасау емес.",
  "payments.required": "Осы өрісті таңдаңыз немесе толтырыңыз.",
  "payments.amountInvalid": "Нөлден үлкен соманы, үтірден кейін екі таңбадан асырмай енгізіңіз.",
  "payments.dateInvalid": "Қазіргі уақыттан кеш емес күн мен уақытты көрсетіңіз.",
  "payments.checkFields": "Өрістерді тексеріңіз: деректер сақталмады.",
  "payments.uncertain": "Жіберу нәтижесі расталмады. «Қайталау» түймесін басыңыз: сол әрекет қайталанбай тексеріледі.",
  "payments.discardTitle": "Пішінді жабу керек пе?",
  "payments.discardText": "Сақталмаған деректер жоғалады.",
  "payments.uncertainClose": "Төлем сақталуы мүмкін. Жіберуді қайталауды ұсынамыз. Пішінді жапсаңыз, төлемді қайта қоспас бұрын журналды тексеріңіз.",
  "payments.discard": "Жабу",
  "payments.search": "Клиент бойынша іздеу",
  "payments.noMatches": "Ештеңе табылмады",
  "payments.kind": "Операциялар",
  "payments.all": "Барлық операциялар",
  "payments.receipt": "Төлем",
  "payments.refundKind": "Қайтару",
  "payments.saved": "Операция тіркелді.",
  "payments.empty": "Төлемдер табылмады",
  "payments.emptyText": "Алынған төлемді қосыңыз немесе сүзгілерді өзгертіңіз.",
  "payments.source": "Дереккөз",
  "payments.manual": "Қолмен енгізілді",
  "payments.integration": "Интеграция",
  "payments.actor": "Кім және қашан енгізді",
  "payments.refunded": "Қайтарылды",
  "payments.pagination": "Төлемдер журналының беттері",
  "payments.count": "Операциялар: {count}",
  "payments.next": "Келесі",
  ...ru,
  "business.navigationLabel": "Бизнес навигациясы",
  "services.statusActive": "Белсенді",
  "services.metricsLabel": "Қызметтердің негізгі көрсеткіштері",
  "services.statusInactive": "Белсенді емес",
  "services.statusArchived": "Мұрағатталған",
  "services.archivedOnly": "Мұрағаттағылар",
  "services.actionOpen": "Ашу",
  "services.actionActivate": "Белсендіру",
  "services.actionDeactivate": "Белсенділігін өшіру",
  "services.actionDelete": "Жою",
  "services.actionArchive": "Мұрағаттау",
  "services.actionRestore": "Қалпына келтіру",
  "services.actionMenuLabel": "«{name}» қызметінің әрекеттері",
  "services.deactivateTitle": "Қызметтің белсенділігін өшіру керек пе?",
  "services.deactivateDescription": "«{name}» тізімде және тарихта қалады, бірақ жаңа жазбалар үшін қолжетімсіз болады.",
  "services.deleteTitle": "Қызметті жою керек пе?",
  "services.deleteDescription": "«{name}» мұрағатқа көшіріледі. Жазбалар тарихы сақталады, ал басшы қызметті қалпына келтіре алады.",
  "services.archiveTitle": "Қызметті мұрағаттау керек пе?",
  "services.archiveDescription": "«{name}» мұрағатқа көшіріледі. Жазбалар тарихы сақталады, ал басшы қызметті қалпына келтіре алады.",
  "services.archiveReason": "Себебі (міндетті емес)",
  "services.archiveReasonPlaceholder": "Мысалы: бұл қызмет енді көрсетілмейді",
  "services.noticeActivated": "Қызмет белсендірілді және жаңа жазбаларға қолжетімді.",
  "services.noticeDeactivated": "Қызметтің белсенділігі өшірілді және жаңа жазбалар таңдауынан жасырылды.",
  "services.noticeArchived": "Қызмет мұрағатқа көшірілді.",
  "services.noticeRestored": "Қызмет белсенді емес күйде қалпына келтірілді.",
  "services.archivedReadOnlyTitle": "Қызмет мұрағатта",
  "services.archivedReadOnlyText": "Параметрлер тек көруге қолжетімді. Өзгерту немесе белсендіру үшін қызметті әрекеттер мәзірі арқылы қалпына келтіріңіз.",
  "automations.runFailureSummary": "Автоматтандыру қатесі",
  "automations.runFailureDetails": "Іске қосу аяқталмады. Ереже шарттарын тексеріп, қайта іске қосыңыз.",
  "platform.operations.failureRecorded": "Қате тіркелді. Қосымша тексеру үшін мерчант картасын ашыңыз.",
  ...
  "mfa.addAuthenticator": "Zani-ді аутентификаторға қосыңыз",
  ...
  "mfa.codePlaceholder": "000000 немесе резервтік код",
  ...
  "mfa.recoveryWarning": "Резервтік кодтарды қауіпсіз жерде сақтаңыз. Бұл беттен шыққаннан кейін Zani оларды қайта көрсетпейді.",
  "mfa.copyCodes": "Кодтарды көшіру",
  "mfa.continue": "Кодтарды сақтадым — жалғастыру",
  "mfa.sessionExpiredTitle": "Растау мерзімі аяқталды",
  "mfa.sessionExpiredText": "Жаңа қауіпсіз растау алу үшін кіруді қайта бастаңыз.",
  "mfa.backToLogin": "Кіруге оралу",
  "mfa.accountEyebrow": "Аккаунт қауіпсіздігі",
  "mfa.accountTitle": "Екі факторлы қорғаныс",
  "mfa.accountText": "Иелер мен әкімшілер кіруді аутентификатор кодымен растайды. Басқару тек өз аккаунтыңызға қатысты.",
  "mfa.enabled": "Қорғаныс қосылған",
  "mfa.required": "Қосу қажет",
  "mfa.notEnabled": "Қосылмаған",
  "mfa.method": "Әдіс",
  "mfa.recoveryRemaining": "Резервтік кодтар",
  "mfa.activeSessions": "Белсенді сессиялар",
  "mfa.setup": "MFA қосу",
  "mfa.newRecoveryCodes": "Жаңа резервтік кодтар",
  "mfa.revokeSessions": "Басқа сессияларды аяқтау",
  "mfa.disable": "MFA өшіру",
  "mfa.disableReason": "Өшіру себебі",
  "auth.forgotPassword": "Құпиясөзді ұмыттыңыз ба?",
  "auth.registerBusiness": "Бизнесті тіркеу",
  "auth.backToSite": "Zani сайтына",
  ...
  "auth.heroAria": "Zani мүмкіндіктері",
  ...
  "auth.loginHeroTime": "бір кірумен",
  "auth.signupHeroText": "Өтінімдер, мәмілелер, жазбалар және диалогтар бір кабинетте жиналады.",
  "auth.loginHeroText": "Өтінімдермен, мәмілелермен, жазбалармен және диалогтармен жұмысты жалғастырыңыз.",
  "auth.featureCrmTitle": "Бірыңғай CRM",
  "auth.featureCrmText": "Клиенттер, өтінімдер, мәмілелер және тапсырмалар бір жерде.",
  "auth.featureAiTitle": "Бақыланатын ЖИ",
  "auth.featureAiText": "Кеңестер CRM деректеріне негізделеді, маңызды әрекеттер растауды талап етеді.",
  "auth.featureBotsTitle": "Диалогтар бір жерде",
  "auth.featureBotsText": "Команда өтінішті, жауапты адамды және келесі қадамды көреді.",
  "auth.featureIntegrationsTitle": "Бизнес қосылымдары",
  "auth.featureIntegrationsText": "Арналар мен сервистердің күйі кабинетте көрінеді.",
  "auth.proofText": "Артық техникалық күрделіліксіз күнделікті жұмыс.",
  "auth.trustSecurity": "Қорғалған сессия",
  "auth.trustServers": "Бизнес деректері бөлінген",
  "auth.previewWelcome": "Бүгінгі жұмыс",
  "auth.previewScanned": "Бизнес күйі жаңартылды",
  "auth.previewNewLeads": "Жаңа өтінімдер",
  "auth.previewBookings": "Жазбалар",
  "auth.previewRevenue": "Түсім",
  "auth.previewPipeline": "Мәмілелер воронкасы",
  "auth.previewAiTip": "ЖИ кеңесі",
  "auth.previewConversion": "Конверсия",
  "auth.signInAppCopy": "CRM жүйесінде жұмысты жалғастыру үшін кіріңіз.",
  "auth.emailDivider": "немесе email арқылы кіріңіз",
  "auth.emailPlaceholder": "Логиніңіз",
  "auth.passwordPlaceholder": "Құпиясөзді енгізіңіз",
  "auth.invalidCredentials": "Email немесе құпиясөз қате.",
  "auth.loginUnavailable": "Жүйеге кіруді аяқтау мүмкін болмады. Сервердің қолжетімділігін тексеріп, қайталап көріңіз.",
  ...
  "invite.existingAccount": "Бұл email үшін аккаунт бар. Құпиясөзді өзгертпей шақыруды қабылдау үшін сол аккаунтқа кіріңіз.",
  "invite.signInToAccept": "Кіру және қабылдау",
  "invite.wrongAccount": "Шақыру басқа аккаунтқа арналған. Шақыруда көрсетілген email арқылы кіріңіз.",
  ...
  "dashboard.businessScopeNeedsProcess": "Барлық бизнес бойынша · өңдеуді қажет етеді",
  "dashboard.teamScopeOpenFollowups": "Барлық команда бойынша · жұмыста",
  "dashboard.teamOpenTasks": "Команданың ашық тапсырмалары",
  "dashboard.noTeamOpenTasks": "Командада ашық тапсырма жоқ",
  "dashboard.noTeamOpenTasksText": "Мұнда барлық қызметкерлердің аяқталмаған тапсырмалары көрінеді.",
  ...
  "dashboard.taskEscalation.escalate": "Эскалация",
  ...
  "dashboard.latestBusinessEventsText":
    "Импортталған сатылымдар, тауарлар, қалдықтар және қосылым оқиғалары бір жерде.",
  "dashboard.connectorHealth": "Қосылымдардың күйі",
  ...
  "dashboard.ownerBriefFallbackSource": "CRM жазбасы",
  "dashboard.ownerBrief.staleLead.title": "Байланысу: {source}",
  "dashboard.ownerBrief.staleLead.text":
    "Өтінім тағайындалмаған немесе ұзақ уақыт жаңартылмаған.",
  "dashboard.ownerBrief.overdueTask.title": "Тапсырманы жабу: {source}",
  "dashboard.ownerBrief.overdueTask.text":
    "Тапсырма мерзімі өтті, бірақ ол әлі ашық.",
  "dashboard.ownerBrief.unansweredConversation.title":
    "Диалогқа жауап беру: {source}",
  "dashboard.ownerBrief.unansweredConversation.text":
    "Кіріс хабарлама жауапты немесе менеджерге беруді күтеді.",
  "dashboard.ownerBrief.stalledDeal.title": "Келесі қадамды анықтау: {source}",
  "dashboard.ownerBrief.stalledDeal.text":
    "Мәміле ашық, бірақ келесі қадам кешіктірілген немесе тағайындалмаған.",
  "dashboard.ownerBrief.failedConnector.title": "Қосылымды тексеру: {source}",
  "dashboard.ownerBrief.failedConnector.text":
    "CRM жаңа деректерді қабылдамас бұрын қосылым назарды қажет етеді.",
  ...
  "common.reset": "Сброс",
  "common.clearAll": "Бәрін тазарту",
  "common.advanced": "Кеңейтілген",
  "crm.activeFilters": "Белсенді:",
  "pagination.range": "{from}—{to} / {total} көрсетілді",
  "pagination.previous": "Артқа",
  "pagination.next": "Алға",
  "pagination.pageSize": "{size}-ден",
  "pagination.pageSizeAriaLabel": "Беттегі жолдар саны",
  "actions.confirm": "Растау",
  "actions.discardChanges": "Өзгерістерден бас тарту",
  "actions.undo": "Болдырмау",
  "actions.reasonRequired": "Себебін көрсетіңіз, кемінде {count} таңба.",
  "actions.errorValidation": "Енгізілген мәндерді тексеріп, әрекетті қайталаңыз.",
  "actions.errorUnauthenticated": "Сеанс аяқталды. Әрекетті қайталамас бұрын жүйеге қайта кіріңіз.",
  "actions.errorForbidden": "Бұл әрекет сіздің рөліңізге немесе бизнес баптауларына қолжетімсіз.",
  ...
  "fallback.permission.title": "Бөлім қолжетімсіз",
  "fallback.permission.guidance": "Бұл бөлім жұмыс үшін қажет болса, бизнес иесіне немесе әкімшіге хабарласыңыз.",
  "fallback.connectivity.offlineTitle": "Байланыс жоқ",
  "fallback.connectivity.reconnectingTitle": "Байланыс қалпына келтірілуде",
  "fallback.fields.title": "Форма деректерін тексеріңіз",
  "fallback.fields.description": "Белгіленген өрістерді түзетіңіз. Қалған деректер орнында қалады.",
  "fallback.fields.invalidValue": "Мәнді тексеріп, әрекетті қайталаңыз.",
  "fallback.session.title": "Сессия аяқталды",
  "fallback.recovery.summary": "Қолдау қызметіне арналған деректер",
  "fallback.recovery.requestId": "Өтініш коды",
  "fallback.recovery.copy": "Көшіру",
  "fallback.recovery.copied": "Көшірілді",
  ...
  "calendar.openSlotsEstimate": "Бос уақыт болжамы",
  "calendar.selectedDay": "Таңдалған күн",
  ...
  "calendar.searchServices": "Қызметтерді іздеу...",
  "calendar.searchResources": "Қызметкерлер мен ресурстарды іздеу...",
  "calendar.noFilterResults": "Ештеңе табылмады",
  ...
  "appointment.source.manual": "Қолмен",
  ...
  "appointments.rescheduleTitle": "Жазбаны ауыстыру",
  "appointments.currentTime": "Қазіргі уақыт",
  ...
  "workingHours.viewsLabel": "Жұмыс кестесінің бөлімі",
  ...
  "workingHours.metricsLabel": "Жұмыс кестесінің көрсеткіштері",
  "workingHours.businessDaysHint": "жалпы жұмыс аралығы бар күндер",
  "workingHours.resourceSchedulesHint": "жеке кестесі бар ресурстар",
  "workingHours.daysOffHint": "кестелерде нақты белгіленген демалыс күндері",
  "workingHours.quickToolbarHint": "Бизнестің жалпы кестесіне қолданылады",
  "workingHours.presetLabel": "Кесте үлгісі",
  "workingHours.applyPresetTitle": "Үлгіні бизнес кестесіне қолдану керек пе?",
  "workingHours.applyPresetDescription": "Ағымдағы жалпы апта таңдалған үлгімен ауыстырылады.",
  "workingHours.discardChanges": "Кестедегі сақталмаған өзгерістерден бас тарту керек пе?",
  "workingHours.businessInspectorSubtitle": "Жеке аптасы жоқ ресурстар қолданатын бизнестің жалпы кестесі",
  "workingHours.resourceInspectorSubtitle": "Таңдалған қызметкердің немесе ресурстың жеке аптасы",
  "workingHours.businessSchedule": "Жалпы кесте",
  "workingHours.individualSchedule": "Жеке",
  "workingHours.readOnlyTitle": "Тек қарау режимі",
  "workingHours.readOnlyText": "Сіздің рөліңіз кестелерді көре алады, бірақ өзгерте алмайды.",
  "workingHours.workingDay": "Жұмыс күні",
  "workingHours.businessWeekHint": "Клиенттерді жазуға арналған негізгі кесте",
  "workingHours.businessWeekTableLabel": "Бизнестің жалпы апталық кестесі",
  "workingHours.resourceListHint": "Жалпы кестені мұралау және жеке апталар",
  "workingHours.searchResources": "Ресурстарды іздеу...",
  "workingHours.scheduleFilter": "Кесте түрі бойынша сүзгі",
  "workingHours.allSchedules": "Барлық кестелер",
  "workingHours.resourceScheduleTableLabel": "Қызметкерлер мен ресурстар кестелері",
  "workingHours.scheduleMode": "Кесте түрі",
  "workingHours.workingDays": "Жұмыс күндері",
  "workingHours.openResourceSchedule": "Кестені ашу: {name}",
  "workingHours.noResourcesFound": "Таңдалған шарттарға сәйкес ресурстар табылмады.",
  ...
  "services.searchPlaceholder": "Қызметтерді іздеу...",
  "services.statusFilter": "Қызмет күйі",
  "services.allStatuses": "Барлық күйлер",
  "services.activeOnly": "Белсенді",
  "services.inactiveOnly": "Белсенді емес",
  "services.tableLabel": "Қызметтер тізімі",
  "services.selectService": "«{name}» қызметін таңдау",
  "services.openDetails": "«{name}» қызметінің параметрлерін ашу",
  "services.inspectorSubtitle": "Қызмет параметрлері және жазбаларда қолданылуы",
  "services.usageTitle": "Жазбаларда қолданылуы",
  "services.usageText": "Қызмет жүктелген тарихтағы {count} жазбада қолданылған.",
  "services.readOnlyTitle": "Көру режимі",
  "services.readOnlyText": "Сіздің рөліңізде қызмет параметрлерін өзгерту құқығы жоқ.",
  "services.discardChanges": "Қызметтің сақталмаған өзгерістерінен бас тарту керек пе?",
  "services.noResultsTitle": "Қызметтер табылмады",
  "services.noResultsText": "Іздеу сұрауын өзгертіңіз немесе күй сүзгісін тазалаңыз.",
  "services.noticeSaved": "Қызмет өзгерістері сақталды.",
  "services.noticeCreated": "Қызмет қосылды.",
  ...
  "resources.typeFilter": "Түрі бойынша сүзгі",
  "resources.allTypes": "Барлық түрлер",
  "resources.statusFilter": "Күйі бойынша сүзгі",
  "resources.allStatuses": "Барлық күйлер",
  "resources.activeOnly": "Тек белсенділер",
  "resources.inactiveOnly": "Тек белсенді емес",
  "resources.quickCreate": "Жылдам қосу",
  "resources.useTemplate": "Қосу",
  "resources.noResultsTitle": "Ресурстар табылмады",
  "resources.noResultsText": "Ресурстарды көру үшін іздеуді немесе сүзгілерді өзгертіңіз.",
  "resources.selectResource": "«{name}» ресурсын ашу",
  "resources.tableLabel": "Қызметкерлер мен ресурстар",
  "resources.scheduleState": "Кесте",
  "resources.individualSchedule": "Жеке кесте",
  "resources.businessSchedule": "Бизнестің жалпы кестесі",
  "resources.statusActive": "Белсенді",
  "resources.statusInactive": "Белсенді емес",
  "resources.actionOpen": "Ашу",
  "resources.actionActivate": "Белсендіру",
  "resources.actionDeactivate": "Белсенділігін тоқтату",
  "resources.actionMenuLabel": "«{name}» ресурсының әрекеттері",
  "resources.noticeCreated": "Ресурс қосылды",
  "resources.noticeSaved": "Ресурс өзгерістері сақталды",
  "resources.noticeActivated": "Ресурс белсендірілді",
  "resources.noticeDeactivated": "Ресурс белсенді емес күйге ауыстырылды",
  "resources.deactivateTitle": "Ресурсты белсенді емес күйге ауыстыру керек пе?",
  "resources.deactivateDescription": "«{name}» ресурсы жаңа жазбалар үшін қолжетімсіз болады.",
  "resources.discardChanges": "Ресурсты жауып, сақталмаған өзгерістерден бас тарту керек пе?",
  "resources.inspectorSubtitle": "Ресурс параметрлері мен кестесі",
  "resources.readOnlyTitle": "Тек көру",
  "resources.readOnlyText": "Сіздің рөліңіз ресурстарды өзгерте алмайды. Бизнес иесіне хабарласыңыз.",
  "resources.usageTitle": "Жазбаларда қолданылуы",
  "resources.usageText": "Осы ресурсты пайдаланатын жазбалар саны: {count}.",
  "resources.scheduleTitle": "Жұмыс кестесі",
  "resources.openSchedule": "Толық кестені ашу",
  "resources.metricsLabel": "Қызметкерлер мен ресурстар қорытындысы",
  ...
  "clients.statusActive": "Белсенді",
  "clients.statusNoReply": "Жауапсыз",
  "clients.lastContact": "Соңғы контакт",
  "clients.managerWithId": "Менеджер {id}",
  ...
  "clients.filterMine": "Менің клиенттерім",
  "clients.searchFilter": "Іздеу",
  ...
  "clients.sourceCampaign": "Кампания",
  "clients.sourceDomain": "Домен",
  "clients.consentStatus": "Келісімдер",
  "clients.consentOptedIn": "Рұқсат етілген",
  "clients.consentOptedOut": "Тыйым салынған",
  ...
  "clients.call": "Қоңырау шалу",
  "clients.openWhatsapp": "WhatsApp",
  "clients.openTelegram": "Telegram",
  "clients.filtersAriaLabel": "Клиент сүзгілері",
  ...
  "clients.tabOverview": "Шолу",
  "clients.tabDeals": "Мәмілелер {count}",
  "clients.tabTasks": "Тапсырмалар {count}",
  "clients.tabFiles": "Файлдар",
  "clients.noDeals": "Мәмілелер әзірге жоқ.",
  "clients.noDealsOpenValue": "Мәмілелер әзірге жоқ. Ашық: {value}",
  "clients.noFiles": "Файлдар әлі қосылмаған.",
  "clients.outboundContact": "Шығыс контакт",
  "clients.inboundContact": "Кіріс контакт",
  "clients.latestDeal": "Соңғы мәміле",
  "clients.nextTask": "Келесі тапсырма",
  "clients.viewAll": "Бәрін көру",
  "clients.phoneMissing": "Телефон көрсетілмеген",
  "clients.emailMissing": "Email көрсетілмеген",
  "clients.telegramConnected": "Telegram қосылған",
  ...
  "crmCard.fileActions": "Файл әрекеттері",
  "crmCard.previewFile": "Ашу",
  "crmCard.renameFile": "Атын өзгерту",
  "crmCard.fileName": "Файл атауы",
  "crmCard.saveFileName": "Сақтау",
  "crmCard.downloadFile": "Жүктеу",
  "crmCard.shareFile": "Бөлісу",
  "crmCard.shareUnsupported": "Бұл браузер осы файлды бөлісуді қолдамайды.",
  "crmCard.zoomIn": "Жақындату",
  "crmCard.zoomOut": "Алыстату",
  ...
  "crmCard.timelineCategoryAppointment": "Жазба",
  "crmCard.timelineCategoryTask": "Тапсырма",
  "crmCard.timelineCategoryAutomation": "Автоматтандыру",
  "crmCard.timelineCategorySystem": "Жүйе",
  "crmCard.timelineFieldAction": "Әрекет",
  "crmCard.timelineFieldStatus": "Статус",
  "crmCard.timelineFieldStage": "Кезең",
  "crmCard.timelineFieldTime": "Уақыт",
  "crmCard.timelineFieldAmount": "Сома",
  "crmCard.timelineFieldAssignee": "Орындаушы",
  "crmCard.timelineFieldReason": "Себеп",
  "crmCard.timelineFieldLostReason": "Жоғалту себебі",
  "crmCard.timelineFieldClearedReason": "Тазартылған себеп",
  "crmCard.timelineFieldResource": "Ресурс",
  "crmCard.timelineFieldClient": "Клиент",
  "crmCard.timelineFieldLead": "Өтінім",
  "crmCard.timelineFieldDeal": "Мәміле",
  "crmCard.timelineFieldAppointment": "Жазба",
  "crmCard.timelineFieldTask": "Тапсырма",
  "crmCard.timelineFieldConversation": "Диалог",
  "crmCard.timelineFieldChannel": "Арна",
  "crmCard.timelineFieldIntegrationEvent": "Интеграция оқиғасы",
  "crmCard.timelineFieldConnector": "Коннектор",
  "crmCard.timelineFieldExternalId": "Сыртқы ID",
  "crmCard.timelineFieldBusinessEvent": "Бизнес оқиға",
  "crmCard.timelineFieldTool": "Құрал",
  ...
  "tasks.filters": "Тапсырма сүзгілері",
  ...
  "tasks.noAssignee": "Орындаушы жоқ",
  "tasks.assign": "Тағайындау",
  "tasks.allAssignees": "Барлық орындаушылар",
  "tasks.allPriorities": "Барлық басымдықтар",
  "tasks.resetFilters": "Фильтрлерді тазарту",
  "tasks.dueFrom": "Мерзім басы",
  "tasks.dueTo": "Мерзім соңы",
  "tasks.allDue": "Барлық мерзімдер",
  "tasks.duePast": "Мерзімі өткен",
  "tasks.dueToday": "Бүгін",
  "tasks.dueFuture": "Болашақ",
  "tasks.dueNone": "Мерзімсіз",
  "tasks.allRelations": "Барлық байланыстар",
  "tasks.noLead": "Өтінімсіз",
  "tasks.noDeal": "Мәмілесіз",
  "tasks.noAppointment": "Жазбасыз",
  "tasks.noConversation": "Диалогсыз",
  "tasks.due": "дейін",
  ...
  "tasks.groupOverdue": "Мерзімі өткен",
  "tasks.groupToday": "Бүгін",
  "tasks.groupLater": "Кейін",
  "tasks.groupNoDue": "Мерзімсіз",
  "tasks.groupUnassigned": "Орындаушысыз",
  "tasks.groupInProgress": "Жұмыста",
  "tasks.groupOpen": "Ашық",
  "tasks.groupClosed": "Жабық",
  "tasks.bucketOverdueText": "Қазір назар аударуды қажет ететін тапсырмалар.",
  "tasks.bucketTodayText": "Бүгінгі мерзімі бар жұмыс.",
  "tasks.bucketLaterText": "Келесі күндерге жоспарланған тапсырмалар.",
  "tasks.bucketNoDueText": "Нақты орындалу мерзімі жоқ тапсырмалар.",
  "tasks.bucketUnassignedText": "Иесін тағайындау керек тапсырмалар.",
  "tasks.bucketInProgressText": "Жұмысқа алынған тапсырмалар.",
  "tasks.bucketOpenText": "Әлі белсенді жұмыс басталмаған ашық тапсырмалар.",
  "tasks.bucketClosedText": "Аяқталған және бас тартылған тапсырмалар.",
  "tasks.bucketSelectedMeta": "Таңдалған санатта {count} тапсырма",
  "tasks.backToBuckets": "Санаттарға",
  "tasks.searchResults": "Іздеу нәтижелері",
  "tasks.searchResultsMeta": "«{query}» · {count} табылды",
  "tasks.allTasks": "Барлық тапсырмалар",
  "tasks.allTasksMeta": "Барлығы {count} тапсырма",
  "tasks.workloadTitle": "Жүктеме",
  "tasks.workloadActiveCount": "{count} белсенді тапсырма",
  "tasks.workloadAssigneeCount": "{count} орындаушы",
  "tasks.workloadOpen": "Ашық",
  "tasks.workloadProgress": "Жұмыста",
  "tasks.workloadOverdue": "Кешіккен",
  "tasks.workloadToday": "Бүгін",
  "tasks.workloadPriority": "Басымдық",
  "tasks.workloadOldest": "Ең ерте",
  "tasks.workloadStatus.idle": "Бос",
  "tasks.workloadStatus.balanced": "Қалыпты",
  "tasks.workloadStatus.busy": "Жүктелген",
  "tasks.workloadStatus.overloaded": "Артық жүктеме",
  "tasks.statTodo": "Жұмысқа",
  "tasks.statTodoText": "Әлі белсенді жұмыс басталмаған ашық тапсырмалар.",
  "tasks.statCompleted": "Аяқталған",
  "tasks.statCompletedText": "Аяқталған және бас тартылған тапсырмалар.",
  ...
  "tasks.tableDue": "Мерзім",
  "tasks.tablePriority": "Басымдық",
  ...
  "tasks.formTitle": "Атауы",
  "tasks.formDescription": "Сипаттама",
  "tasks.dueAt": "Мерзімі",
  "tasks.reminderAt": "Еске салу",
  ...
  "tasks.history": "Тарих",
  "tasks.drawerOverviewTab": "Шолу",
  "tasks.drawerCommentsTab": "Пікірлер",
  ...
  "tasks.saveAssignee": "Орындаушыны сақтау",
  "tasks.noHistory": "Тарих әзірге жоқ.",
  ...
  "conversations.suggestionStatus": "Ұсыныс",
  ...
  "conversations.allHandoff": "Менеджерге берілгендердің барлығы",
  "conversations.needsManager": "Менеджер керек",
  "conversations.noHandoff": "Менеджерге берілмеген",
  ...
  "conversations.filters": "Сүзгілер",
  "conversations.queueAll": "Барлық диалогтар",
  "conversations.priority": "Басымдық",
  "conversations.status": "Статус",
  "conversations.sort": "Сұрыптау",
  "conversations.noFilter": "Сүзгі жоқ",
  "conversations.sortLatest": "Соңғылары алдымен",
  "conversations.sortUnread": "Оқылмағандар алдымен",
  "conversations.sortFirstResponse": "Жауап мерзімі бойынша",
  ...
  "conversations.markUnreadAction": "Оқылмағанға қайтару",
  "conversations.createClient": "Клиент жасау",
  "conversations.openClient": "Клиентті ашу",
  "conversations.createLead": "Өтінім жасау",
  "conversations.openLead": "Өтінімді ашу",
  ...
  "conversations.messageStatusFailed": "қате",
  "conversations.deliveryTitle": "Жауапты жеткізу",
  "conversations.deliveryStatusQueued": "кезекте",
  "conversations.deliveryStatusSending": "жіберілуде",
  "conversations.deliveryStatusDelivered": "арна қабылдады",
  "conversations.deliveryStatusDelayed": "кейінге қалдырылды",
  "conversations.deliveryStatusRetrying": "қайта жіберілуде",
  "conversations.deliveryStatusFailed": "жеткізілмеді",
  "conversations.deliveryHelpQueued": "Жауап сақталды және арнаға жіберуді күтуде.",
  "conversations.deliveryHelpSending": "Жауап қосылған арнаға жіберілуде.",
  "conversations.deliveryHelpDelivered": "Арна жауапты қабылдағанын растады.",
  "conversations.deliveryHelpDelayed": "Автоматты қайталап жіберу жоспарланды.",
  "conversations.deliveryHelpRetrying": "Жүйе жауапты қайта жіберіп жатыр.",
  "conversations.deliveryHelpFailed": "Жауап жеткізілмеді, бірақ хабарлама тарихта сақталды.",
  "conversations.deliveryAttempts": "Әрекеттер: {attempts} / {max}",
  "conversations.retryDelivery": "Қайта жіберу",
  "conversations.deliveryRetryNotAllowed": "Қайта жіберу үшін диалогтарды өзгерту құқығы бар рөл қажет.",
  "conversations.linked": "Байланысқан",
  "conversations.notLinked": "Байланыспаған",
  "conversations.linkExisting": "Байлау",
  ...
  "analytics.teamPerformanceText":
    "Команда сапасын бақылау: өтінімдер, менеджерге беру, мәмілелер және тапсырмалар.",
  ...
  "settings.notifications.category.outreach.text":
    "Кампанияларды дайындау, іске қосу, аяқтау, жазылымнан бас тарту және қателер.",
  ...
  "settings.paymentMethod.empty": "Таңдалмаған",
  "settings.paymentMethod.invoice": "Төлем шоты",
  "settings.paymentMethod.card": "Банк картасы",
  "settings.paymentMethod.bankTransfer": "Банк аударымы",
  "settings.invoiceName": "Шот алушы",
  "settings.invoiceTaxId": "БСН / ЖСН",
  ...
  "settings.resumeSubscription": "Жалғастыру",
  ...
  "businessForm.slug": "Кабинет мекенжайы",
  ...
  "businessForm.language": "Бизнес тілі",
  "businessForm.currency": "Валюта",
  "businessForm.slaMinutes": "Жауап беру нормасы, минут",
  "businessForm.legalName": "Заңды атауы",
  "businessForm.taxId": "БСН / ЖСН",
  "businessForm.invoiceEmail": "Шоттарға арналған email",
  "businessForm.bookingBufferMinutes": "Жазбалар арасындағы буфер, минут",
  "businessForm.brandColor": "Бренд түсі",
  "businessForm.brandLogoUrl": "Логотип мекенжайы",
  "businessForm.cancellationPolicy": "Бас тарту саясаты",
  "businessForm.prepaymentPolicy": "Алдын ала төлем және төлем",
  ...
  "aiAgents.section.profile": "Профиль",
  "aiAgents.section.knowledgeSimple": "Білім",
  "aiAgents.section.actions": "Әрекеттер",
  "aiAgents.section.test": "Тест",
  ...
  "aiAgents.searchPlaceholder": "Агентті іздеу",
  "aiAgents.filterStatus": "Мәртебе бойынша сүзгі",
  "aiAgents.allStatuses": "Барлық мәртебелер",
  "aiAgents.agentListAria": "ЖИ агенттерінің тізімі",
  "aiAgents.purposeMissing": "Профиль мақсаты әлі бапталмаған.",
  "aiAgents.noMatches": "Іздеу шарттарына сәйкес агент табылмады.",
  "aiAgents.totalCount": "Барлығы: {count} агент",
  "aiAgents.editorAria": "{name} агентінің редакторы",
  "aiAgents.statusSwitch": "{name} агентінің мәртебесін өзгерту",
  "aiAgents.editorTabsAria": "Агент редакторының бөлімдері",
  "aiAgents.unsavedIndicator": "Сақталмаған өзгерістер бар.",
  "aiAgents.savedIndicator": "Өзгерістер сақталды.",
  "aiAgents.saveChanges": "Өзгерістерді сақтау",
  "aiAgents.unsavedTitle": "Сақталмаған өзгерістер",
  "aiAgents.unsavedText": "Агентті ауыстырсаңыз немесе беттен шықсаңыз, сақталмаған өзгерістер жоғалады.",
  ...
  "aiAgents.status.activeBlocked": "Іске қосу бұғатталған",
  ...
  "automations.details": "Детальдар",
  "automations.cancelRun": "Іске қосуды тоқтату",
  "automations.runDetailTitle": "Автоматтандыру іске қосуы",
  "automations.status": "Күй",
  "automations.runRule": "Ереже",
  "automations.runEntity": "Нысан",
  "automations.attempts": "Әрекеттер",
  "automations.runCreated": "Жасалды",
  "automations.runStarted": "Басталды",
  "automations.runFinished": "Аяқталды",
  ...
  "automations.trigger.leadStatusChanged": "Өтінім күйі өзгерді",
  "automations.trigger.dealStageChanged": "Мәміле сатысы өзгерді",
  ...
  "automations.trigger.botMessageReceived": "Бот хабарламасы келді",
  "automations.trigger.conversationUnread": "Диалог оқылмаған болды",
  "automations.trigger.appointmentCreated": "Жазба жасалды",
  "automations.trigger.appointmentCancelled": "Жазба тоқтатылды",
  "automations.trigger.appointmentCompleted": "Жазба аяқталды",
  ...
  "automations.action.assignUser": "Пайдаланушыны тағайындау",
  "automations.action.addNote": "Ескертпе қосу",
  "automations.action.createFollowUp": "Follow-up жасау",
  ...
  "leads.useActionForStatus": "Бұл статус тек бизнес әрекет арқылы өзгереді.",
  ...
  "deals.stageNew": "Жаңа мәміле",
  "deals.stageQualification": "Біліктілікті анықтау",
  "deals.stageProposal": "Ұсыныс",
  "deals.stageNegotiation": "Келісу",
  "deals.stageWon": "Сәтті",
  "deals.stageLost": "Жоғалды",
  ...
  "deals.hot": "Ыстық",
  "deals.noTasksFilter": "Тапсырмасыз",
  "deals.clearSearch": "Іздеуді тазарту",
  ...
  "deals.sourceOnboarding": "Бастапқы баптау",
  ...
  "deals.sections": "Мәміле бөлімдері",
  "deals.tabOverview": "Шолу",
  "deals.tabActivities": "Белсенділік",
  "deals.tabHistory": "Тарих",
  ...
  "deals.riskHighWithPercent": "Жоғары тәуекел {percent}%",
  "deals.riskControlWithPercent": "Бақылау {percent}%",
  "deals.riskNormalWithPercent": "Қалыпты {percent}%",
  "deals.showRecommendations": "Кеңестерді көрсету",
  ...
  "integrations.provider.ozonUse":
    "Маркетплейстегі тапсырыстар, қалдықтар және бас тартулар.",
  ...
  "integrations.provider.emailUse": "Хабарламалар, кіріс хаттар және резервтік жеткізу.",
  "crmCard.timelineEvent.integration_event": "Қосылымнан деректер алынды",
  ...
  "integrations.import.deals": "Мәмілелер",
  ...
  "integrations.import.rowNeedsReview": "{row}-жолдағы деректерді тексеріңіз.",
  "integrations.import.columnsNeedReview": "Файлдағы міндетті бағандарды тексеріңіз.",
  ...
  "analytics.noShowRate": "Келмеу үлесі",
  "analytics.leadToDeal": "Мәмілеге конверсия",
  "analytics.leadToDealHint": "мәмілеге өткен өтінімдер",
  "analytics.wonValue": "Ұтылған мәмілелер сомасы",
  "analytics.wonValueHint": "Мәмілелер сомасы, нақты түсімдер емес",
  "analytics.unansweredConversations": "Жауапсыз диалогтар",
  "analytics.unansweredConversationsHint": "оқылмаған немесе менеджерді күтуде",
  "analytics.connectorErrors": "Қосылым қателері",
  "analytics.appointmentRate": "Жазба үлесі",
  "analytics.aiOpenSources": "Дереккөздерді ашу",
  "analytics.aiCard.overdue_tasks.title": "Мерзімі өткен тапсырмалар назарды қажет етеді",
  "analytics.aiCard.overdue_tasks.description":
    "Мерзімі өткен тапсырмалар: {value}. {sources} тапсырма жазбасына негізделген.",
  "analytics.aiCard.unanswered_conversations.title":
    "Клиенттер кіріс жәшігінде жауап күтуде",
  "analytics.aiCard.unanswered_conversations.description":
    "Жауапсыз немесе менеджерге берілмеген диалогтар: {value}. {sources} диалогқа негізделген.",
  "analytics.aiCard.failed_connectors.title": "Қосылымдарда мәселе бар",
  "analytics.aiCard.failed_connectors.description":
    "Қате күйіндегі қосылымдар: {value}. Тексерілген дереккөздер: {sources}.",
  "analytics.aiCard.appointment_no_show_rate.title": "Келмеу үлесі жоғары",
  "analytics.aiCard.appointment_no_show_rate.description":
    "Келмеу үлесі — {value}%. {sources} жазбаға негізделген.",
  "analytics.aiCard.lead_to_deal_missing.title":
    "Өтінімдер мәмілеге өтпейді",
  "analytics.aiCard.lead_to_deal_missing.description":
    "Қолжетімді {value} өтінімнің әлі байланысты мәмілесі жоқ.",
  "analytics.aiCard.crm_operating_norm.title": "CRM жұмысы тұрақты",
  "analytics.aiCard.crm_operating_norm.description":
    "Ағымдағы көрсеткіштерде шұғыл ауытқулар жоқ.",
  "analytics.aiCard.no_operational_data.title": "Әзірге дерек жеткіліксіз",
  "analytics.aiCard.no_operational_data.description":
    "Негізделген қорытынды алу үшін арналарды қосыңыз немесе деректерді импорттаңыз.",
  ...
  "dashboard.needReply": "Жауап қажет",
  "dashboard.unreadConversationCount": "Оқылмаған: {count}",
  "dashboard.overdueWork": "Мерзімі өткен жұмыс",
  "dashboard.noUnreadConversations": "Жауап күтетін диалогтар жоқ",
  "dashboard.noUnreadConversationsText": "Сіздің қолжетімділік ауқымыңызда оқылмаған және берілген диалогтар кезегі бос.",
  "dashboard.failedConnectors": "Қосылым ақаулары",
  "dashboard.failedConnectorsText": "Қалпына келтіруді қажет ететін қосылымдар: {count}",
  "calendar.openTodayTasks": "Бүгінгі тапсырмаларды ашу",
  "calendar.emptyDayTitle": "Бұл күнге жоспарланған жұмыс жоқ",
  "calendar.emptyDayText": "Сіздің қолжетімділік ауқымыңызда бұл күнге жазбалар немесе мерзімді тапсырмалар жоқ.",
  ...
  "conversations.openIntegrations": "Арна қосылымдарын ашу",
  "conversations.useSuggestedReply": "Ұсынысты жауапқа енгізу",
  "conversations.nextAction.handoff_sla_overdue": "Диалогты операторға беру мерзімі өтті",
  "conversations.nextAction.unread_sla_overdue": "Клиентке жауап беру мерзімі өтті",
  "conversations.nextAction.review_unread": "Оқылмағандарды өңдеу",
  "conversations.nextAction.take_handoffs": "Диалогтарды боттан алу",
  "conversations.nextAction.assign_owners": "Жауаптыларды тағайындау",
  "conversations.nextAction.connect_channel": "Хабарлама арнасын қосу",
  "integrations.page.merchantDescription": "Арналар мен сыртқы сервистерді қосыңыз, олардың күйін тексеріңіз және деректер алмасуды қалпына келтіріңіз.",
  "integrations.page.merchantRequestText": "Қосылым өтінім мен сервис растауын талап етеді.",
  ...
  "crmCard.context": "Контекст",
  "leads.takeInWork": "Жұмысқа алу",
  "signup.passwordMinCheck": "Кемінде 8 таңба",
  "signup.passwordLettersNumbersCheck": "Әріптер мен сандар",
  "signup.passwordNoSpacesCheck": "Бос орынсыз",
  "signup.createCompanyTitle": "Жұмыс кеңістігін жасаңыз",
  "signup.createCompanyText": "CRM жүйесін баптау үшін бизнес деректерін көрсетіңіз.",
  "signup.namePlaceholder": "Атыңыз",
  "signup.passwordPlaceholder": "Құпиясөз ойлап табыңыз",
  "signup.businessNamePlaceholder": "Бизнес атауы",
  "signup.cityPlaceholder": "Қала",
  "signup.afterSignInHelper": "Тіркелгеннен кейін команданы шақырып, жұмыс үдерістерін баптай аласыз.",
  "signup.freeSubmit": "Аккаунт жасау",
  "signup.terms": "Тіркелу арқылы пайдалану шарттары мен құпиялық саясатын қабылдайсыз.",
  "tasks.status": "Мәртебе",
  "tasks.savedNotice": "Өзгерістер сақталды.",
  "tasks.quickActions": "Жылдам әрекеттер",
  "deals.riskPercentShort": "Тәуекел {percent}%",
  "deals.openDealContext": "«{title}» мәмілесін ашу",
  "leads.selectLeadRowContext": "«{title}» өтінімін таңдау",
  "leads.openContext": "«{title}» өтінімін ашу",
  "leads.callContext": "«{title}» өтінімінің клиентіне қоңырау шалу",
  "leads.whatsappContext": "«{title}» өтінімінің клиентіне WhatsApp арқылы жазу",
  "leads.moreActionsContext": "«{title}» өтінімінің қосымша әрекеттері",
  "conversations.openClientContext": "«{title}» клиент картасын ашу",
  "integrations.card.configureContext": "{title} қосылымын баптау",
  "integrations.card.connectContext": "{title} қосу",
  "crmCard.note": "Ескертпе",
  "timeline.searchPlaceholder": "Оқиға немесе клиент",
  "timeline.category": "Санат",
  "timeline.allCategories": "Барлық санат",
  "timeline.actor": "Орындаушы",
  "timeline.actorSelected": "Орындаушы таңдалды",
  "timeline.allActors": "Барлық орындаушы",
  "timeline.noActor": "Орындаушы көрсетілмеген",
  "timeline.unknownActor": "Аты қолжетімсіз",
  "timeline.actorSearch": "Орындаушыны іздеу",
  "timeline.noActorsFound": "Орындаушылар табылмады",
  "timeline.dateFrom": "Басталу күні",
  "timeline.dateTo": "Аяқталу күні",
  "timeline.reset": "Сүзгілерді тазалау",
  "timeline.event": "Оқиға",
  "timeline.object": "Клиент / нысан",
  "timeline.time": "Уақыт",
  "timeline.details": "Оқиға мәліметтері",
  "timeline.openDetails": "Оқиға мәліметтерін ашу",
  "timeline.descriptionLabel": "Өзгерістер",
  "timeline.noDetails": "Қолжетімді қосымша мәліметтер жоқ.",
  "timeline.emptyFilteredText": "Оқиғаларды көру үшін іздеуді өзгертіңіз немесе сүзгілерді қалпына келтіріңіз.",
  "timeline.otherEvent": "Тарихтағы оқиға",
  "timeline.range": "{total} ішінен {from}–{to} көрсетілді",
  "timeline.pageSize": "Беттегі оқиғалар саны",
  "timeline.perPage": "{count}-дан",
  "common.edit": "Өзгерту",
  "analytics.detailedReports": "Толық есептер",
  "analytics.detailedReportsHint": "дереккөздер, воронка және қызметтер",
  "analytics.dataQuality.estimate_from_completed_appointments": "Аяқталған жазбалардағы қызмет бағасы, нақты түсімдер емес",
  "analytics.roiStatus.tracked_without_cost": "Табыс шығындарды есепке алмай бақыланады",
  "analytics.source.unknown": "Дереккөз көрсетілмеген",
  "analytics.source.manual": "Қолмен",
  "analytics.source.website": "Сайт",
  "analytics.source.telegram": "Telegram",
  "analytics.source.whatsapp": "WhatsApp",
  "analytics.action.overdue_handoff.title": "Кешіккен диалогтарға қосылу",
  "analytics.action.overdue_handoff.description": "{count} диалог менеджерді белгіленген уақыттан ұзақ күтуде.",
  "analytics.action.missed_chat.title": "Жауапсыз диалогтарға жауап беру",
  "analytics.action.missed_chat.description": "Тағайындалған {count} диалогта клиентке жауап жоқ.",
  "analytics.action.sla_overdue_deal.title": "Мерзімі өткен мәмілелерді тексеру",
  "analytics.action.sla_overdue_deal.description": "{count} мәміле кезеңде белгіленген уақыттан ұзақ тұр.",
  "analytics.action.overdue_task.title": "Мерзімі өткен тапсырмаларды жабу",
  "analytics.action.overdue_task.description": "Мерзімі өткен тапсырмалар: {count}.",
  "aiAgents.channelSetupUnavailable": "Арна баптауы ашылмады. Терезені жауып, қайта қосып көріңіз.",
  "aiAgents.agentPickerAria": "ЖИ агентін таңдау",
  "aiAgents.activationBlocked": "Агентті қоспас бұрын іске қосу талаптарын аяқтаңыз.",
  "aiAgents.channelsPermissionDenied": "Сіздің рөліңіз агентті баптай алады, бірақ сыртқы арналарды қоса немесе өзгерте алмайды.",
  "aiAgents.conversationsPermissionDenied": "Сіздің рөліңіз бұл агентті тексеруге арналған диалогтарды көре алмайды.",
  "aiAgents.sectionLoading": "Бұл бөлім жүктелуде...",
  "aiAgents.aiProviderLive": "Жауап қосылған ЖИ провайдерімен дайындалды",
  "aiAgents.aiProviderMock": "Қауіпсіз сынақ жауабы: жұмыс істейтін ЖИ провайдері бапталмаған",
  "aiAgents.aiProviderDetails": "Провайдер: {provider}. Модель: {model}.",
  "aiAgents.aiSources": "Жауап үшін пайдаланылған дереккөздер",
  "aiAgents.saveAndContinue": "Сақтау және жалғастыру",
  "aiAgents.knowledgeSharedScopeTitle": "Бизнестің ортақ білім базасы",
  "aiAgents.knowledge.category.business": "Бизнес",
