...
from apps.core.custom_fields import custom_field_role_allowed, validate_custom_field_value
...
class CustomFieldValueViewSet(TenantModelViewSet):
    ...
    def bulk_upsert(self, request):
        ...
        for item in serializer.validated_data["values"]:
            ...
            if not custom_field_role_allowed(definition, request.user, "edit"):
