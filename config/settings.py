...
env = environ.Env(
    ...
    OUTBOUND_MESSAGES_RUN_INLINE=(bool, True),
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": (
        "apps.accounts.authentication.SessionEpochJWTAuthentication",
    ),
...
AUTH_REFRESH_COOKIE_NAME = env("AUTH_REFRESH_COOKIE_NAME", default="zani_refresh")
...
OUTBOUND_MESSAGES_RUN_INLINE = env.bool("OUTBOUND_MESSAGES_RUN_INLINE", default=True)
OUTBOUND_DELIVERY_INTERVAL_SECONDS = env.int("OUTBOUND_DELIVERY_INTERVAL_SECONDS", default=30)
OUTBOUND_DELIVERY_BATCH_SIZE = env.int("OUTBOUND_DELIVERY_BATCH_SIZE", default=100)
OUTBOUND_DELIVERY_MAX_ATTEMPTS = env.int("OUTBOUND_DELIVERY_MAX_ATTEMPTS", default=5)
OUTBOUND_DELIVERY_RETRY_BASE_SECONDS = env.int("OUTBOUND_DELIVERY_RETRY_BASE_SECONDS", default=30)
OUTBOUND_DELIVERY_RETRY_MAX_SECONDS = env.int("OUTBOUND_DELIVERY_RETRY_MAX_SECONDS", default=3600)
OUTBOUND_DELIVERY_STALE_LOCK_SECONDS = env.int("OUTBOUND_DELIVERY_STALE_LOCK_SECONDS", default=900)
CRM_COMMAND_IDEMPOTENCY_RETENTION_DAYS = env.int("CRM_COMMAND_IDEMPOTENCY_RETENTION_DAYS", default=7)
CRM_COMMAND_IDEMPOTENCY_LOCK_SECONDS = env.int("CRM_COMMAND_IDEMPOTENCY_LOCK_SECONDS", default=300)
CRM_COMMAND_IDEMPOTENCY_PRUNE_INTERVAL_SECONDS = env.int(
...
CELERY_BEAT_SCHEDULE.update(
    {
        ...
        "outbound-message-runtime": {
            "task": "bots.process_due_outbound_messages",
            "schedule": OUTBOUND_DELIVERY_INTERVAL_SECONDS,
            "kwargs": {"limit": OUTBOUND_DELIVERY_BATCH_SIZE},
        },
        "crm-command-idempotency-prune": {
