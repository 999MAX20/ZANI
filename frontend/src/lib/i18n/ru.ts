export const ru: Record<string, string> = {
  ...
  "auth.proofText": "CRM, задачи и каналы работают в одном кабинете",
  ...
  "signup.progressAria": "Шаги регистрации",
  ...
  "conversations.emptyText": "Подключите WhatsApp, Telegram, Instagram или чат сайта. Новые обращения появятся здесь автоматически.",
  "conversations.connectChannel": "Подключить канал",
  ...
  "deals.noPipelineTitle": "Настройте первую воронку",
  "deals.noPipeline": "ZANI создаст понятный процесс продаж: новая сделка, контакт, предложение, успех или отказ.",
  "deals.createPipeline": "Создать стандартную воронку",
  "deals.defaultPipelineName": "Основные продажи",
  "deals.pipelineStageNew": "Новая",
  "deals.pipelineStageContact": "Связались",
  "deals.pipelineStageProposal": "Предложение",
  "deals.pipelineStageWon": "Оплачено",
  "deals.pipelineStageLost": "Отказ",
  "deals.pipelineCreated": "Воронка создана. Можно добавлять сделки.",
  ...
  "landing.experience.phone.inbox.instagram": "Здравствуйте! Хочу записаться сегодня.",
  "landing.experience.phone.inbox.telegram": "Добрый день! Есть время сегодня?",
  ...
  "landing.experience.heroFlow.leadTitle": "Новый лид",
  "landing.experience.heroFlow.leadText": "Анна Смирнова",
  "landing.experience.heroFlow.bookingTitle": "Запись создана",
  "landing.experience.heroFlow.bookingText": "Сегодня · 16:30",
  "landing.experience.heroFlow.channelsAria": "Выберите канал для сценария",
  "landing.experience.heroFlow.status.waiting": "Ждём сообщение клиента",
  "landing.experience.heroFlow.status.message": "Сообщение получено",
  "landing.experience.heroFlow.status.replied": "ZANI ответил",
  "landing.experience.heroFlow.status.lead": "Лид создан в CRM",
  "landing.experience.heroFlow.status.time": "Клиент выбрал время",
  "landing.experience.heroFlow.status.booked": "Запись подтверждена на 16:30",
  "landing.demo.kicker": "Попробуйте сами",
  "landing.demo.title": "Напишите боту. CRM соберётся рядом",
  "landing.demo.text": "Один короткий сценарий показывает, как ZANI отвечает клиенту, создаёт запись и передаёт готовую задачу сотруднику.",
  "landing.demo.mode.aria": "Режим демонстрации",
  "landing.demo.mode.guided": "Покажите мне",
  "landing.demo.mode.manual": "Попробую сам",
  "landing.demo.chat.aria": "Демонстрационный диалог с ботом ZANI",
  "landing.demo.chat.welcome": "Здравствуйте! Помогу выбрать время и запишу вас.",
  "landing.demo.chat.client": "Хочу записаться на консультацию сегодня.",
  "landing.demo.chat.slots": "Сегодня свободно 16:30 и 18:00. Какое время удобнее?",
  "landing.demo.chat.confirmed": "Готово. Запись создана, напоминание придёт за час.",
  "landing.demo.chat.typing": "ZANI печатает",
  "landing.demo.chat.quickAppointment": "Записаться сегодня",
  "landing.demo.chat.quickPrice": "Узнать цену",
  "landing.demo.chat.guidedHint": "Смотрите, как работает ZANI",
  "landing.demo.chat.greetingReply": "Здравствуйте! Выберите готовый вопрос ниже или напишите, что вам нужно.",
  "landing.demo.chat.priceReply": "Стоимость зависит от услуги. Для демонстрации выберите запись, и ZANI покажет весь путь до CRM.",
  "landing.demo.chat.unknownReply": "Пока это демонстрационный диалог. Выберите готовый вариант ниже, чтобы увидеть работу CRM.",
  "landing.demo.transfer": "данные уже в CRM",
  "landing.demo.crm.aria": "Интерактивная демонстрация CRM ZANI",
  "landing.demo.crm.live": "обновляется сразу",
  "landing.demo.crm.ready": "карточка готова",
  "landing.demo.crm.waiting": "ждём сообщение",
  "landing.demo.crm.client": "Клиент",
  "landing.demo.crm.newClient": "Новый клиент",
  "landing.demo.crm.request": "Что нужно",
  "landing.demo.crm.consultation": "Консультация",
  "landing.demo.crm.appointment": "Запись",
  "landing.demo.crm.todayTime": "Сегодня, 16:30",
  "landing.demo.crm.responsible": "Ответственный",
  "landing.demo.crm.manager": "Алексей",
  "landing.demo.crm.notAssigned": "Не назначен",
  "landing.demo.crm.stage": "Этап продажи",
  "landing.demo.crm.stageNew": "Новый",
  "landing.demo.crm.stageWork": "В работе",
  "landing.demo.crm.stageBooked": "Записан",
  "landing.demo.crm.assign": "Назначить Алексея",
  "landing.demo.crm.assigned": "Алексей назначен",
  "landing.demo.crm.createTask": "Создать задачу",
  "landing.demo.crm.taskReady": "Задача создана",
  "landing.demo.result.client": "Новый клиент",
  "landing.demo.result.appointment": "Время записи",
  "landing.demo.result.value": "Ожидаемая сумма",
  "landing.demo.result.progress": "ZANI собирает результат по мере диалога",
  "landing.demo.result.complete": "Клиент записан. Сотрудник получил задачу",
  "landing.demo.result.ownerTitle": "Результат владельца",
  "landing.demo.result.progressTitle": "Сценарий в работе",
  "landing.demo.repeat": "Повторить",
  "landing.demo.scenario.aria": "Тип бизнеса для демонстрации",
  "landing.demo.scenario.label": "Покажите на примере",
  "landing.demo.privacy": "Демо ничего не отправляет и не сохраняет",
  "landing.demo.scenario.beauty.welcome": "Здравствуйте! Помогу выбрать услугу и удобное время.",
  "landing.demo.scenario.beauty.client": "Хочу записаться на маникюр сегодня.",
  "landing.demo.scenario.beauty.slots": "На маникюр свободно сегодня в 16:30 и 18:00. Какое время удобнее?",
  "landing.demo.scenario.beauty.confirmed": "Готово. Маникюр забронирован, напоминание придёт за час.",
  ...
  "landing.demo.scenario.beauty.time1": "Сегодня, 16:30",
  "landing.demo.scenario.beauty.time2": "Сегодня, 18:00",
  "landing.demo.scenario.medical.welcome": "Здравствуйте! Уточню направление и подберу время врача.",
  "landing.demo.scenario.medical.client": "Нужна консультация стоматолога.",
  "landing.demo.scenario.medical.slots": "Стоматолог принимает сегодня в 18:00 и завтра в 10:30. Какое время выбрать?",
  "landing.demo.scenario.medical.confirmed": "Запись подтверждена. Перед приёмом отправим короткое напоминание.",
  "landing.demo.scenario.medical.name": "Дмитрий Ким",
  "landing.demo.scenario.medical.request": "Консультация стоматолога",
  "landing.demo.scenario.medical.manager": "Айгуль",
  "landing.demo.scenario.medical.time1": "Сегодня, 18:00",
  "landing.demo.scenario.medical.time2": "Завтра, 10:30",
  "landing.demo.scenario.services.welcome": "Здравствуйте! Уточню задачу и найду свободного мастера.",
  "landing.demo.scenario.services.client": "Нужно установить кондиционер.",
  "landing.demo.scenario.services.slots": "Мастер может приехать завтра в 11:00 или 15:00. Какое время удобнее?",
  "landing.demo.scenario.services.confirmed": "Выезд запланирован. Мастер получил адрес и задачу.",
  "landing.demo.scenario.services.name": "Максим Орлов",
  "landing.demo.scenario.services.request": "Установка кондиционера",
  "landing.demo.scenario.services.manager": "Алексей",
  "landing.demo.scenario.services.time1": "Завтра, 11:00",
  "landing.demo.scenario.services.time2": "Завтра, 15:00",
  "landing.demo.hint.message": "Напишите сообщение или выберите готовый вариант",
  "landing.demo.hint.time": "Выберите удобное время",
  "landing.demo.hint.assign": "Назначьте ответственного сотрудника",
  "landing.demo.hint.task": "Создайте задачу сотруднику",
  "landing.demo.hint.complete": "Готово: результат виден владельцу",
  "landing.demo.guide.play": "Продолжить показ",
  "landing.demo.guide.pause": "Поставить показ на паузу",
  "landing.demo.guide.next": "Следующий шаг",
  "landing.demo.mobileTabs.aria": "Экраны демонстрации",
  "landing.demo.mobileTabs.chat": "Диалог",
  "landing.demo.mobileTabs.crm": "CRM",
  "landing.demo.mobileTabs.result": "Результат",
  "landing.demo.ai.live": "Ответ сформирован AI в демонстрационном контуре",
  "landing.demo.ai.fallback": "Безопасный демонстрационный ответ",
  "landing.demo.cta": "Создать CRM бесплатно",
  "landing.demo.proof.title": "То, что вы только что увидели",
  "landing.demo.proof.text": "Без обещаний роста и декоративных цифр. Только возможности, которые показывает демонстрация.",
  "landing.demo.proof.bot": "Бот отвечает постоянно",
  "landing.demo.proof.botText": "Диалог продолжается, даже когда администратор занят.",
  "landing.demo.proof.noCodeValue": "Без кода",
  "landing.demo.proof.noCode": "Быстрый запуск",
  "landing.demo.proof.noCodeText": "Для базового подключения не нужен разработчик или интегратор.",
  "landing.demo.proof.freeCrm": "CRM бесплатно",
  "landing.demo.proof.freeCrmText": "Клиенты, сделки, задачи и команда доступны в базовой CRM.",
  ...
  "landing.experience.hero.titlePrefix": "Клиент пишет. ZANI доводит",
  "landing.experience.hero.titleLine1": "Клиент пишет.",
  "landing.experience.hero.titleLine2": "ZANI доводит",
  "landing.experience.hero.titleAccent": "до записи",
  "landing.experience.hero.note": "пока команда занята",
  "landing.experience.hero.tryMessage": "Попробовать на своём сообщении",
  ...
  "landing.experience.pain.compact.timer": "без ответа",
  "landing.experience.pain.compact.text": "Клиент не ждёт — он продолжает искать.",
  "landing.experience.pain.compact.action": "Посмотреть ответ ZANI",
  ...
  "landing.experience.ecosystem.title": "Один диалог. Вся работа связана",
  "landing.experience.ecosystem.text": "Сообщение становится лидом, записью и задачей сотруднику без повторного ввода данных.",
  ...
  "landing.experience.cta.titlePrefix": "Начните с бесплатной CRM и настройте",
  "landing.experience.cta.titleAccent": "свой рабочий процесс",
  "landing.experience.cta.text": "Создайте кабинет без банковской карты. Каналы и команда подключаются внутри ZANI.",
  "landing.experience.proof.noCardValue": "Без карты",
  "landing.experience.proof.noCard": "Свободный старт",
  "landing.experience.proof.noCardText": "Для создания кабинета не нужны платежные данные.",
  "landing.experience.proof.demoValue": "В браузере",
  "landing.experience.proof.demo": "Проверяемый сценарий",
  "landing.experience.proof.demoText": "Диалог, CRM и результат можно пройти прямо на этой странице.",
