export const ru: Record<string, string> = {
  "aiSetup.dentalEscalation": "Передавай администратору жалобы, медицинские вопросы и просьбы поговорить с человеком.\nЕсли информации нет или она противоречива — уточни её у администратора.",
  "aiSetup.advanced": "Дополнительные настройки",
  "aiSetup.advancedText": "Инструкции, модель и вариативность ответов.",
  "aiSetup.handoffRules": "Когда передавать администратору",
  "aiSetup.dentalRole": "Администратор стоматологии",
  "aiSetup.dentalPrompt": "Ты администратор стоматологии. Отвечай на выбранном языке и в выбранном тоне. Используй только данные клиники: услуги, цены, специалистов, свободное время и базу знаний. Не ставь диагнозы и не назначай лечение. При нехватке данных задай уточняющий вопрос. Жалобы, медицинские вопросы и просьбы о человеке передавай администратору. Запись, перенос, отмену и окончательную стоимость подтверждает сотрудник; не утверждай, что выполнил эти действия.",
  "aiSetup.applyDentalRole": "Применить роль администратора стоматологии",
  "aiSetup.previewTitle": "Пробный диалог",
  "aiSetup.previewScope": "Проверяются сохранённые настройки и данные клиники. Сообщения клиентам не отправляются, CRM-записи не создаются. Тест использует запросы ИИ и сохраняется в журнале ИИ.",
  "aiSetup.previewForbidden": "Для теста нужны права управления ИИ-агентом и использования ИИ-помощника.",
  "aiSetup.saveBeforeTest": "Сохраните настройки перед проверкой",
  "aiSetup.scenario.price": "Цена",
  "aiSetup.scenario.booking": "Запись",
  "aiSetup.scenario.complaint": "Жалоба",
  "aiSetup.example.price": "Какие услуги у вас есть и сколько они стоят?",
  "aiSetup.example.booking": "Хочу записаться на завтра. Какое время свободно?",
  "aiSetup.example.complaint": "Я хочу подать жалобу. Соедините меня с администратором.",
  "aiSetup.handoff": "Требуется администратор",
  "aiSetup.automatic": "Правила допускают автоматический ответ после запуска",
  "aiSetup.draftOnly": "Автоматический ответ выключен — показана проба ответа",
  "aiSetup.message": "Сообщение от тестового клиента",
  "aiSetup.testReply": "Проверить ответ",
  "aiSetup.resetTest": "Новый тест",
  "aiSetup.launchHelp": "Для запуска нужны сохранённый профиль, знания и активный канал. Включение и пауза — переключателем сверху. Пробный диалог доступен до подключения канала.",
  "aiSetup.next": "Далее: {section}",
  "aiSetup.sourceTitle": "Услуги, цены и расписание из CRM",
  "aiSetup.sourceText": "Агент использует активные услуги и индивидуальную доступность специалистов автоматически. Здесь добавьте адрес, правила клиники и ответы на частые вопросы. Цены и графики ведите в соответствующих разделах CRM.",
  ...
  "workingHours.noAppointmentsOnDate": "Нет записей, требующих переноса или отмены.",
  "workingHours.appointmentsToReview": "Записи выбранного дня",
  "workingHours.restoreWeek": "Вернуть недельный график",
  "workingHours.saveDate": "Сохранить дату",
  "workingHours.dateExceptions": "Изменения на отдельные даты",
  "resources.setupSchedule": "Далее: индивидуальный график",
  "appointment.selectSpecialist": "Выберите активного специалиста",
  "payments.refundDateInvalid": "Возврат не может быть раньше оплаты.",
  "permissions.resource.payments": "Оплаты",
  "payments.title": "Ручной учёт",
  "finance.title": "Финансы из учётной системы",
  "finance.unavailable": "Нет финансовых данных",
  "finance.stale": "Данные не обновлены.",
  "finance.receipts": "Поступления",
  "finance.refunds": "Возвраты",
  "finance.net_receipts": "Поступления − возвраты",
  "finance.source": "Источник: {name}",
  "finance.period": "Период: {start} — {end}",
  "finance.asOf": "Обновлено: {at}",
  "finance.serviceEstimate": "Оценка стоимости услуг",
  "finance.averageServiceEstimate": "Средняя оценка услуг на клиента",
  "finance.reason.no_source": "Проверенный финансовый источник не подключён.",
  "finance.reason.unsupported_source": "Источник не подтверждает финансовые данные.",
  "finance.reason.multiple_sources": "Несколько финансовых источников: объединение не настроено.",
  "finance.reason.permission_denied": "Нет доступа к финансовым данным бизнеса.",
  "finance.reason.source_unavailable": "Финансовый источник недоступен.",
  "finance.reason.initial_sync": "Первая загрузка периода ещё не завершена.",
  "finance.reason.no_verified_snapshot": "Нет проверенных данных за этот период.",
  "finance.reason.sync_failed": "Обновление завершилось ошибкой.",
  "finance.reason.sync_stopped": "Обновление источника остановлено.",
  "finance.reason.updating": "Обновление ещё не завершено.",
  "finance.reason.snapshot_not_refreshed": "Новое обновление не подтвердило этот период.",
  "finance.reason.sync_overdue": "Плановое обновление задерживается.",
  "analytics.roiStatus.service_price_estimate_not_receipts": "Цены услуг, не фактические поступления",
  "payments.add": "Добавить оплату",
  "payments.client": "Клиент",
  "payments.deal": "Сделка",
  "payments.appointment": "Запись",
  "payments.link": "Связь с записью / сделкой",
  "payments.standalone": "Без связи — отдельная оплата",
  "payments.amount": "Сумма",
  "payments.date": "Дата и время платежа",
  "payments.method": "Способ оплаты",
  "payments.method.cash": "Наличные",
  "payments.method.card": "Карта",
  "payments.method.transfer": "Банковский перевод",
  "payments.method.other": "Другой",
  "payments.note": "Комментарий (необязательно)",
  "payments.reason": "Причина возврата",
  "payments.refund": "Зарегистрировать возврат",
  "payments.recordRefund": "Подтвердить возврат",
  "payments.record": "Зарегистрировать оплату",
  "payments.refundLimit": "Доступно к возврату: {amount} {currency}",
  "payments.manualNotice": "Ручной учёт уже полученных денег. Это не банковское подтверждение и не проведение платежа.",
  "payments.required": "Выберите или заполните это поле.",
  "payments.amountInvalid": "Укажите сумму больше нуля, не более двух знаков после запятой.",
  "payments.dateInvalid": "Укажите дату и время не позднее текущего момента.",
  "payments.checkFields": "Проверьте поля: данные не сохранены.",
  "payments.uncertain": "Результат отправки не подтверждён. Нажмите «Повторить»: будет проверена та же операция без создания дубля.",
  "payments.discardTitle": "Закрыть форму?",
  "payments.discardText": "Несохранённые данные будут потеряны.",
  "payments.uncertainClose": "Оплата могла сохраниться. Рекомендуем повторить отправку. Если закроете форму, проверьте журнал перед добавлением оплаты заново.",
  "payments.discard": "Закрыть",
  "payments.search": "Поиск по клиенту",
  "payments.noMatches": "Ничего не найдено",
  "payments.kind": "Операции",
  "payments.all": "Все операции",
  "payments.receipt": "Оплата",
  "payments.refundKind": "Возврат",
  "payments.saved": "Операция зарегистрирована.",
  "payments.empty": "Оплат не найдено",
  "payments.emptyText": "Добавьте полученную оплату или измените фильтры.",
  "payments.source": "Источник",
  "payments.manual": "Внесено вручную",
  "payments.integration": "Интеграция",
  "payments.actor": "Кто и когда внёс",
  "payments.refunded": "Возвращено",
  "payments.pagination": "Страницы журнала оплат",
  "payments.count": "Операций: {count}",
  "payments.next": "Вперёд",
  "business.navigationLabel": "Навигация по бизнесу",
  "services.statusActive": "Активна",
  "services.metricsLabel": "Ключевые показатели услуг",
  "services.statusInactive": "Неактивна",
  "services.statusArchived": "Архивирована",
  "services.archivedOnly": "Архивные",
  "services.actionOpen": "Открыть",
  "services.actionActivate": "Активировать",
  "services.actionDeactivate": "Деактивировать",
  "services.actionDelete": "Удалить",
  "services.actionArchive": "Архивировать",
  "services.actionRestore": "Восстановить",
  "services.actionMenuLabel": "Действия с услугой «{name}»",
  "services.deactivateTitle": "Деактивировать услугу?",
  "services.deactivateDescription": "Услуга «{name}» останется в списке и истории, но её нельзя будет выбрать для новых записей.",
  "services.deleteTitle": "Удалить услугу?",
  "services.deleteDescription": "Услуга «{name}» будет перемещена в архив. История записей сохранится, а руководитель сможет восстановить услугу.",
  "services.archiveTitle": "Архивировать услугу?",
  "services.archiveDescription": "Услуга «{name}» будет перемещена в архив. История записей сохранится, а руководитель сможет восстановить услугу.",
  "services.archiveReason": "Причина (необязательно)",
  "services.archiveReasonPlaceholder": "Например: услуга больше не предоставляется",
  "services.noticeActivated": "Услуга активирована и доступна для новых записей.",
  "services.noticeDeactivated": "Услуга деактивирована и скрыта из выбора для новых записей.",
  "services.noticeArchived": "Услуга перемещена в архив.",
  "services.noticeRestored": "Услуга восстановлена как неактивная.",
  "services.archivedReadOnlyTitle": "Услуга находится в архиве",
  "services.archivedReadOnlyText": "Параметры доступны только для просмотра. Восстановите услугу через меню действий, чтобы снова редактировать и активировать её.",
  "automations.runFailureSummary": "Ошибка автоматизации",
  "automations.runFailureDetails": "Запуск не завершен. Проверьте условия правила и повторите запуск.",
  "platform.operations.failureRecorded": "Зафиксирована ошибка. Откройте карточку мерчанта для дальнейшей проверки.",
  "outreach.recipientDeliveryFailed": "Отправка не выполнена",
  "outreach.recipientSkipped": "Получатель пропущен по условиям рассылки",
  "pricing.changeFailed": "Изменение не применено. Проверьте подключение и повторите попытку.",
  ...
  "mfa.addAuthenticator": "Добавьте Zani в аутентификатор",
  ...
  "mfa.codePlaceholder": "000000 или резервный код",
  ...
  "mfa.recoveryWarning": "Сохраните эти резервные коды в надёжном месте. После закрытия страницы Zani больше не покажет их повторно.",
  "mfa.copyCodes": "Скопировать коды",
  "mfa.continue": "Я сохранил коды — продолжить",
  "mfa.sessionExpiredTitle": "Подтверждение устарело",
  "mfa.sessionExpiredText": "Начните вход заново, чтобы получить новое безопасное подтверждение.",
  "mfa.backToLogin": "Вернуться ко входу",
  "mfa.accountEyebrow": "Безопасность аккаунта",
  "mfa.accountTitle": "Двухфакторная защита",
  "mfa.accountText": "Владельцы и администраторы подтверждают вход кодом из приложения. Управление относится только к вашему аккаунту.",
  "mfa.enabled": "Защита включена",
  "mfa.required": "Требуется подключение",
  "mfa.notEnabled": "Не подключено",
  "mfa.method": "Метод",
  "mfa.recoveryRemaining": "Резервных кодов",
  "mfa.activeSessions": "Активных сессий",
  "mfa.setup": "Подключить MFA",
  "mfa.newRecoveryCodes": "Новые резервные коды",
  "mfa.revokeSessions": "Завершить другие сессии",
  "mfa.disable": "Отключить MFA",
  "mfa.disableReason": "Причина отключения",
  "auth.forgotPassword": "Забыли пароль?",
  "auth.registerBusiness": "Зарегистрировать бизнес",
  "auth.backToSite": "На сайт Zani",
  ...
  "auth.loginHeroTime": "один вход",
  "auth.signupHeroText": "Заявки, сделки, записи и диалоги будут собраны в одном рабочем кабинете.",
  "auth.loginHeroText": "Продолжите работу с заявками, сделками, записями и диалогами.",
  "auth.featureCrmTitle": "Единая CRM",
  "auth.featureCrmText": "Клиенты, заявки, сделки и задачи без разрозненных таблиц.",
  "auth.featureAiTitle": "ИИ с контролем",
  "auth.featureAiText": "Подсказки основаны на данных CRM, важные действия требуют подтверждения.",
  "auth.featureBotsTitle": "Диалоги в одном месте",
  "auth.featureBotsText": "Команда видит обращения, ответственного и следующий шаг.",
  "auth.featureIntegrationsTitle": "Подключения бизнеса",
  "auth.featureIntegrationsText": "Статусы каналов и сервисов видны прямо в кабинете.",
  "auth.proofText": "Ежедневная работа команды без лишней технической сложности.",
  "auth.trustSecurity": "Защищенная сессия",
  "auth.trustServers": "Данные бизнеса разделены",
  "auth.previewWelcome": "Сегодня в работе",
  "auth.previewScanned": "Состояние бизнеса обновлено",
  "auth.previewNewLeads": "Новые заявки",
  "auth.previewBookings": "Записи",
  "auth.previewRevenue": "Выручка",
  "auth.previewPipeline": "Воронка сделок",
  "auth.previewAiTip": "ИИ-подсказка",
  "auth.previewConversion": "Конверсия",
  "auth.signInAppCopy": "Войдите, чтобы продолжить работу в CRM.",
  "auth.emailDivider": "или войдите по email",
  "auth.emailPlaceholder": "Ваш логин",
  "auth.passwordPlaceholder": "Введите пароль",
  "auth.invalidCredentials": "Неверный email или пароль.",
  "auth.loginUnavailable": "Не удалось завершить вход. Проверьте доступность сервера и повторите попытку.",
  ...
  "invite.existingAccount": "Для этого email уже есть аккаунт. Войдите в него, чтобы принять приглашение без изменения пароля.",
  "invite.signInToAccept": "Войти и принять",
  "invite.wrongAccount": "Приглашение адресовано другому аккаунту. Войдите с указанным в приглашении email.",
  ...
  "dashboard.businessScopeNeedsProcess": "По всему бизнесу · требуют обработки",
  "dashboard.teamScopeOpenFollowups": "По всей команде · в работе",
  "dashboard.teamOpenTasks": "Открытые задачи команды",
  "dashboard.noTeamOpenTasks": "У команды нет открытых задач",
  "dashboard.noTeamOpenTasksText": "Здесь появятся незавершенные задачи всех сотрудников.",
  ...
  "dashboard.taskEscalation.none": "В норме",
  "dashboard.taskEscalation.watch": "Наблюдать",
  ...
  "dashboard.latestBusinessEventsText":
    "Импортированные продажи, товары, остатки и события подключений в одном месте.",
  "dashboard.connectorHealth": "Состояние подключений",
  ...
  "dashboard.ownerBriefFallbackSource": "запись CRM",
  "dashboard.ownerBrief.staleLead.title": "Связаться: {source}",
  "dashboard.ownerBrief.staleLead.text":
    "Заявка не назначена или давно не обновлялась.",
  "dashboard.ownerBrief.overdueTask.title": "Закрыть задачу: {source}",
  "dashboard.ownerBrief.overdueTask.text":
    "Срок задачи прошел, но она все еще открыта.",
  "dashboard.ownerBrief.unansweredConversation.title":
    "Ответить в диалоге: {source}",
  "dashboard.ownerBrief.unansweredConversation.text":
    "Входящее сообщение ожидает ответа или передачи менеджеру.",
  "dashboard.ownerBrief.stalledDeal.title": "Уточнить следующий шаг: {source}",
  "dashboard.ownerBrief.stalledDeal.text":
    "Сделка открыта, но следующий шаг просрочен или не назначен.",
  "dashboard.ownerBrief.failedConnector.title": "Проверить подключение: {source}",
  "dashboard.ownerBrief.failedConnector.text":
    "Подключение требует внимания до приема новых данных в CRM.",
  ...
  "common.advanced": "Расширенные",
  "crm.activeFilters": "Активные:",
  "pagination.range": "Показано {from}—{to} из {total}",
  "pagination.previous": "Назад",
  "pagination.next": "Вперёд",
  "pagination.pageSize": "По {size}",
  "pagination.pageSizeAriaLabel": "Количество строк на странице",
  "actions.confirm": "Подтвердить",
  "actions.discardChanges": "Отменить изменения",
  "actions.undo": "Отменить",
  "actions.reasonRequired": "Укажите причину, минимум {count} символа.",
  "actions.errorValidation": "Проверьте введённые значения и повторите действие.",
  "actions.errorUnauthenticated": "Сессия завершилась. Войдите снова перед повторением действия.",
  "actions.errorForbidden": "Это действие недоступно для вашей роли или настроек бизнеса.",
  "actions.errorUnavailable": "Эта запись больше недоступна. Обновите страницу и продолжите из актуального списка.",
  "actions.errorConflict": "Запись изменилась во время работы. Обновите данные и повторите действие.",
  "actions.errorRateLimited": "Слишком много попыток. Подождите немного и повторите.",
  "actions.errorTemporary": "Сервер не завершил действие. Данные на экране сохранены; повторите через пару секунд.",
  "actions.errorNetwork": "Соединение прервалось. Изменения не потеряны; повторите, когда связь восстановится.",
  "actions.errorGeneric": "Действие не выполнено. Проверьте состояние и повторите.",
  "fallback.inline.title": "Не удалось выполнить действие",
  "fallback.page.title": "Не удалось открыть данные",
  "fallback.permission.title": "Раздел недоступен",
  "fallback.permission.guidance": "Обратитесь к владельцу или администратору бизнеса, если доступ нужен для работы.",
  "fallback.connectivity.offlineTitle": "Нет соединения",
  "fallback.connectivity.reconnectingTitle": "Восстанавливаем соединение",
  "fallback.fields.title": "Проверьте данные формы",
  "fallback.fields.description": "Исправьте отмеченные поля. Остальные данные останутся на месте.",
  "fallback.fields.invalidValue": "Проверьте значение и повторите действие.",
  "fallback.session.title": "Сессия завершилась",
  "fallback.recovery.summary": "Данные для поддержки",
  "fallback.recovery.requestId": "Код обращения",
  "fallback.recovery.copy": "Копировать",
  "fallback.recovery.copied": "Скопировано",
  ...
  "outreach.readiness.rolesText":
    "Массовые рассылки запускают владелец, администратор или маркетолог. Важные уведомления о запуске и сбоях скрыть нельзя.",
  ...
  "outreach.readiness.safetyText":
    "Перед запуском проверяются текст, аудитория, согласия получателей, готовность отправки и лимиты канала.",
  "outreach.checklistPassed": "Проверка пройдена",
  "outreach.checklistRequired": "Нужна проверка",
  ...
  "outreach.retry15": "Повторить через 15 мин",
  ...
  "outreach.launchOrderText":
    "Создание кампании не отправляет сообщения. Сначала сохраните рассылку, затем подготовьте аудиторию, проверьте готовность и только после этого запускайте отправку.",
  ...
  "outreach.optInOnly": "Только с согласием",
  "outreach.noOptInCheck": "Без проверки согласия",
  "outreach.segment": "Сегмент",
  "outreach.selectSegment": "Выберите сегмент",
  "outreach.templateStatus": "Статус шаблона",
  "outreach.rateLimit": "Лимит в минуту",
  "outreach.batchSize": "Размер партии",
  ...
  "outreach.productionModeNotice":
    "Клиенты без согласия или с отказом будут пропущены. Рассылка WhatsApp запускается только после одобрения шаблона.",
  ...
  "outreach.manualAudienceText":
    "Выбрано: {count}. В отправку попадут только клиенты с идентификатором канала и действующим согласием.",
  ...
  "outreach.whatsappTemplate": "Шаблон WhatsApp",
  "outreach.whatsappTemplateName": "Название шаблона WhatsApp",
  ...
  "outreach.launchBlockedChecklist":
    "Сначала подготовьте аудиторию и пройдите проверку готовности.",
  ...
  "appointment.resourceHintText": "Добавьте активного специалиста и настройте его индивидуальный график, чтобы создать запись.",
  ...
  "appointment.resource": "Специалист",
  ...
  "workingHours.viewsLabel": "Раздел графика работы",
  ...
  "workingHours.metricsLabel": "Показатели графика работы",
  "workingHours.businessDaysHint": "дни с общим рабочим интервалом",
  "workingHours.resourceSchedulesHint": "ресурсы с собственным графиком",
  "workingHours.daysOffHint": "явно заданные выходные в графиках",
  "workingHours.quickToolbarHint": "Применяется к общему графику бизнеса",
  "workingHours.presetLabel": "Шаблон графика",
  "workingHours.applyPresetTitle": "Применить шаблон к графику бизнеса?",
  "workingHours.applyPresetDescription": "Текущие настройки общей недели будут заменены выбранным шаблоном.",
  "workingHours.discardChanges": "Отменить несохранённые изменения графика?",
  "workingHours.businessInspectorSubtitle": "Общий график, используемый бизнесом и ресурсами без индивидуальной недели",
  "workingHours.resourceInspectorSubtitle": "Индивидуальная неделя выбранного сотрудника или ресурса",
  "workingHours.businessSchedule": "Общий график",
  "workingHours.individualSchedule": "Индивидуальный",
  "workingHours.readOnlyTitle": "Режим просмотра",
  "workingHours.readOnlyText": "Ваша роль может просматривать графики, но не может изменять их.",
  "workingHours.workingDay": "Рабочий день",
  "workingHours.businessWeekHint": "Основной график для записи клиентов",
  "workingHours.businessWeekTableLabel": "Общий недельный график бизнеса",
  "workingHours.resourceListHint": "Наследование общего графика и индивидуальные недели",
  "workingHours.searchResources": "Поиск по ресурсам...",
  "workingHours.scheduleFilter": "Фильтр по типу графика",
  "workingHours.allSchedules": "Все графики",
  "workingHours.resourceScheduleTableLabel": "Графики сотрудников и ресурсов",
  "workingHours.scheduleMode": "Тип графика",
  "workingHours.workingDays": "Рабочих дней",
  "workingHours.openResourceSchedule": "Открыть график: {name}",
  "workingHours.noResourcesFound": "По выбранным условиям ресурсы не найдены.",
  ...
  "services.statusFilter": "Статус услуги",
  "services.allStatuses": "Все статусы",
  "services.activeOnly": "Активные",
  "services.inactiveOnly": "Неактивные",
  "services.tableLabel": "Список услуг",
  "services.selectService": "Выбрать услугу «{name}»",
  "services.openDetails": "Открыть параметры услуги «{name}»",
  "services.inspectorSubtitle": "Параметры услуги и использование в записях",
  "services.usageTitle": "Использование в записях",
  "services.usageText": "Услуга используется в {count} записях из загруженной истории.",
  "services.readOnlyTitle": "Режим просмотра",
  "services.readOnlyText": "У вашей роли нет права изменять настройки услуг.",
  "services.discardChanges": "Отменить несохранённые изменения услуги?",
  "services.noResultsTitle": "Услуги не найдены",
  "services.noResultsText": "Измените поисковый запрос или сбросьте фильтр статуса.",
  "services.noticeSaved": "Изменения услуги сохранены.",
  "services.noticeCreated": "Услуга добавлена.",
  ...
  "resources.noLinkedUser": "Без доступа в CRM",
  "resources.available": "Доступен для записи",
  "resources.save": "Сохранить",
  "resources.searchPlaceholder": "Поиск сотрудников и ресурсов...",
  "resources.typeFilter": "Фильтр по типу",
  "resources.allTypes": "Все типы",
  "resources.statusFilter": "Фильтр по статусу",
  "resources.allStatuses": "Все статусы",
  "resources.activeOnly": "Только активные",
  "resources.inactiveOnly": "Только неактивные",
  "resources.quickCreate": "Быстрое добавление",
  "resources.useTemplate": "Создать",
  "resources.noResultsTitle": "Ресурсы не найдены",
  "resources.noResultsText": "Измените поиск или фильтры, чтобы увидеть ресурсы.",
  "resources.selectResource": "Открыть ресурс «{name}»",
  "resources.tableLabel": "Сотрудники и ресурсы",
  "resources.scheduleState": "Расписание",
  "resources.individualSchedule": "Индивидуальный график",
  "resources.businessSchedule": "Общий график",
  "resources.statusActive": "Активен",
  "resources.statusInactive": "Неактивен",
  "resources.actionOpen": "Открыть",
  "resources.actionActivate": "Активировать",
  "resources.actionDeactivate": "Деактивировать",
  "resources.actionMenuLabel": "Действия с ресурсом «{name}»",
  "resources.noticeCreated": "Ресурс создан",
  "resources.noticeSaved": "Изменения ресурса сохранены",
  "resources.noticeActivated": "Ресурс активирован",
  "resources.noticeDeactivated": "Ресурс деактивирован",
  "resources.deactivateTitle": "Деактивировать ресурс?",
  "resources.deactivateDescription": "Ресурс «{name}» станет недоступен для новых записей.",
  "resources.discardChanges": "Закрыть ресурс и отменить несохранённые изменения?",
  "resources.inspectorSubtitle": "Параметры ресурса и его расписание",
  "resources.readOnlyTitle": "Только просмотр",
  "resources.readOnlyText": "У вашей роли нет права изменять ресурсы. Обратитесь к владельцу бизнеса.",
  "resources.usageTitle": "Использование в записях",
  "resources.usageText": "Записей с этим ресурсом: {count}.",
  "resources.scheduleTitle": "Рабочее расписание",
  "resources.openSchedule": "Открыть полный график",
  "resources.metricsLabel": "Сводка по сотрудникам и ресурсам",
  ...
  "clients.consentStatus": "Согласия",
  "clients.consentOptedIn": "Разрешено",
  "clients.consentOptedOut": "Запрещено",
  "clients.consentUnknown": "Не указано",
  ...
  "clients.filtersAriaLabel": "Фильтры клиентов",
  ...
  "clients.tabOverview": "Обзор",
  "clients.tabDeals": "Сделки {count}",
  "clients.tabTasks": "Задачи {count}",
  "clients.tabFiles": "Файлы",
  "clients.noDeals": "Сделок пока нет.",
  "clients.noDealsOpenValue": "Сделок пока нет. Открыто: {value}",
  "clients.noFiles": "Файлы пока не добавлены.",
  ...
  "crmCard.timelineCategoryAppointment": "Запись",
  "crmCard.timelineCategoryTask": "Задача",
  "crmCard.timelineCategoryAutomation": "Автоматизация",
  "crmCard.timelineCategorySystem": "Система",
  "crmCard.timelineFieldAction": "Действие",
  "crmCard.timelineFieldStatus": "Статус",
  "crmCard.timelineFieldStage": "Этап",
  "crmCard.timelineFieldTime": "Время",
  "crmCard.timelineFieldAmount": "Сумма",
  "crmCard.timelineFieldAssignee": "Исполнитель",
  "crmCard.timelineFieldReason": "Причина",
  "crmCard.timelineFieldLostReason": "Причина отказа",
  "crmCard.timelineFieldClearedReason": "Сброшенная причина",
  "crmCard.timelineFieldResource": "Ресурс",
  "crmCard.timelineFieldClient": "Клиент",
  "crmCard.timelineFieldLead": "Заявка",
  "crmCard.timelineFieldDeal": "Сделка",
  "crmCard.timelineFieldAppointment": "Запись",
  "crmCard.timelineFieldTask": "Задача",
  "crmCard.timelineFieldConversation": "Диалог",
  "crmCard.timelineFieldChannel": "Канал",
  "crmCard.timelineFieldIntegrationEvent": "Событие интеграции",
  "crmCard.timelineFieldConnector": "Коннектор",
  "crmCard.timelineFieldExternalId": "Внешний ID",
  "crmCard.timelineFieldBusinessEvent": "Бизнес-событие",
  "crmCard.timelineFieldTool": "Инструмент",
  ...
  "tasks.noConversation": "Без диалога",
  "tasks.due": "до",
  ...
  "tasks.workloadTitle": "Нагрузка",
  "tasks.workloadActiveCount": "{count} активных задач",
  "tasks.workloadAssigneeCount": "{count} исполнителей",
  "tasks.workloadOpen": "Открыто",
  "tasks.workloadProgress": "В работе",
  "tasks.workloadOverdue": "Просрочено",
  "tasks.workloadToday": "Сегодня",
  "tasks.workloadPriority": "Приоритет",
  "tasks.workloadOldest": "Старшая",
  "tasks.workloadStatus.idle": "Свободен",
  "tasks.workloadStatus.balanced": "Норма",
  "tasks.workloadStatus.busy": "Загружен",
  "tasks.workloadStatus.overloaded": "Перегруз",
  ...
  "conversations.suggestionStatus": "Подсказка",
  ...
  "conversations.allHandoff": "Все передачи менеджеру",
  "conversations.needsManager": "Требуют менеджера",
  "conversations.noHandoff": "Без передачи менеджеру",
  ...
  "conversations.deliveryTitle": "Доставка ответа",
  "conversations.deliveryStatusQueued": "в очереди",
  "conversations.deliveryStatusSending": "отправляется",
  "conversations.deliveryStatusDelivered": "принято каналом",
  "conversations.deliveryStatusDelayed": "отложено",
  "conversations.deliveryStatusRetrying": "повторяется",
  "conversations.deliveryStatusFailed": "не доставлено",
  "conversations.deliveryHelpQueued": "Ответ сохранён и ожидает отправки в канал.",
  "conversations.deliveryHelpSending": "Ответ передаётся подключённому каналу.",
  "conversations.deliveryHelpDelivered": "Канал подтвердил приём ответа.",
  "conversations.deliveryHelpDelayed": "Повторная попытка запланирована автоматически.",
  "conversations.deliveryHelpRetrying": "Система выполняет повторную попытку отправки.",
  "conversations.deliveryHelpFailed": "Ответ не доставлен, но сообщение сохранено в истории.",
  "conversations.deliveryAttempts": "Попытки: {attempts} из {max}",
  "conversations.retryDelivery": "Повторить отправку",
  "conversations.deliveryRetryNotAllowed": "Для повторной отправки нужна роль с правом изменять диалоги.",
  ...
  "analytics.teamPerformanceText":
    "Контроль качества команды: заявки, передачи менеджеру, сделки и задачи.",
  ...
  "settings.notifications.category.outreach.text":
    "Подготовка кампаний, запуск, завершение, отписки и ошибки кампаний.",
  ...
  "settings.paymentMethod.empty": "Не выбран",
  "settings.paymentMethod.invoice": "Счёт на оплату",
  "settings.paymentMethod.card": "Банковская карта",
  "settings.paymentMethod.bankTransfer": "Банковский перевод",
  "settings.invoiceName": "Получатель счёта",
  "settings.invoiceTaxId": "БИН / ИИН",
  ...
  "businessForm.slug": "Адрес кабинета",
  ...
  "businessForm.slaMinutes": "Норма ответа, минут",
  ...
  "businessForm.brandLogoUrl": "Адрес логотипа",
  ...
  "aiAgents.section.actions": "Действия",
  ...
  "aiAgents.searchPlaceholder": "Поиск агента",
  "aiAgents.filterStatus": "Фильтр по статусу",
  "aiAgents.allStatuses": "Все статусы",
  "aiAgents.agentListAria": "Список ИИ-агентов",
  "aiAgents.purposeMissing": "Назначение профиля ещё не настроено.",
  "aiAgents.noMatches": "По заданным условиям агенты не найдены.",
  "aiAgents.totalCount": "Всего агентов: {count}",
  "aiAgents.editorAria": "Редактор агента {name}",
  "aiAgents.statusSwitch": "Изменить статус агента {name}",
  "aiAgents.editorTabsAria": "Разделы редактора агента",
  "aiAgents.unsavedIndicator": "Есть несохранённые изменения.",
  "aiAgents.savedIndicator": "Изменения сохранены.",
  "aiAgents.saveChanges": "Сохранить изменения",
  "aiAgents.unsavedTitle": "Несохранённые изменения",
  "aiAgents.unsavedText": "При смене агента или выходе со страницы несохранённые изменения будут потеряны.",
  ...
  "aiAgents.status.activeBlocked": "Запуск заблокирован",
  ...
  "automations.details": "Детали",
  "automations.cancelRun": "Отменить запуск",
  "automations.runDetailTitle": "Запуск автоматизации",
  "automations.status": "Статус",
  "automations.runRule": "Правило",
  "automations.runEntity": "Сущность",
  "automations.attempts": "Попытки",
  "automations.runCreated": "Создан",
  "automations.runStarted": "Начат",
  "automations.runFinished": "Завершен",
  "automations.runError": "Ошибка",
  "automations.runPayload": "Payload",
  "automations.runResults": "Результаты действий",
  ...
  "automations.trigger.leadStatusChanged": "Статус заявки изменен",
  "automations.trigger.dealStageChanged": "Стадия сделки изменена",
  ...
  "automations.trigger.botMessageReceived": "Сообщение от бота",
  "automations.trigger.conversationUnread": "Диалог стал непрочитанным",
  "automations.trigger.appointmentCreated": "Создана запись",
  "automations.trigger.appointmentCancelled": "Запись отменена",
  "automations.trigger.appointmentCompleted": "Запись завершена",
  ...
  "automations.action.assignUser": "Назначить пользователя",
  "automations.action.addNote": "Добавить заметку",
  "automations.action.createFollowUp": "Создать follow-up",
  ...
  "deals.stageNew": "Новая сделка",
  "deals.stageQualification": "Квалификация",
  "deals.stageProposal": "Предложение",
  "deals.stageNegotiation": "Согласование",
  "deals.stageWon": "Успешно",
  "deals.stageLost": "Потеряно",
  ...
  "deals.hot": "Горячие",
  "deals.noTasksFilter": "Без задач",
  "deals.clearSearch": "Очистить поиск",
  ...
  "deals.sourceOnboarding": "Первичная настройка",
  ...
  "deals.sections": "Разделы сделки",
  "deals.tabOverview": "Обзор",
  "deals.tabActivities": "Активности",
  "deals.tabHistory": "История",
  ...
  "deals.riskNormalWithPercent": "Норма {percent}%",
  ...
  "integrations.provider.ozonUse": "Заказы, остатки и отмены на маркетплейсе.",
  ...
  "integrations.provider.emailUse": "Уведомления, входящие письма и резервная доставка.",
  "crmCard.timelineEvent.integration_event": "Получены данные из подключения",
  ...
  "integrations.import.deals": "Сделки",
  ...
  "integrations.import.rowNeedsReview": "Проверьте данные в строке {row}.",
  "integrations.import.columnsNeedReview": "Проверьте обязательные колонки файла.",
  ...
  "analytics.leadToDeal": "Конверсия в сделки",
  "analytics.leadToDealHint": "заявки, перешедшие в сделки",
  "analytics.wonValue": "Сумма выигранных сделок",
  "analytics.wonValueHint": "Сумма сделок, не фактические поступления",
  "analytics.unansweredConversations": "Диалоги без ответа",
  "analytics.unansweredConversationsHint": "непрочитанные или ожидающие менеджера",
  "analytics.connectorErrors": "Ошибки подключений",
  "analytics.appointmentRate": "Доля записей",
  "analytics.aiOpenSources": "Открыть источники",
  "analytics.aiCard.overdue_tasks.title": "Просроченные задачи требуют внимания",
  "analytics.aiCard.overdue_tasks.description":
    "Просрочено задач: {value}. Основано на {sources} записях задач.",
  "analytics.aiCard.unanswered_conversations.title":
    "Клиенты ждут ответа во входящих",
  "analytics.aiCard.unanswered_conversations.description":
    "Без ответа или передачи менеджеру: {value}. Основано на {sources} диалогах.",
  "analytics.aiCard.failed_connectors.title": "Есть проблемы с подключениями",
  "analytics.aiCard.failed_connectors.description":
    "Подключений с ошибкой: {value}. Проверено источников: {sources}.",
  "analytics.aiCard.appointment_no_show_rate.title": "Высокая доля неявок",
  "analytics.aiCard.appointment_no_show_rate.description":
    "Доля неявок — {value}%. Основано на {sources} записях.",
  "analytics.aiCard.lead_to_deal_missing.title":
    "Заявки не переходят в сделки",
  "analytics.aiCard.lead_to_deal_missing.description":
    "У {value} доступных заявок ещё нет связанной сделки.",
  "analytics.aiCard.crm_operating_norm.title": "Работа CRM стабильна",
  "analytics.aiCard.crm_operating_norm.description":
    "По текущим операционным показателям срочных отклонений нет.",
  "analytics.aiCard.no_operational_data.title": "Пока недостаточно данных",
  "analytics.aiCard.no_operational_data.description":
    "Подключите каналы или импортируйте данные, чтобы получить обоснованные выводы.",
  ...
  "dashboard.needReply": "Нужно ответить",
  "dashboard.unreadConversationCount": "Непрочитано: {count}",
  "dashboard.overdueWork": "Просроченная работа",
  "dashboard.noUnreadConversations": "Нет диалогов, требующих ответа",
  "dashboard.noUnreadConversationsText": "Очереди непрочитанных и переданных диалогов чисты в рамках вашего доступа.",
  "dashboard.failedConnectors": "Сбои подключений",
  "dashboard.failedConnectorsText": "Подключений требуют восстановления: {count}",
  "calendar.openTodayTasks": "Открыть задачи на сегодня",
  "calendar.emptyDayTitle": "На этот день нет запланированной работы",
  "calendar.emptyDayText": "В рамках вашего доступа нет записей или задач со сроком на этот день.",
  ...
  "conversations.openIntegrations": "Открыть подключения каналов",
  "conversations.useSuggestedReply": "Вставить рекомендацию в ответ",
  "conversations.nextAction.handoff_sla_overdue": "Просрочена передача диалога оператору",
  "conversations.nextAction.unread_sla_overdue": "Просрочен ответ клиенту",
  "conversations.nextAction.review_unread": "Разобрать непрочитанные",
  "conversations.nextAction.take_handoffs": "Забрать диалоги у бота",
  "conversations.nextAction.assign_owners": "Назначить ответственных",
  "conversations.nextAction.connect_channel": "Подключить канал сообщений",
  "integrations.page.merchantDescription": "Подключайте каналы и внешние сервисы, проверяйте их состояние и восстанавливайте обмен данными.",
  "integrations.page.merchantRequestText": "Подключение требует заявки и подтверждения со стороны сервиса.",
  ...
  "leads.takeInWork": "Взять в работу",
  "signup.passwordMinCheck": "Не менее 8 символов",
  "signup.passwordLettersNumbersCheck": "Буквы и цифры",
  "signup.passwordNoSpacesCheck": "Без пробелов",
  "signup.createCompanyTitle": "Создайте рабочее пространство",
  "signup.createCompanyText": "Укажите данные бизнеса, чтобы настроить CRM.",
  "signup.namePlaceholder": "Ваше имя",
  "signup.passwordPlaceholder": "Придумайте пароль",
  "signup.businessNamePlaceholder": "Название бизнеса",
  "signup.cityPlaceholder": "Город",
  "signup.afterSignInHelper": "После регистрации вы сможете пригласить команду и настроить рабочие процессы.",
  "signup.freeSubmit": "Создать аккаунт",
  "signup.terms": "Регистрируясь, вы принимаете условия использования и политику конфиденциальности.",
  "tasks.status": "Статус",
  "tasks.savedNotice": "Изменения сохранены.",
  "tasks.quickActions": "Быстрые действия",
  "deals.riskPercentShort": "Риск {percent}%",
  "deals.openDealContext": "Открыть сделку «{title}»",
  "leads.selectLeadRowContext": "Выбрать заявку «{title}»",
  "leads.openContext": "Открыть заявку «{title}»",
  "leads.callContext": "Позвонить клиенту по заявке «{title}»",
  "leads.whatsappContext": "Написать в WhatsApp клиенту по заявке «{title}»",
  "leads.moreActionsContext": "Дополнительные действия для заявки «{title}»",
  "conversations.openClientContext": "Открыть карточку клиента «{title}»",
  "integrations.card.configureContext": "Настроить подключение {title}",
  "integrations.card.connectContext": "Подключить {title}",
  "crmCard.note": "Заметка",
  "timeline.searchPlaceholder": "Событие или клиент",
  "timeline.category": "Категория",
  "timeline.allCategories": "Все категории",
  "timeline.actor": "Исполнитель",
  "timeline.actorSelected": "Исполнитель выбран",
  "timeline.allActors": "Все исполнители",
  "timeline.noActor": "Без исполнителя",
  "timeline.unknownActor": "Имя недоступно",
  "timeline.actorSearch": "Поиск исполнителя",
  "timeline.noActorsFound": "Исполнители не найдены",
  "timeline.dateFrom": "С даты",
  "timeline.dateTo": "По дату",
  "timeline.reset": "Сбросить фильтры",
  "timeline.event": "Событие",
  "timeline.object": "Клиент / объект",
  "timeline.time": "Время",
  "timeline.details": "Детали события",
  "timeline.openDetails": "Открыть детали события",
  "timeline.descriptionLabel": "Изменения",
  "timeline.noDetails": "Нет доступных дополнительных сведений.",
  "timeline.emptyFilteredText": "Измените поиск или сбросьте фильтры, чтобы увидеть события.",
  "timeline.otherEvent": "Событие в истории",
  "timeline.range": "Показано {from}–{to} из {total}",
  "timeline.pageSize": "Событий на странице",
  "timeline.perPage": "По {count}",
  "common.edit": "Изменение",
  "analytics.detailedReports": "Подробные отчёты",
  "analytics.detailedReportsHint": "источники, воронка и услуги",
  "analytics.dataQuality.estimate_from_completed_appointments": "По ценам услуг завершённых записей, не фактические поступления",
  "analytics.roiStatus.tracked_without_cost": "Доход отслеживается без учёта расходов",
  "analytics.source.unknown": "Источник не указан",
  "analytics.source.manual": "Вручную",
  "analytics.source.website": "Сайт",
  "analytics.source.telegram": "Telegram",
  "analytics.source.whatsapp": "WhatsApp",
  "analytics.action.overdue_handoff.title": "Подключиться к просроченным диалогам",
  "analytics.action.overdue_handoff.description": "{count} диалогов ждут менеджера дольше нормы.",
  "analytics.action.missed_chat.title": "Ответить в диалогах без ответа",
  "analytics.action.missed_chat.description": "В {count} назначенных диалогах ещё нет ответа клиенту.",
  "analytics.action.sla_overdue_deal.title": "Проверить сделки с просроченным сроком",
  "analytics.action.sla_overdue_deal.description": "{count} сделок находятся на этапе дольше нормы.",
  "analytics.action.overdue_task.title": "Закрыть просроченные задачи",
  "analytics.action.overdue_task.description": "Просрочено задач: {count}.",
  "aiAgents.channelSetupUnavailable": "Настройка канала не открылась. Закройте окно и повторите подключение.",
  "aiAgents.agentPickerAria": "Выбрать ИИ-агента",
  "aiAgents.activationBlocked": "Перед включением агента завершите обязательные шаги запуска.",
  "aiAgents.channelsPermissionDenied": "Ваша роль может настраивать агента, но не может подключать или изменять внешние каналы.",
  "aiAgents.conversationsPermissionDenied": "Ваша роль не может просматривать диалоги для проверки этого агента.",
  "aiAgents.sectionLoading": "Загружаем этот раздел...",
  "aiAgents.aiProviderLive": "Ответ подготовлен подключённым ИИ-провайдером",
  "aiAgents.aiProviderMock": "Безопасный тестовый ответ: рабочий ИИ-провайдер не настроен",
  "aiAgents.aiProviderDetails": "Провайдер: {provider}. Модель: {model}.",
  "aiAgents.aiSources": "Источники, использованные для ответа",
  "aiAgents.saveAndContinue": "Сохранить и продолжить",
  "aiAgents.knowledgeSharedScopeTitle": "Общая база знаний бизнеса",
