...
from apps.accounts.views import ChangePasswordView, CurrentUserLoginHistoryView, CurrentUserView, LogoutView, OwnerSignupView, PasswordResetConfirmView, PasswordResetRequestView, SocialAuthView
...
from apps.mobile.views import (
    MobileActionsView,
    MobileApprovalApproveView,
    MobileApprovalRejectView,
    MobileAppointmentCancelView,
    MobileAppointmentConfirmView,
    MobileAppointmentDetailView,
    MobileAppointmentsView,
    MobileAppointmentRescheduleView,
    MobileBootstrapView,
    MobileClientsView,
    MobileClientDetailView,
    MobileDeviceListView,
    MobileDeviceRegisterView,
    MobileDeviceRevokeView,
    MobileHomeView,
    MobileInboxView,
    MobileInboxDetailView,
    MobileInboxReplyView,
    MobileLeadAssignView,
    MobileLeadDetailView,
    MobileLeadQualifyView,
    MobileLeadsView,
    MobileLoginView,
    MobileLogoutView,
    ...
    MobileOperationalSummaryView,
    MobilePushTokenRegisterView,
    MobileRefreshView,
    MobileTasksView,
    MobileTaskCompleteView,
    MobileTaskDetailView,
    MobileTaskAssignToMeView,
    MobileTaskCancelView,
    MobileTaskSnoozeView,
    MobileTodayView,
)
...
urlpatterns = [
    ...
    path("api/mobile/v1/auth/login/", MobileLoginView.as_view(), name="mobile_auth_login"),
    path("api/mobile/v1/auth/refresh/", MobileRefreshView.as_view(), name="mobile_auth_refresh"),
    path("api/mobile/v1/auth/logout/", MobileLogoutView.as_view(), name="mobile_auth_logout"),
    path("api/mobile/v1/devices/register/", MobileDeviceRegisterView.as_view(), name="mobile_device_register"),
    path("api/mobile/v1/devices/", MobileDeviceListView.as_view(), name="mobile_device_list"),
    path("api/mobile/v1/devices/<int:device_id>/revoke/", MobileDeviceRevokeView.as_view(), name="mobile_device_revoke"),
    path("api/mobile/v1/push-tokens/register/", MobilePushTokenRegisterView.as_view(), name="mobile_push_register"),
    path("api/mobile/v1/operations/summary/", MobileOperationalSummaryView.as_view(), name="mobile_operations_summary"),
    path("api/mobile/v1/bootstrap/", MobileBootstrapView.as_view(), name="mobile_bootstrap"),
    path("api/mobile/v1/home/", MobileHomeView.as_view(), name="mobile_home"),
    path("api/mobile/v1/today/", MobileTodayView.as_view(), name="mobile_today"),
    path("api/mobile/v1/actions/", MobileActionsView.as_view(), name="mobile_actions"),
    path("api/mobile/v1/inbox/", MobileInboxView.as_view(), name="mobile_inbox"),
    path("api/mobile/v1/inbox/<int:conversation_id>/", MobileInboxDetailView.as_view(), name="mobile_inbox_detail"),
    path("api/mobile/v1/inbox/<int:conversation_id>/reply/", MobileInboxReplyView.as_view(), name="mobile_inbox_reply"),
    path("api/mobile/v1/leads/", MobileLeadsView.as_view(), name="mobile_leads"),
    path("api/mobile/v1/leads/<int:lead_id>/", MobileLeadDetailView.as_view(), name="mobile_lead_detail"),
    path("api/mobile/v1/leads/<int:lead_id>/assign/", MobileLeadAssignView.as_view(), name="mobile_lead_assign"),
    path("api/mobile/v1/leads/<int:lead_id>/qualify/", MobileLeadQualifyView.as_view(), name="mobile_lead_qualify"),
    path("api/mobile/v1/notifications/", MobileNotificationsView.as_view(), name="mobile_notifications"),
    path("api/mobile/v1/notification-preferences/", MobileNotificationPreferencesView.as_view(), name="mobile_notification_preferences"),
    path("api/mobile/v1/notifications/<int:notification_id>/mark-read/", MobileNotificationMarkReadView.as_view(), name="mobile_notification_mark_read"),
    path("api/mobile/v1/clients/", MobileClientsView.as_view(), name="mobile_clients"),
    path("api/mobile/v1/clients/<int:client_id>/", MobileClientDetailView.as_view(), name="mobile_client_detail"),
    path("api/mobile/v1/tasks/", MobileTasksView.as_view(), name="mobile_tasks"),
    path("api/mobile/v1/tasks/<int:task_id>/", MobileTaskDetailView.as_view(), name="mobile_task_detail"),
    path("api/mobile/v1/tasks/<int:task_id>/complete/", MobileTaskCompleteView.as_view(), name="mobile_task_complete"),
    path("api/mobile/v1/tasks/<int:task_id>/assign-to-me/", MobileTaskAssignToMeView.as_view(), name="mobile_task_assign_to_me"),
    path("api/mobile/v1/tasks/<int:task_id>/cancel/", MobileTaskCancelView.as_view(), name="mobile_task_cancel"),
    path("api/mobile/v1/tasks/<int:task_id>/snooze/", MobileTaskSnoozeView.as_view(), name="mobile_task_snooze"),
    path("api/mobile/v1/appointments/", MobileAppointmentsView.as_view(), name="mobile_appointments"),
    path("api/mobile/v1/appointments/<int:appointment_id>/", MobileAppointmentDetailView.as_view(), name="mobile_appointment_detail"),
    path("api/mobile/v1/appointments/<int:appointment_id>/confirm/", MobileAppointmentConfirmView.as_view(), name="mobile_appointment_confirm"),
    path("api/mobile/v1/appointments/<int:appointment_id>/cancel/", MobileAppointmentCancelView.as_view(), name="mobile_appointment_cancel"),
    path("api/mobile/v1/appointments/<int:appointment_id>/reschedule/", MobileAppointmentRescheduleView.as_view(), name="mobile_appointment_reschedule"),
    path("api/mobile/v1/ai/approval-requests/<int:approval_id>/approve/", MobileApprovalApproveView.as_view(), name="mobile_ai_approval_approve"),
    path("api/mobile/v1/ai/approval-requests/<int:approval_id>/reject/", MobileApprovalRejectView.as_view(), name="mobile_ai_approval_reject"),
