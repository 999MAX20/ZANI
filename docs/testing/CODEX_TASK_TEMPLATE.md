...
Корневой [STATUS.md](../../STATUS.md) после AGENTS.md даёт краткую картину
и ссылки на текущую задачу. При смене scope, существенном результате, блокере
и перед завершением/согласованной передачей обновлять его краткую сводку;
подробные проверки и попытки сохранять в существующем checkpoint. Это не
автоматическое сохранение и не разрешение новому чату стать владельцем.
