...
def get_wildberries_api_token(connector):
    return read_connector_credential(connector, "api_token", expired_error="Wildberries API token expired.")
...
def validate_wildberries_credentials(connector):
    ...
    try:
        ...
        logger.exception("integrations.wildberries.credentials_validation_failed")
...
def sync_wildberries(connector):
    ...
    try:
        ...
        logger.exception("integrations.wildberries.sync_failed", extra={"connector_id": connector.id})
