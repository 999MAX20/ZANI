...
This document is retained as historical UI/UX context. Use `../design-system.md`, `../product-ui-reform.md`, `../ui-ux-polish-phase-10.md` and `../../crm/CRM_PRODUCTION_LAYER_PLAN.md` as current implementation inputs unless a newer active frontend roadmap is added to `docs/frontend/`.
