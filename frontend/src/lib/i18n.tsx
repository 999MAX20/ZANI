...
const kk: Dictionary = {
  ...
  "aiAgents.loading": "AI agents жүктелуде...",
  "aiAgents.noBusiness": "AI agents баптау үшін бизнес жасаңыз.",
  "aiAgents.eyebrow": "Агент профильдері",
  "aiAgents.title": "AI agents",
  "aiAgents.description": "AI черновиктері үшін басқарылатын мінез-құлық профильдері. Олар жауап дайындауға көмектеседі, бірақ хабарламаны автоматты жібермейді.",
