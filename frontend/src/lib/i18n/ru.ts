export const ru: Record<string, string> = {
  ...
  "landing.experience.channel.kaspi": "Новый заказ",
  ...
  "landing.experience.hero.kicker": "AI-экосистема для бизнеса",
  "landing.experience.hero.titlePrefix": "Ваш бизнес наконец работает",
  "landing.experience.hero.titleAccent": "спокойно",
  "landing.experience.hero.note": "даже когда команда занята",
  "landing.experience.hero.text": "ZANI отвечает клиентам, создает заявки, ведет CRM, подключает маркетплейсы и показывает владельцу картину дня без ручного контроля.",
  ...
  "landing.experience.pain.text": "Пока команда переключается между мессенджерами, звонками и таблицами, клиент уже получает ответ в другом месте.",
  ...
  "landing.experience.owner.title": "Вы открываете кабинет — и все спокойно",
