...
export const en: Record<string, string> = {
  ...
  "landing.experience.channel.kaspi": "New order",
  ...
  "landing.experience.hero.kicker": "AI ecosystem for business",
  "landing.experience.hero.titlePrefix": "Your business finally works",
  "landing.experience.hero.titleAccent": "calmly",
  "landing.experience.hero.note": "even when the team is busy",
  "landing.experience.hero.text": "ZANI answers clients, creates leads, runs CRM, connects marketplaces and shows the owner the day without manual control.",
