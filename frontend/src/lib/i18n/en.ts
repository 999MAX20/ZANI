...
export const en: Record<string, string> = {
  ...
  "aiSetup.previewScope": "Uses saved settings and clinic data. Sends no customer messages and creates no CRM records. The test consumes AI requests and is recorded in the AI log.",
  "aiSetup.previewForbidden": "Testing requires AI agent management and AI assistant suggestion permissions.",
  "aiSetup.saveBeforeTest": "Save settings before testing",
  "aiSetup.scenario.price": "Price",
  "aiSetup.scenario.booking": "Booking",
  "aiSetup.scenario.complaint": "Complaint",
  "aiSetup.example.price": "Which services do you offer and how much do they cost?",
  "aiSetup.example.booking": "I would like an appointment tomorrow. What times are available?",
  "aiSetup.example.complaint": "I want to make a complaint. Please connect me to an administrator.",
  "aiSetup.handoff": "Administrator required",
  "aiSetup.automatic": "Rules allow an automatic reply after launch",
  "aiSetup.draftOnly": "Automatic replies are off — showing a test answer",
  "aiSetup.message": "Test customer message",
  "aiSetup.testReply": "Test reply",
  "aiSetup.resetTest": "New test",
  "aiSetup.launchHelp": "Launch requires a saved profile, knowledge and an active channel. Use the switch above to activate or pause. Test before connecting a channel.",
  "aiSetup.next": "Next: {section}",
  "aiSetup.sourceTitle": "Services, prices and schedules from CRM",
  "aiSetup.sourceText": "The agent automatically uses active services and individual specialist availability. Add the address, clinic policies and FAQ here. Maintain prices and schedules in their CRM sections.",
  ...
  "payments.title": "Manual accounting",
  "finance.title": "Finance from accounting system",
  "finance.unavailable": "No financial data",
  "finance.stale": "Data has not been refreshed.",
  "finance.receipts": "Receipts",
  "finance.refunds": "Refunds",
  "finance.net_receipts": "Receipts − refunds",
  "finance.source": "Source: {name}",
  "finance.period": "Period: {start} — {end}",
  "finance.asOf": "Updated: {at}",
  "finance.serviceEstimate": "Service value estimate",
  "finance.averageServiceEstimate": "Average service estimate per client",
  "finance.reason.no_source": "No verified financial source connected.",
  "finance.reason.unsupported_source": "Source does not verify financial data.",
  "finance.reason.multiple_sources": "Multiple financial sources: consolidation is not configured.",
  "finance.reason.permission_denied": "No access to business financial data.",
  "finance.reason.source_unavailable": "Financial source unavailable.",
  "finance.reason.initial_sync": "Initial period load is incomplete.",
  "finance.reason.no_verified_snapshot": "No verified data for this period.",
  "finance.reason.sync_failed": "Refresh failed.",
  "finance.reason.sync_stopped": "Source refresh stopped.",
  "finance.reason.updating": "Refresh is still in progress.",
  "finance.reason.snapshot_not_refreshed": "Latest refresh did not verify this period.",
  "finance.reason.sync_overdue": "Scheduled refresh is overdue.",
  "analytics.roiStatus.service_price_estimate_not_receipts": "Service prices, not actual receipts",
  "payments.add": "Add payment",
  "payments.client": "Client",
  "payments.deal": "Deal",
  "payments.appointment": "Appointment",
  "payments.link": "Related appointment / deal",
  "payments.standalone": "Standalone payment",
  "payments.amount": "Amount",
  "payments.date": "Payment date and time",
  ...
  "payments.reason": "Refund reason",
  "payments.refund": "Record refund",
  "payments.recordRefund": "Confirm refund",
  "payments.record": "Record payment",
  "payments.refundLimit": "Available to refund: {amount} {currency}",
  "payments.manualNotice": "Manual record of money already received. This is not bank confirmation or a money transfer.",
  "payments.required": "Select or complete this field.",
  "payments.amountInvalid": "Enter a positive amount with up to two decimal places.",
  "payments.dateInvalid": "Enter a date and time no later than now.",
  "payments.checkFields": "Check the fields: data was not saved.",
  "payments.uncertain": "Submission result is unconfirmed. Retry checks the same operation without creating a duplicate.",
  "payments.discardTitle": "Close form?",
  "payments.discardText": "Unsaved data will be lost.",
  "payments.uncertainClose": "The payment may have been saved. Retry is recommended. If you close, check the journal before entering the payment again.",
  "payments.discard": "Close",
  "payments.search": "Search by client",
  "payments.noMatches": "No matches",
  "payments.kind": "Operations",
  "payments.all": "All operations",
  "payments.receipt": "Receipt",
  "payments.refundKind": "Refund",
  "payments.saved": "Operation recorded.",
  "payments.empty": "No payments found",
  "payments.emptyText": "Add a received payment or adjust the filters.",
  "payments.source": "Source",
  "payments.manual": "Entered manually",
  "payments.integration": "Integration",
  "payments.actor": "Recorded by / at",
  "payments.refunded": "Refunded",
  "payments.pagination": "Payment journal pages",
  "payments.count": "Operations: {count}",
  "payments.next": "Next",
  ...ru,
  "business.navigationLabel": "Business navigation",
  "services.statusActive": "Active",
  "services.metricsLabel": "Key service metrics",
  "services.statusInactive": "Inactive",
  "services.statusArchived": "Archived",
  "services.archivedOnly": "Archived",
  "services.actionOpen": "Open",
  "services.actionActivate": "Activate",
  "services.actionDeactivate": "Deactivate",
  "services.actionDelete": "Delete",
  "services.actionArchive": "Archive",
  "services.actionRestore": "Restore",
  "services.actionMenuLabel": "Actions for service “{name}”",
  "services.deactivateTitle": "Deactivate service?",
  "services.deactivateDescription": "“{name}” will remain in the list and history, but it will no longer be available for new bookings.",
  "services.deleteTitle": "Delete service?",
  "services.deleteDescription": "“{name}” will move to the archive. Booking history will be preserved and a business leader can restore the service.",
  "services.archiveTitle": "Archive service?",
  "services.archiveDescription": "“{name}” will move to the archive. Booking history will be preserved and a business leader can restore the service.",
  "services.archiveReason": "Reason (optional)",
  "services.archiveReasonPlaceholder": "For example: this service is no longer offered",
  "services.noticeActivated": "Service activated and available for new bookings.",
  "services.noticeDeactivated": "Service deactivated and hidden from new booking choices.",
  "services.noticeArchived": "Service moved to the archive.",
  "services.noticeRestored": "Service restored as inactive.",
  "services.archivedReadOnlyTitle": "Service is archived",
  "services.archivedReadOnlyText": "Settings are view-only. Restore the service from the actions menu before editing or activating it.",
  "automations.runFailureSummary": "Automation failed",
  "automations.runFailureDetails": "The run did not complete. Review the rule conditions and retry the run.",
  "platform.operations.failureRecorded": "A failure was recorded. Open the merchant card for further review.",
  ...
  "mfa.codePlaceholder": "000000 or recovery code",
  ...
  "mfa.sessionExpiredText": "Start sign-in again to receive a new secure verification.",
  "mfa.backToLogin": "Back to sign-in",
  "mfa.accountEyebrow": "Account security",
  "mfa.accountTitle": "Two-factor protection",
  "mfa.accountText": "Owners and administrators verify sign-in with an authenticator code. These controls apply only to your account.",
  "mfa.enabled": "Protection enabled",
  "mfa.required": "Setup required",
  "mfa.notEnabled": "Not enabled",
  "mfa.method": "Method",
  "mfa.recoveryRemaining": "Recovery codes",
  "mfa.activeSessions": "Active sessions",
  "mfa.setup": "Set up MFA",
  "mfa.newRecoveryCodes": "New recovery codes",
  "mfa.revokeSessions": "End other sessions",
  ...
  "auth.loginHeroTime": "one sign-in",
  "auth.signupHeroText": "Leads, deals, appointments and conversations stay in one workspace.",
  "auth.loginHeroText": "Continue working with leads, deals, appointments and conversations.",
  "auth.featureCrmTitle": "Unified CRM",
  "auth.featureCrmText": "Clients, leads, deals and tasks without scattered spreadsheets.",
  "auth.featureAiTitle": "Controlled AI",
  "auth.featureAiText": "Suggestions use CRM data and important actions require confirmation.",
  "auth.featureBotsTitle": "Conversations in one place",
  "auth.featureBotsText": "The team sees each request, owner and next step.",
  "auth.featureIntegrationsTitle": "Business connections",
  "auth.featureIntegrationsText": "Channel and service status is visible in the workspace.",
  "auth.proofText": "Daily team work without unnecessary technical complexity.",
  "auth.trustSecurity": "Protected session",
  "auth.trustServers": "Business data is isolated",
  "auth.previewWelcome": "Today's work",
  "auth.previewScanned": "Business state updated",
  "auth.previewNewLeads": "New leads",
  "auth.previewBookings": "Appointments",
  "auth.previewRevenue": "Revenue",
  "auth.previewPipeline": "Deal pipeline",
  "auth.previewAiTip": "AI suggestion",
  "auth.previewConversion": "Conversion",
  "auth.signInAppCopy": "Sign in to continue working in the CRM.",
  "auth.emailDivider": "or sign in with email",
  "auth.emailPlaceholder": "Your login",
  "auth.passwordPlaceholder": "Enter your password",
  "auth.invalidCredentials": "Incorrect email or password.",
  "auth.loginUnavailable": "Sign-in could not be completed. Check server availability and try again.",
  ...
  "invite.existingAccount": "This email already has an account. Sign in to that account to accept the invitation without changing its password.",
  "invite.signInToAccept": "Sign in to accept",
  "invite.wrongAccount": "This invitation belongs to another account. Sign in with the invited email address.",
  ...
  "dashboard.businessScopeNeedsProcess": "Whole business · needs processing",
  "dashboard.teamScopeOpenFollowups": "Whole team · in progress",
  "dashboard.teamOpenTasks": "Team open tasks",
  "dashboard.noTeamOpenTasks": "No open team tasks",
  "dashboard.noTeamOpenTasksText": "Incomplete tasks for all team members will appear here.",
  ...
  "dashboard.connectorHealth": "Connector health",
  ...
  "dashboard.ownerBriefFallbackSource": "CRM record",
  "dashboard.ownerBrief.staleLead.title": "Contact: {source}",
  "dashboard.ownerBrief.staleLead.text":
    "The lead is unassigned or has not been updated recently.",
  "dashboard.ownerBrief.overdueTask.title": "Close task: {source}",
  "dashboard.ownerBrief.overdueTask.text":
    "The task is past due and is still open.",
  "dashboard.ownerBrief.unansweredConversation.title":
    "Reply to conversation: {source}",
  "dashboard.ownerBrief.unansweredConversation.text":
    "An inbound message is waiting for a reply or manager handoff.",
  "dashboard.ownerBrief.stalledDeal.title": "Set next step: {source}",
  "dashboard.ownerBrief.stalledDeal.text":
    "The deal is open, but its next step is overdue or missing.",
  "dashboard.ownerBrief.failedConnector.title": "Check connection: {source}",
  "dashboard.ownerBrief.failedConnector.text":
    "The connection needs attention before CRM accepts new data.",
  ...
  "pagination.pageSizeAriaLabel": "Rows per page",
  ...
  "fallback.permission.title": "Section unavailable",
  "fallback.permission.guidance": "Ask the business owner or administrator if you need this access for your work.",
  "fallback.connectivity.offlineTitle": "No connection",
  "fallback.connectivity.reconnectingTitle": "Restoring connection",
  "fallback.fields.title": "Check the form data",
  "fallback.fields.description": "Correct the highlighted fields. The rest of your data will stay in place.",
  "fallback.fields.invalidValue": "Check this value and try again.",
  "fallback.session.title": "Session ended",
  "fallback.recovery.summary": "Support details",
  "fallback.recovery.requestId": "Support reference",
  "fallback.recovery.copy": "Copy",
  "fallback.recovery.copied": "Copied",
  ...
  "workingHours.viewsLabel": "Working hours section",
  ...
  "workingHours.metricsLabel": "Working-hours metrics",
  "workingHours.businessDaysHint": "days with a business-wide working interval",
  "workingHours.resourceSchedulesHint": "resources with their own schedule",
  "workingHours.daysOffHint": "explicit days off across schedules",
  "workingHours.quickToolbarHint": "Applies to the business-wide schedule",
  "workingHours.presetLabel": "Schedule preset",
  "workingHours.applyPresetTitle": "Apply this preset to the business schedule?",
  "workingHours.applyPresetDescription": "The current business week will be replaced with the selected preset.",
  "workingHours.discardChanges": "Discard unsaved schedule changes?",
  "workingHours.businessInspectorSubtitle": "Business-wide schedule used by resources without an individual week",
  "workingHours.resourceInspectorSubtitle": "Individual week for the selected staff member or resource",
  "workingHours.businessSchedule": "Business schedule",
  "workingHours.individualSchedule": "Individual",
  "workingHours.readOnlyTitle": "View only",
  "workingHours.readOnlyText": "Your role can view schedules but cannot change them.",
  "workingHours.workingDay": "Working day",
  "workingHours.businessWeekHint": "Primary availability used for client bookings",
  "workingHours.businessWeekTableLabel": "Business-wide weekly schedule",
  "workingHours.resourceListHint": "Business schedule inheritance and individual weeks",
  "workingHours.searchResources": "Search resources...",
  "workingHours.scheduleFilter": "Filter by schedule type",
  "workingHours.allSchedules": "All schedules",
  "workingHours.resourceScheduleTableLabel": "Staff and resource schedules",
  "workingHours.scheduleMode": "Schedule type",
  "workingHours.workingDays": "Working days",
  "workingHours.openResourceSchedule": "Open schedule: {name}",
  "workingHours.noResourcesFound": "No resources match the selected filters.",
  ...
  "services.statusFilter": "Service status",
  "services.allStatuses": "All statuses",
  "services.activeOnly": "Active",
  "services.inactiveOnly": "Inactive",
  "services.tableLabel": "Services list",
  "services.selectService": "Select service {name}",
  "services.openDetails": "Open settings for service {name}",
  "services.inspectorSubtitle": "Service settings and appointment usage",
  "services.usageTitle": "Appointment usage",
  "services.usageText": "This service is used in {count} appointments in the loaded history.",
  "services.readOnlyTitle": "View-only mode",
  "services.readOnlyText": "Your role cannot change service settings.",
  "services.discardChanges": "Discard unsaved service changes?",
  "services.noResultsTitle": "No services found",
  "services.noResultsText": "Change the search query or clear the status filter.",
  "services.noticeSaved": "Service changes saved.",
  "services.noticeCreated": "Service added.",
  ...
  "resources.typeFilter": "Filter by type",
  "resources.allTypes": "All types",
  "resources.statusFilter": "Filter by status",
  "resources.allStatuses": "All statuses",
  "resources.activeOnly": "Active only",
  "resources.inactiveOnly": "Inactive only",
  "resources.quickCreate": "Quick create",
  "resources.useTemplate": "Create",
  "resources.noResultsTitle": "No resources found",
  "resources.noResultsText": "Change the search or filters to see resources.",
  "resources.selectResource": "Open resource “{name}”",
  "resources.tableLabel": "Team and resources",
  "resources.scheduleState": "Schedule",
  "resources.individualSchedule": "Individual schedule",
  "resources.businessSchedule": "Business schedule",
  "resources.statusActive": "Active",
  "resources.statusInactive": "Inactive",
  "resources.actionOpen": "Open",
  "resources.actionActivate": "Activate",
  "resources.actionDeactivate": "Deactivate",
  "resources.actionMenuLabel": "Actions for resource “{name}”",
  "resources.noticeCreated": "Resource created",
  "resources.noticeSaved": "Resource changes saved",
  "resources.noticeActivated": "Resource activated",
  "resources.noticeDeactivated": "Resource deactivated",
  "resources.deactivateTitle": "Deactivate resource?",
  "resources.deactivateDescription": "Resource “{name}” will be unavailable for new bookings.",
  "resources.discardChanges": "Close the resource and discard unsaved changes?",
  "resources.inspectorSubtitle": "Resource settings and schedule",
  "resources.readOnlyTitle": "View only",
  "resources.readOnlyText": "Your role cannot change resources. Ask the business owner for access.",
  "resources.usageTitle": "Booking usage",
  "resources.usageText": "Bookings using this resource: {count}.",
  "resources.scheduleTitle": "Working schedule",
  "resources.openSchedule": "Open full schedule",
  "resources.metricsLabel": "Team and resources summary",
  ...
  "conversations.suggestionStatus": "Suggestion",
  ...
  "conversations.deliveryTitle": "Reply delivery",
  "conversations.deliveryStatusQueued": "queued",
  "conversations.deliveryStatusSending": "sending",
  "conversations.deliveryStatusDelivered": "accepted by channel",
  "conversations.deliveryStatusDelayed": "delayed",
  "conversations.deliveryStatusRetrying": "retrying",
  "conversations.deliveryStatusFailed": "not delivered",
  "conversations.deliveryHelpQueued": "The reply is saved and waiting to be sent to the channel.",
  "conversations.deliveryHelpSending": "The reply is being sent to the connected channel.",
  "conversations.deliveryHelpDelivered": "The channel confirmed that it accepted the reply.",
  "conversations.deliveryHelpDelayed": "An automatic retry has been scheduled.",
  "conversations.deliveryHelpRetrying": "The system is retrying delivery.",
  "conversations.deliveryHelpFailed": "The reply was not delivered, but the message is kept in history.",
  "conversations.deliveryAttempts": "Attempts: {attempts} of {max}",
  "conversations.retryDelivery": "Retry delivery",
  "conversations.deliveryRetryNotAllowed": "A role with conversation update permission is required to retry delivery.",
  ...
  "analytics.wonValueHint": "Deal amounts, not actual receipts",
  ...
  "businessForm.slug": "Workspace address",
  ...
  "aiAgents.section.profile": "Profile",
  "aiAgents.section.knowledgeSimple": "Knowledge",
  "aiAgents.section.actions": "Actions",
  "aiAgents.section.test": "Test",
  ...
  "aiAgents.searchPlaceholder": "Search agents",
  "aiAgents.filterStatus": "Filter by status",
  "aiAgents.allStatuses": "All statuses",
  "aiAgents.agentListAria": "AI agents list",
  "aiAgents.purposeMissing": "The profile purpose has not been configured yet.",
  "aiAgents.noMatches": "No agents match the current filters.",
  "aiAgents.totalCount": "Total agents: {count}",
  "aiAgents.editorAria": "Editor for agent {name}",
  "aiAgents.statusSwitch": "Change status for agent {name}",
  "aiAgents.editorTabsAria": "Agent editor sections",
  "aiAgents.unsavedIndicator": "There are unsaved changes.",
  "aiAgents.savedIndicator": "Changes saved.",
  "aiAgents.saveChanges": "Save changes",
  "aiAgents.unsavedTitle": "Unsaved changes",
  "aiAgents.unsavedText": "Unsaved changes will be lost if you switch agents or leave this page.",
  ...
  "aiAgents.status.activeBlocked": "Launch blocked",
  ...
  "deals.stageNew": "New deal",
  "deals.stageQualification": "Qualification",
  "deals.stageProposal": "Proposal",
  "deals.stageNegotiation": "Negotiation",
  "deals.stageWon": "Won",
  "deals.stageLost": "Lost",
  ...
  "deals.sourceOnboarding": "Initial setup",
  ...
  "integrations.import.rowNeedsReview": "Check the data in row {row}.",
  "integrations.import.columnsNeedReview": "Check the required columns in the file.",
  ...
  "dashboard.needReply": "Needs a reply",
  "dashboard.unreadConversationCount": "{count} unread",
  "dashboard.overdueWork": "Overdue work",
  "dashboard.noUnreadConversations": "No conversations need a reply",
  "dashboard.noUnreadConversationsText": "Unread and handoff queues are clear for your access scope.",
  "dashboard.failedConnectors": "Failed connections",
  "dashboard.failedConnectorsText": "{count} connections need recovery",
  "calendar.openTodayTasks": "Open today’s tasks",
  "calendar.emptyDayTitle": "No scheduled work for this day",
  "calendar.emptyDayText": "There are no appointments or due tasks in your access scope.",
  ...
  "conversations.openIntegrations": "Open channel connections",
  "conversations.useSuggestedReply": "Insert suggestion into reply",
  "conversations.nextAction.handoff_sla_overdue": "Operator handoff is overdue",
  "conversations.nextAction.unread_sla_overdue": "Client reply is overdue",
  "conversations.nextAction.review_unread": "Review unread conversations",
  "conversations.nextAction.take_handoffs": "Take conversations from bot",
  "conversations.nextAction.assign_owners": "Assign owners",
  "conversations.nextAction.connect_channel": "Connect a messaging channel",
  "integrations.page.merchantDescription": "Connect channels and external services, check their status and recover data exchange.",
  "integrations.page.merchantRequestText": "This connection requires a request and provider confirmation.",
  ...
  "crmCard.context": "Context",
  "leads.takeInWork": "Take into work",
  "signup.passwordMinCheck": "At least 8 characters",
  "signup.passwordLettersNumbersCheck": "Letters and numbers",
  "signup.passwordNoSpacesCheck": "No spaces",
  "signup.createCompanyTitle": "Create your workspace",
  "signup.createCompanyText": "Add your business details to set up the CRM.",
  "signup.namePlaceholder": "Your name",
  "signup.passwordPlaceholder": "Create a password",
  "signup.businessNamePlaceholder": "Business name",
  "signup.cityPlaceholder": "City",
  "signup.afterSignInHelper": "After registration, you can invite your team and configure workflows.",
  "signup.freeSubmit": "Create account",
  "signup.terms": "By registering, you accept the terms of use and privacy policy.",
  "tasks.status": "Status",
  "tasks.savedNotice": "Changes saved.",
  "tasks.quickActions": "Quick actions",
  "deals.riskPercentShort": "Risk {percent}%",
  "deals.openDealContext": "Open deal “{title}”",
  "leads.selectLeadRowContext": "Select lead “{title}”",
  "leads.openContext": "Open lead “{title}”",
  "leads.callContext": "Call the client for lead “{title}”",
  "leads.whatsappContext": "Message the client in WhatsApp for lead “{title}”",
  "leads.moreActionsContext": "More actions for lead “{title}”",
  "conversations.openClientContext": "Open client “{title}”",
  "integrations.card.configureContext": "Configure {title}",
  "integrations.card.connectContext": "Connect {title}",
  "crmCard.note": "Note",
  "timeline.searchPlaceholder": "Event or client",
  "timeline.category": "Category",
  "timeline.allCategories": "All categories",
  "timeline.actor": "Actor",
  "timeline.actorSelected": "Actor selected",
  "timeline.allActors": "All actors",
  "timeline.noActor": "No actor recorded",
  "timeline.unknownActor": "Name unavailable",
  "timeline.actorSearch": "Search actors",
  "timeline.noActorsFound": "No actors found",
  "timeline.dateFrom": "From date",
  "timeline.dateTo": "Through date",
  "timeline.reset": "Reset filters",
  "timeline.event": "Event",
  "timeline.object": "Client / object",
  "timeline.time": "Time",
  "timeline.details": "Event details",
  "timeline.openDetails": "Open event details",
  "timeline.descriptionLabel": "Changes",
  "timeline.noDetails": "No additional details are available.",
  "timeline.emptyFilteredText": "Change the search or reset filters to see events.",
  "timeline.otherEvent": "Timeline event",
  "timeline.range": "Showing {from}–{to} of {total}",
  "timeline.pageSize": "Events per page",
  "timeline.perPage": "Per {count}",
  "common.edit": "Edit",
  "analytics.detailedReports": "Detailed reports",
  "analytics.detailedReportsHint": "sources, funnel, and services",
  "analytics.dataQuality.estimate_from_completed_appointments": "Service prices for completed appointments, not actual receipts",
  "analytics.roiStatus.tracked_without_cost": "Revenue tracked without cost data",
  "analytics.source.unknown": "Unknown source",
  "analytics.source.manual": "Manual",
  "analytics.source.website": "Website",
  "analytics.source.telegram": "Telegram",
  "analytics.source.whatsapp": "WhatsApp",
  "analytics.action.overdue_handoff.title": "Take overdue handoffs",
  "analytics.action.overdue_handoff.description": "{count} conversations have waited too long for a manager.",
  "analytics.action.missed_chat.title": "Reply to unanswered conversations",
  "analytics.action.missed_chat.description": "{count} assigned conversations still have no reply.",
  "analytics.action.sla_overdue_deal.title": "Review overdue deals",
  "analytics.action.sla_overdue_deal.description": "{count} deals have stayed in a stage longer than expected.",
  "analytics.action.overdue_task.title": "Complete overdue tasks",
  "analytics.action.overdue_task.description": "Overdue tasks: {count}.",
  "aiAgents.channelSetupUnavailable": "The channel setup did not open. Close this window and try connecting again.",
  "aiAgents.agentPickerAria": "Select AI agent",
  "aiAgents.activationBlocked": "Complete the launch requirements before activating the agent.",
  "aiAgents.channelsPermissionDenied": "Your role can edit the agent, but cannot connect or change external channels.",
  "aiAgents.conversationsPermissionDenied": "Your role cannot view conversations used to test this agent.",
  "aiAgents.sectionLoading": "Loading this section...",
  "aiAgents.aiProviderLive": "Reply generated by the configured AI provider",
  "aiAgents.aiProviderMock": "Safe test response: live AI provider is not configured",
  "aiAgents.aiProviderDetails": "Provider: {provider}. Model: {model}.",
  "aiAgents.aiSources": "Sources used for the reply",
  "aiAgents.saveAndContinue": "Save and continue",
  "aiAgents.knowledgeSharedScopeTitle": "Shared business knowledge",
  "aiAgents.knowledge.category.business": "Business",
