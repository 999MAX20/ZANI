...
import { CalendarClock, CheckCircle2, ClipboardList, Download, ExternalLink, FilePenLine, FileText, Image, MessageCircle, MoreHorizontal, Paperclip, Share2, StickyNote, Upload, X, ZoomIn, ZoomOut } from "lucide-react";
    ...
    <div className="space-y-3">
      {Object.entries(grouped).map(([date, events]) => (
        <div key={date} className="space-y-3">
          ...
          {events.map((event) => (
            <div key={event.id} className={drawerSurfaceClass}>
