...
> ARCHIVED 2026-09-14 · CLOSED
>
> Original path: `docs/crm/CRM_IMPLEMENTATION_TASKS.md`. Source: `4ba3cbf9fddcc6e1baa172b494c781550c090693`.
> 232 выполненных пункта; 11 пустых чекбоксов относятся к шаблону Definition of Done, а не к открытому backlog.
