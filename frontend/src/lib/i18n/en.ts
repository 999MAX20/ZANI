...
export const en: Record<string, string> = {
  ...
  "actions.errorValidation": "Check the highlighted fields and try again. {detail}",
  ...
  "actions.errorConflict": "The record changed while you were working. Refresh and try again. {detail}",
