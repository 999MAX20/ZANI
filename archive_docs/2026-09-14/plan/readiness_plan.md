...
>
> Original path: `plan/readiness_plan.md`. Source: `4ba3cbf9fddcc6e1baa172b494c781550c090693`.
> Майский page-based readiness заменён domain-планом, gap register и функциональной сертификацией; не все старые пожелания реализованы.
