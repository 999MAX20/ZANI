...
export const kk: Record<string, string> = {
  ...
  "theme.switchDark": "Қараңғы тақырыпты қосу",
  "theme.switchLight": "Жарық тақырыпты қосу",
  "theme.dark": "Қараңғы",
  "theme.light": "Жарық",
  ...
  "auth.signInAppCopy": "Жұмыс кабинетіне кіріп, өтінімдерді, клиенттерді, боттарды және сатылымдарды басқаруды жалғастырыңыз.",
  ...
  "auth.backToSite": "Сайтқа қайту",
  "auth.brandTagline": "Бизнес өзі жұмыс істейді",
  "auth.alreadyHaveAccount": "Аккаунтыңыз бар ма?",
  "auth.noAccount": "Аккаунт жоқ па?",
  "auth.create": "Құру",
  "auth.heroAria": "ZANI мүмкіндіктері",
  "auth.signupHeroPrefix": "Бизнесіңіз жұмысын бастайды",
  "auth.signupHeroTime": "2 минутта",
  "auth.loginHeroPrefix": "Бизнес басқаруына оралыңыз",
  "auth.loginHeroTime": "1 минутта",
  "auth.signupHeroText": "Аккаунт құрып, CRM, AI-боттар, маркетплейстер, рассылкалар және аналитиканы бір жүйеде алыңыз.",
  "auth.loginHeroText": "Жұмыс кабинетін ашып, сатылымдарды, жазбаларды, рассылкаларды және команданы артық ауысусыз бақылаңыз.",
  "auth.featureCrmTitle": "Тегін CRM",
  "auth.featureCrmText": "Негізгі функцияларға толық қолжетімділік",
  "auth.featureAiTitle": "AI-көмекші",
  "auth.featureAiText": "Талдап, келесі қадамды ұсынады",
  "auth.featureBotsTitle": "Боттар және рассылкалар",
  "auth.featureBotsText": "Жауап береді, жазады және сатады",
  "auth.featureIntegrationsTitle": "Маркетплейстер және интеграциялар",
  "auth.featureIntegrationsText": "Kaspi, Wildberries, Ozon және басқалар",
  "auth.proofText": "CRM, тапсырмалар мен арналар бір кабинетте жұмыс істейді",
  "auth.trustSecurity": "Деректеріңіз қорғалған",
  "auth.trustServers": "Серверлер Қазақстанда",
  "auth.previewWelcome": "Қош келдіңіз, Atlas Dental",
  "auth.previewScanned": "AI кіріс хабарламаларды тексеріп қойды",
  "auth.previewNewLeads": "Жаңа лидтер",
  "auth.previewBookings": "Бүгінгі жазбалар",
  "auth.previewRevenue": "Түсім",
  "auth.previewPipeline": "Сату воронкасы",
  "auth.previewAiTip": "AI 15:00-де акция қосуды ұсынады",
  "auth.previewConversion": "Конверсия үшінші апта қатарынан өсіп жатыр",
  ...
  "signup.progressAria": "Тіркелу қадамдары",
  "signup.accountStep": "Аккаунт",
  "signup.businessStep": "Бизнес",
  "signup.continue": "Жалғастыру",
  "signup.back": "Артқа",
  ...
  "signup.createCompanyTitle": "Компания құру",
  "signup.createCompanyText": "Тегін бастаңыз. Карта қажет емес, маман қажет емес, баптау бірнеше минут алады.",
  "signup.passwordMinCheck": "Кемі 8 таңба",
  "signup.passwordLettersNumbersCheck": "Әріптер және сандар",
  "signup.passwordNoSpacesCheck": "Бос орынсыз",
  "signup.namePlaceholder": "Мысалы: Максим",
  "signup.passwordPlaceholder": "Құпиясөз ойластырыңыз",
  "signup.businessNamePlaceholder": "Мысалы: Atlas Dental",
  "signup.cityPlaceholder": "Алматы",
  "signup.afterSignInHelper": "Кіргеннен кейін қызметкерлерді қосып, арналарды қосыңыз. Қосу батырмасын басып, авторизациядан өтіңіз, жүйе жұмысын бастайды.",
  "signup.freeSubmit": "Компанияны тегін құру",
  "signup.terms": "«Компания құру» батырмасын басу арқылы пайдалану шарттары мен құпиялылық саясатымен келісесіз.",
  ...
  "clients.statusNoReply": "Жауап жоқ",
  "clients.priorityLow": "Төмен",
  "clients.priorityNormal": "Қалыпты",
  "clients.priorityHigh": "Жоғары",
  "clients.priorityUrgent": "Шұғыл",
  "clients.lastContact": "Соңғы байланыс",
  ...
  "clients.tableAria": "Клиенттер тізімі",
  "clients.tableDescription": "Сүзгісі бар клиенттер кестесі. Клиентті таңдау үшін жолда Enter немесе Space басыңыз.",
  "clients.selectAllPage": "Осы беттегінің бәрін таңдау",
  "clients.filterNoReplyWithCount": "Жауап жоқ {count}",
  "clients.filterMine": "Менің клиенттерім",
  "clients.advanced": "Кеңейтілген",
  "clients.filtersAria": "Клиент сүзгілері",
  "clients.clearSearch": "Іздеуді тазалау",
  "clients.noDealsYet": "Әзірге мәміле жоқ.",
  "clients.noDueDate": "Мерзім жоқ",
  "clients.noFilesYet": "Файлдар әлі қосылмаған.",
  "clients.outboundContact": "Шығыс байланыс",
  "clients.inboundContact": "Кіріс байланыс",
  "clients.favorite": "Таңдаулы",
  "clients.dealsCount": "Мәмілелер {count}",
  "clients.tasksCount": "Тапсырмалар {count}",
  "clients.files": "Файлдар",
  "clients.contacts": "Контактілер",
  "clients.latestDeal": "Соңғы мәміле",
  "clients.negotiations": "Келіссөздер",
  "clients.noDealsOpenValue": "Әзірге мәміле жоқ. Ашық: {value}",
  "clients.nextTask": "Келесі тапсырма",
  "clients.viewAll": "Барлығын көру",
  "clients.aiHintTitle": "AI кеңесі",
  "clients.aiHintActive": "Клиент CRM-мен әрекеттескен. Келесі қадам мен байланысты тексеріңіз.",
  "clients.aiHintInactive": "Клиент ұзақ уақыт ұсыныс алған жоқ. Бүгін байланысу ұсынылады.",
  "clients.contactNow": "Қазір байланысу",
  ...
  "tasks.noLinkedEntities": "Тапсырма әзірге клиентке, өтінімге, мәмілеге немесе жазбаға байланыстырылмаған.",
  "tasks.dates": "Күндер",
  ...
  "conversations.emptyText": "WhatsApp, Telegram, Instagram немесе сайт чатын қосыңыз. Жаңа өтініштер осында автоматты түрде пайда болады.",
  "conversations.connectChannel": "Арнаны қосу",
  ...
  "conversations.loadEarlier": "Бұрынғыларды жүктеу",
  ...
  "analytics.label.estimate_from_completed_appointments": "Аяқталған жазбалар бойынша бағалау",
  "analytics.label.tracked_without_cost": "Құнсыз есептеледі",
  "analytics.label.website": "Сайт",
  "analytics.label.manual": "Қолмен",
  ...
  "settings.planChangeRequested": "Тариф ауыстыру сұрауы #{id}",
  "settings.pauseSubscription": "Кідірту",
  "settings.resumeSubscription": "Жалғастыру",
  "settings.cancelSubscription": "Бас тарту",
  "settings.invoicesAndPayments": "Шоттар және төлем",
  "settings.paymentMethod": "Төлем тәсілі",
  "settings.paymentMethodNone": "Таңдалмаған",
  "settings.paymentMethodInvoice": "Төлем шоты",
  "settings.paymentMethodCard": "Банк картасы",
  "settings.paymentMethodBankTransfer": "Банк аударымы",
  "settings.invoiceRecipient": "Шот алушы",
  "settings.legalAddress": "Заңды мекенжай",
  "settings.saveBilling": "Биллингті сақтау",
  "settings.plan": "Тариф",
  "settings.planChangeText": "Тариф ауыстыру қолдау төлем мен лимиттерді тексеруі үшін сұрау ретінде сақталады.",
  ...
  "businessForm.slaMinutes": "Жауап SLA, минут",
  ...
  "businessForm.logoUrl": "Логотип URL",
  ...
  "aiNavigator.source.sale.recorded": "Сату жазылды",
  "aiNavigator.source.excel_csv.sale.recorded": "Excel/CSV · сату",
  "aiNavigator.source.excel_csv.channel_connected": "Excel/CSV арнасы қосылды",
  "aiNavigator.source.website.channel_connected": "Сайт арнасы қосылды",
  "aiNavigator.source.telegram.channel_ready_for_setup": "Telegram баптауға дайын",
  "aiNavigator.source.whatsapp.channel_ready_for_setup": "WhatsApp баптауға дайын",
  ...
  "automations.trigger.botMessageReceived": "Жаңа бот хабарламасы",
  ...
  "deals.noPipelineTitle": "Алғашқы воронканы баптаңыз",
  "deals.noPipeline": "ZANI түсінікті сату үдерісін жасайды: жаңа мәміле, байланыс, ұсыныс, жеңіс немесе бас тарту.",
  "deals.createPipeline": "Стандартты воронка жасау",
  "deals.defaultPipelineName": "Негізгі сатылымдар",
  "deals.pipelineStageNew": "Жаңа",
  "deals.pipelineStageContact": "Байланыстық",
  "deals.pipelineStageProposal": "Ұсыныс",
  "deals.pipelineStageWon": "Төленді",
  "deals.pipelineStageLost": "Бас тарту",
  "deals.pipelineCreated": "Воронка жасалды. Мәмілелерді қосуға болады.",
  ...
  "timeline.category.message": "Хабарлама",
  "timeline.category.appointment": "Жазба",
  "timeline.category.task": "Тапсырма",
  "timeline.category.automation": "Автоматтандыру",
  "timeline.category.system": "Жүйе",
  "timeline.category.crm": "CRM",
  "timeline.eventType.deal_stage_changed": "Мәміле кезеңі өзгерді",
  "timeline.eventType.task_comment_added": "Тапсырмаға пікір қосылды",
  "timeline.eventType.task_reopened": "Тапсырма қайта ашылды",
  "timeline.eventType.task_cancelled": "Тапсырма тоқтатылды",
  "timeline.eventType.task_completed": "Тапсырма аяқталды",
  "timeline.eventType.task_created": "Тапсырма құрылды",
  "timeline.eventType.task_updated": "Тапсырма жаңартылды",
  "timeline.eventType.lead_created": "Өтінім құрылды",
  "timeline.eventType.appointment_created": "Жазба құрылды",
  "timeline.eventType.appointment_rescheduled": "Жазба ауыстырылды",
  "timeline.eventType.message_received": "Хабарлама алынды",
  "timeline.eventType.message_sent": "Хабарлама жіберілді",
  "timeline.eventType.bot_message_received": "Бот хабарламасы алынды",
  ...
  "landing.experience.nav.top": "Басты",
  "landing.experience.nav.pain": "Мәселе",
  "landing.experience.nav.agent": "AI агент",
  "landing.experience.nav.crm": "CRM",
  "landing.experience.nav.marketplace": "Маркетплейстер",
  "landing.experience.nav.ecosystem": "Экожүйе",
  "landing.experience.nav.owner": "Иесі",
  "landing.experience.nav.integrations": "Интеграциялар",
  "landing.experience.nav.proof": "Кейстер",
  "landing.experience.nav.cta": "Бастау",
  "landing.experience.nav.aria": "Негізгі бөлімдер",
  "landing.experience.login": "Кіру",
  "landing.experience.tryFree": "Тегін байқап көру",
  "landing.experience.getCrmFree": "CRM тегін алу",
  "landing.experience.watchHow": "Қалай жұмыс істейтінін көру",
  "landing.experience.today": "Бүгін",
  "landing.experience.person.anna": "Анна Смирнова",
  "landing.experience.channel.whatsapp": "Жаңа клиент",
  "landing.experience.channel.instagram": "Жауап беріңізші",
  "landing.experience.channel.telegram": "Жазба туралы сұрақ",
  "landing.experience.channel.kaspi": "Жаңа сұрақ",
  "landing.experience.channel.ai": "24/7 жауап береді",
  "landing.experience.channel.crm": "Карточка жасалды",
  "landing.experience.channel.reply": "4 секундта",
  ...
  "landing.experience.phone.inbox.instagram": "Сәлеметсіз бе! Бүгін жазылғым келеді.",
  "landing.experience.phone.inbox.telegram": "Сәлем! Бүгін бос уақыт бар ма?",
  "landing.experience.phone.inbox.kaspi": "Сатып алушының жаңа сұрағы",
  "landing.experience.phone.online": "онлайн",
  "landing.experience.phone.chat.client1": "Сәлеметсіз бе! Бүгін жазылуға бола ма?",
  "landing.experience.phone.chat.bot1": "Сәлеметсіз бе. Бүгін 16:30 және 18:00 бар. Қайсысы ыңғайлы?",
  "landing.experience.phone.chat.client2": "16:30 болады",
  "landing.experience.phone.chat.bot2": "Дайын. Сізді 16:30-ға жаздық. Еске салу бір сағат бұрын келеді.",
  "landing.experience.phone.chat.input": "Хабарлама...",
  "landing.experience.phone.dashboard.recommendation": "AI ұсынысы",
  "landing.experience.phone.dashboard.action": "15:00-де рассылка іске қосу",
  "landing.experience.heroFlow.leadTitle": "Жаңа лид",
  "landing.experience.heroFlow.leadText": "Анна Смирнова",
  "landing.experience.heroFlow.bookingTitle": "Жазба жасалды",
  "landing.experience.heroFlow.bookingText": "Бүгін · 16:30",
  "landing.experience.heroFlow.channelsAria": "Сценарий арнасын таңдаңыз",
  "landing.experience.heroFlow.status.waiting": "Клиент хабарламасын күтеміз",
  "landing.experience.heroFlow.status.message": "Хабарлама алынды",
  "landing.experience.heroFlow.status.replied": "ZANI жауап берді",
  "landing.experience.heroFlow.status.lead": "Лид CRM-де жасалды",
  "landing.experience.heroFlow.status.time": "Клиент уақытты таңдады",
  "landing.experience.heroFlow.status.booked": "Жазба 16:30-ға расталды",
  "landing.demo.kicker": "Өзіңіз байқап көріңіз",
  "landing.demo.title": "Ботқа жазыңыз. CRM қатар жиналады",
  "landing.demo.text": "Бір қысқа сценарий ZANI клиентке қалай жауап беретінін, жазба жасайтынын және қызметкерге дайын тапсырма беретінін көрсетеді.",
  "landing.demo.mode.aria": "Демонстрация режимі",
  "landing.demo.mode.guided": "Маған көрсетіңіз",
  "landing.demo.mode.manual": "Өзім көремін",
  "landing.demo.chat.aria": "ZANI ботымен демонстрациялық диалог",
  "landing.demo.chat.welcome": "Сәлеметсіз бе! Уақыт таңдауға және жазылуға көмектесемін.",
  "landing.demo.chat.client": "Бүгін кеңес алуға жазылғым келеді.",
  "landing.demo.chat.slots": "Бүгін 16:30 және 18:00 бос. Қай уақыт ыңғайлы?",
  "landing.demo.chat.confirmed": "Дайын. Жазба жасалды, еске салу бір сағат бұрын келеді.",
  "landing.demo.chat.typing": "ZANI жазып жатыр",
  "landing.demo.chat.quickAppointment": "Бүгін жазылу",
  "landing.demo.chat.quickPrice": "Бағаны білу",
  "landing.demo.chat.guidedHint": "ZANI қалай жұмыс істейтінін көріңіз",
  "landing.demo.chat.greetingReply": "Сәлеметсіз бе! Төмендегі дайын сұрақты таңдаңыз немесе не қажет екенін жазыңыз.",
  "landing.demo.chat.priceReply": "Баға қызметке байланысты. CRM-ге дейінгі толық жолды көру үшін демода жазылуды таңдаңыз.",
  "landing.demo.chat.unknownReply": "Әзірге бұл демонстрациялық диалог. CRM жұмысын көру үшін төмендегі дайын нұсқаны таңдаңыз.",
  "landing.demo.transfer": "деректер CRM-де",
  "landing.demo.crm.aria": "ZANI CRM интерактивті демонстрациясы",
  "landing.demo.crm.live": "бірден жаңарады",
  "landing.demo.crm.ready": "карточка дайын",
  "landing.demo.crm.waiting": "хабарламаны күтеміз",
  "landing.demo.crm.client": "Клиент",
  "landing.demo.crm.newClient": "Жаңа клиент",
  "landing.demo.crm.request": "Не қажет",
  "landing.demo.crm.consultation": "Кеңес",
  "landing.demo.crm.appointment": "Жазба",
  "landing.demo.crm.todayTime": "Бүгін, 16:30",
  "landing.demo.crm.responsible": "Жауапты",
  "landing.demo.crm.manager": "Алексей",
  "landing.demo.crm.notAssigned": "Тағайындалмаған",
  "landing.demo.crm.stage": "Сату кезеңі",
  "landing.demo.crm.stageNew": "Жаңа",
  "landing.demo.crm.stageWork": "Жұмыста",
  "landing.demo.crm.stageBooked": "Жазылды",
  "landing.demo.crm.assign": "Алексейді тағайындау",
  "landing.demo.crm.assigned": "Алексей тағайындалды",
  "landing.demo.crm.createTask": "Тапсырма жасау",
  "landing.demo.crm.taskReady": "Тапсырма жасалды",
  "landing.demo.result.client": "Жаңа клиент",
  "landing.demo.result.appointment": "Жазылу уақыты",
  "landing.demo.result.value": "Күтілетін сома",
  "landing.demo.result.progress": "ZANI диалог барысында нәтижені жинайды",
  "landing.demo.result.complete": "Клиент жазылды. Қызметкер тапсырма алды",
  "landing.demo.result.ownerTitle": "Иесінің нәтижесі",
  "landing.demo.result.progressTitle": "Сценарий орындалуда",
  "landing.demo.repeat": "Қайталау",
  "landing.demo.scenario.aria": "Демонстрацияға арналған бизнес түрі",
  "landing.demo.scenario.label": "Мысал түрі",
  "landing.demo.privacy": "Демо ештеңе жібермейді және сақтамайды",
  "landing.demo.scenario.beauty.welcome": "Сәлеметсіз бе! Қызмет пен ыңғайлы уақытты таңдауға көмектесемін.",
  "landing.demo.scenario.beauty.client": "Бүгін маникюрге жазылғым келеді.",
  "landing.demo.scenario.beauty.slots": "Маникюрге бүгін 16:30 және 18:00 бос. Қай уақыт ыңғайлы?",
  "landing.demo.scenario.beauty.confirmed": "Дайын. Маникюрге жазылдыңыз, еске салу бір сағат бұрын келеді.",
  "landing.demo.scenario.beauty.name": "Анна Смирнова",
  "landing.demo.scenario.beauty.request": "Маникюр",
  "landing.demo.scenario.beauty.manager": "Марина",
  "landing.demo.scenario.beauty.time1": "Бүгін, 16:30",
  "landing.demo.scenario.beauty.time2": "Бүгін, 18:00",
  "landing.demo.scenario.medical.welcome": "Сәлеметсіз бе! Бағытты нақтылап, дәрігер уақытын таңдаймын.",
  "landing.demo.scenario.medical.client": "Стоматолог кеңесі қажет.",
  "landing.demo.scenario.medical.slots": "Стоматолог бүгін 18:00-де және ертең 10:30-да қабылдайды. Қай уақыт ыңғайлы?",
  "landing.demo.scenario.medical.confirmed": "Қабылдау расталды. Алдында қысқа еске салу жібереміз.",
  "landing.demo.scenario.medical.name": "Дмитрий Ким",
  "landing.demo.scenario.medical.request": "Стоматолог кеңесі",
  "landing.demo.scenario.medical.manager": "Айгүл",
  "landing.demo.scenario.medical.time1": "Бүгін, 18:00",
  "landing.demo.scenario.medical.time2": "Ертең, 10:30",
  "landing.demo.scenario.services.welcome": "Сәлеметсіз бе! Тапсырманы нақтылап, бос шеберді табамын.",
  "landing.demo.scenario.services.client": "Кондиционер орнату керек.",
  "landing.demo.scenario.services.slots": "Шебер ертең 11:00-де немесе 15:00-де келе алады. Қай уақыт ыңғайлы?",
  "landing.demo.scenario.services.confirmed": "Сапар жоспарланды. Шебер мекенжай мен тапсырманы алды.",
  "landing.demo.scenario.services.name": "Максим Орлов",
  "landing.demo.scenario.services.request": "Кондиционер орнату",
  "landing.demo.scenario.services.manager": "Алексей",
  "landing.demo.scenario.services.time1": "Ертең, 11:00",
  "landing.demo.scenario.services.time2": "Ертең, 15:00",
  "landing.demo.hint.message": "Хабарлама жазыңыз немесе дайын нұсқаны таңдаңыз",
  "landing.demo.hint.time": "Ыңғайлы уақытты таңдаңыз",
  "landing.demo.hint.assign": "Жауапты қызметкерді тағайындаңыз",
  "landing.demo.hint.task": "Қызметкерге тапсырма жасаңыз",
  "landing.demo.hint.complete": "Дайын: нәтиже иесіне көрінеді",
  "landing.demo.guide.play": "Көрсетілімді жалғастыру",
  "landing.demo.guide.pause": "Көрсетілімді тоқтату",
  "landing.demo.guide.next": "Келесі қадам",
  "landing.demo.mobileTabs.aria": "Демо экрандары",
  "landing.demo.mobileTabs.chat": "Диалог",
  "landing.demo.mobileTabs.crm": "CRM",
  "landing.demo.mobileTabs.result": "Нәтиже",
  "landing.demo.ai.live": "Жауапты AI демо ортада жасады",
  "landing.demo.ai.fallback": "Қауіпсіз демонстрациялық жауап",
  "landing.demo.cta": "Тегін CRM жасау",
  "landing.demo.proof.title": "Жаңа ғана көрген мүмкіндіктер",
  "landing.demo.proof.text": "Өсу туралы уәде мен сәндік сандар жоқ. Тек демонстрацияда көрсетілген мүмкіндіктер.",
  "landing.demo.proof.bot": "Бот үнемі жауап береді",
  "landing.demo.proof.botText": "Әкімші бос емес кезде де диалог жалғасады.",
  "landing.demo.proof.noCodeValue": "Кодсыз",
  "landing.demo.proof.noCode": "Жылдам іске қосу",
  "landing.demo.proof.noCodeText": "Негізгі қосылымға әзірлеуші немесе интегратор қажет емес.",
  "landing.demo.proof.freeCrm": "CRM тегін",
  "landing.demo.proof.freeCrmText": "Клиенттер, мәмілелер, тапсырмалар және команда негізгі CRM-де қолжетімді.",
  "landing.experience.metric.leads": "лид",
  "landing.experience.metric.records": "жазба",
  "landing.experience.metric.newLeads": "жаңа лид",
  "landing.experience.metric.deals": "мәміле",
  "landing.experience.metric.revenue": "түсім",
  "landing.experience.metric.channels": "канал",
  "landing.experience.metric.connected": "қосылған",
  "landing.experience.metric.requestsProcessed": "өтінім өңделді",
  "landing.experience.metric.teamOnline": "қызметкер онлайн",
  "landing.experience.metric.working": "жұмыста",
  "landing.experience.metric.profitToday": "бүгінгі пайда",
  "landing.experience.hero.kicker": "Иесі мен командасы үшін",
  "landing.experience.hero.titlePrefix": "Клиент жазады. ZANI",
  "landing.experience.hero.titleLine1": "Клиент жазады.",
  "landing.experience.hero.titleLine2": "ZANI",
  "landing.experience.hero.titleAccent": "жазбаға жеткізеді",
  "landing.experience.hero.note": "команда бос емес кезде",
  "landing.experience.hero.tryMessage": "Өз хабарламаңызбен байқап көру",
  "landing.experience.hero.text": "ZANI WhatsApp, Instagram, Telegram, Kaspi және сайттан өтінімдерді жинайды, уақытында жауап беруге көмектеседі және иесіне күннің толық көрінісін көрсетеді.",
  "landing.experience.hero.proof": "14 000-нан астам компания ZANI-мен өсіп жатыр",
  "landing.experience.pain.kicker": "Мәселе",
  "landing.experience.pain.title": "Клиенттер баға үшін кетпейді",
  "landing.experience.pain.text": "Команда мессенджер, қоңырау және кесте арасында ауысқанда, клиент басқа жерден жауап алып қояды.",
  "landing.experience.pain.story.client": "Клиент жазды",
  "landing.experience.pain.story.noAnswer": "Жауап жоқ",
  "landing.experience.pain.story.competitor": "Бәсекелесті таңдады",
  "landing.experience.pain.story.money": "Ақша кетті",
  "landing.experience.pain.zani": "ZANI клиент суымай тұрып жауап береді",
  "landing.experience.pain.compact.timer": "жауапсыз",
  "landing.experience.pain.compact.text": "Клиент күтпейді — іздеуді жалғастырады.",
  "landing.experience.pain.compact.action": "ZANI жауабын көру",
  "landing.experience.pain.calendar.record": "10:00 Жазба: Анна",
  "landing.experience.pain.calendar.meeting": "11:30 Кездесу",
  "landing.experience.pain.calendar.callback": "14:00 Клиентке қоңырау",
  "landing.experience.pain.calendar.consult": "16:30 Кеңес",
  "landing.experience.pain.note": "Ештеңе ұмытылмайды!",
  "landing.experience.pain.channelsAria": "Өтінімдер жоғалатын каналдар",
  "landing.experience.agent.kicker": "AI агент",
  "landing.experience.agent.title": "AI клиентті жазбаға дейін жеткізеді",
  "landing.experience.agent.text": "ZANI жай ғана жауап бермейді. Ол нақтылайды, уақыт ұсынады, контактіні сақтайды және командаға дайын нәтиже береді.",
  "landing.experience.agent.ability.reply": "Бірден жауап берді",
  "landing.experience.agent.ability.replyText": "клиент менеджерді күтпейді",
  "landing.experience.agent.ability.details": "Детальдарды нақтылады",
  "landing.experience.agent.ability.detailsText": "қызмет, уақыт және контакт диалогта",
  "landing.experience.agent.ability.record": "Жазба жасады",
  "landing.experience.agent.ability.recordText": "визит пен еске салу өзі пайда болды",
  "landing.experience.agent.ability.return": "Клиентті қайтарды",
  "landing.experience.agent.ability.returnText": "пікір сұрап, келесі қадам ұсынады",
  "landing.experience.agent.cardCreated": "Жаңа жазба жасалды",
  "landing.experience.agent.cardTime": "Бүгін, 16:30 · Кеңес",
  "landing.experience.agent.openCard": "Карточканы ашу",
  "landing.experience.agent.dialog.clientStart": "Сәлеметсіз бе! Бүгін кеңеске жазылғым келеді.",
  "landing.experience.agent.dialog.botSlots": "Сәлеметсіз бе. Бүгін 16:30 және 18:00 бос. Қай уақыт ыңғайлы?",
  "landing.experience.agent.dialog.clientTime": "16:30 болады",
  "landing.experience.agent.dialog.botContact": "Жақсы. Жазбаны растау үшін телефон нөмірін жіберіңіз.",
  "landing.experience.agent.dialog.clientPhone": "+7 777 418 22 10",
  "landing.experience.agent.dialog.botBooked": "Анна, сізді 16:30-ға жаздық. Еске салу бір сағат бұрын келеді.",
  "landing.experience.agent.dialog.autoReminder": "Авто: еске салу 15:30-да жіберіледі",
  "landing.experience.agent.dialog.autoCampaign": "Авто: визиттен кейін пікір сұрау және келесі жазба ұсынысы жіберіледі",
  "landing.experience.agent.modal.close": "Клиент карточкасын жабу",
  "landing.experience.agent.modal.status": "Клиент карточкасы ашылды",
  "landing.experience.agent.modal.contact": "Контакт",
  "landing.experience.agent.modal.source": "Дереккөз",
  "landing.experience.agent.modal.automation": "Автоматтандыру",
  "landing.experience.agent.modal.automationText": "Бір сағат бұрын еске салу, визиттен кейін пікір, 21 күннен кейін қайта жазу.",
  "landing.experience.agent.modal.next": "Келесі қадам",
  "landing.experience.agent.modal.nextText": "Менеджер дайын жазбаны және диалог тарихын көреді.",
  "landing.experience.crm.title": "CRM автоматты түрде пайда болады",
  "landing.experience.crm.text": "Менеджер деректерді қолмен көшірмейді. Хабарлама бір жұмыс терезесінде клиентке, мәмілеге, тапсырмаға және жазбаға айналады.",
  "landing.experience.crm.sidebar.home": "Басты",
  "landing.experience.crm.sidebar.clients": "Клиенттер",
  "landing.experience.crm.sidebar.deals": "Мәмілелер",
  "landing.experience.crm.sidebar.tasks": "Тапсырмалар",
  "landing.experience.crm.flow.message": "Хабарлама",
  "landing.experience.crm.flow.client": "Клиент",
  "landing.experience.crm.flow.deal": "Мәміле",
  "landing.experience.crm.flow.task": "Тапсырма",
  "landing.experience.crm.flow.calendar": "Күнтізбе",
  "landing.experience.crm.flow.payment": "Төлем",
  "landing.experience.crm.card.new": "Жаңа карточка",
  "landing.experience.crm.card.source": "Дереккөз: WhatsApp",
  "landing.experience.crm.card.record": "Бүгінгі жазба, 16:30",
  "landing.experience.crm.tasks.title": "Менеджер тапсырмалары",
  "landing.experience.crm.tasks.confirm": "Жазбаны растау · 5 мин",
  "landing.experience.crm.tasks.remind": "Еске салу жіберу · 45 мин",
  "landing.experience.crm.tasks.review": "Пікір сұрау · визиттен кейін",
  "landing.experience.market.kicker": "Маркетплейстер",
  "landing.experience.market.title": "Маржа мен қалдық қол кестесіз",
  "landing.experience.market.text": "Тапсырыс, қалдық, баға және өзіндік құн ZANI-де бірігеді. AI төмендеуді көріп, бүгін не өзгерту керегін ұсынады.",
  "landing.experience.market.dumping": "Демпинг-бот 24/7",
  "landing.experience.market.dumpingText": "Бәсекелес бағаларын бақылап, оңтайлы баға ұсынады.",
  "landing.experience.market.stock": "Қойма және қалдық",
  "landing.experience.market.stockText": "Қалдық пен өзіндік құн автоматты тартылады.",
  "landing.experience.market.chain.stock": "Қалдық",
  "landing.experience.market.chain.prices": "Бағалар",
  "landing.experience.market.chain.analytics": "Аналитика",
  "landing.experience.market.chain.outreach": "Рассылкалар",
  "landing.experience.ecosystem.kicker": "Экожүйе",
  "landing.experience.ecosystem.title": "Бір диалог. Барлық жұмыс байланысқан",
  "landing.experience.ecosystem.text": "Хабарлама деректерді қайта енгізбей лидке, жазбаға және қызметкер тапсырмасына айналады.",
  "landing.experience.ecosystem.ai": "AI клиенттерге жауап береді",
  "landing.experience.ecosystem.aiText": "Алғашқы жауап, жазба, нақтылау және қайталама сату.",
  "landing.experience.ecosystem.market": "Маркетплейстер жұмыста",
  "landing.experience.ecosystem.marketText": "Kaspi, WB, Ozon, қойма және бағалар бір контурда.",
  "landing.experience.ecosystem.team": "Команда тапсырмаларды көреді",
  "landing.experience.ecosystem.teamText": "Жауаптылар, дедлайндар және клиент тарихы қатар.",
  "landing.experience.owner.kicker": "Иесі",
  "landing.experience.owner.title": "Кабинетті ашасыз. Бәрі тыныш",
  "landing.experience.owner.text": "AI жауап береді. Қызметкерлер тапсырманы көреді. Сату жүріп жатыр. Ақша түседі. Иесі әр менеджерге қоңырау шалмай-ақ күнді түсінеді.",
  "landing.experience.owner.control": "Бәрі бақылауда",
  "landing.experience.owner.controlText": "Клиенттер, сатулар, тапсырмалар және тәуекелдер бірден көрінеді.",
  "landing.experience.owner.growth": "Өсу түсінікті",
  "landing.experience.owner.growthText": "AI қай жерде көбірек табыс табуға болатынын көрсетеді.",
  "landing.experience.integrations.kicker": "Интеграциялар",
  "landing.experience.integrations.title": "Логотип емес. Дерек жүретін желі",
  "landing.experience.integrations.text": "Каналдар, қойма, жарнама, пошта және телефония бір жұмыс көрінісіне байланысады.",
  "landing.experience.integration.moysklad": "МойСклад",
  "landing.experience.integration.telephony": "Телефония",
  "landing.experience.proof.kicker": "Дәлел",
  "landing.experience.proof.title": "Аз сөз. Көрінетін нәтиже",
  "landing.experience.proof.repeat": "қайталама сатудың өсуі",
  "landing.experience.proof.missed": "жоғалған өтінімдер",
  "landing.experience.proof.connectTime": "15 мин",
  "landing.experience.proof.connect": "алғашқы қосылуға дейін",
  "landing.experience.proof.salon": "Қызмет салоны",
  "landing.experience.proof.medical": "Медициналық орталық",
  "landing.experience.proof.retail": "Ритейл",
  "landing.experience.proof.quoteRepeat": "Клиенттер еске салу мен жеке ұсыныстардан кейін қайта келеді.",
  "landing.experience.proof.quoteMissed": "Администратор бос болмаса да, AI бірден жауап береді.",
  "landing.experience.proof.quoteConnect": "Арналар интеграторсыз және ұзақ енгізусіз қосылды.",
  "landing.experience.cta.titlePrefix": "Тегін CRM-нен бастап,",
  "landing.experience.cta.titleAccent": "жұмыс процесін баптаңыз",
  "landing.experience.cta.text": "Банк картасынсыз кабинет жасаңыз. Арналар мен команда ZANI ішінде қосылады.",
  "landing.experience.proof.noCardValue": "Картасыз",
  "landing.experience.proof.noCard": "Еркін бастау",
  "landing.experience.proof.noCardText": "Кабинет жасау үшін төлем деректері қажет емес.",
  "landing.experience.proof.demoValue": "Браузерде",
  "landing.experience.proof.demo": "Тексерілетін сценарий",
  "landing.experience.proof.demoText": "Диалогты, CRM-ді және нәтижені осы бетте тексеруге болады.",
  "landing.experience.cta.email": "E-mail",
  "landing.experience.cta.noCard": "Карта жоқ",
  "landing.experience.cta.fastStart": "Жылдам старт",
  "landing.experience.cta.freeCrm": "CRM тегін",
  "landing.experience.footer.text": "Коммуникация, сату, маркетплейстер және команда бақылауына арналған AI-экожүйе.",
  "landing.experience.footer.aria": "Төменгі навигация",
  "landing.experience.footer.rights": "© 2026 ZANI. Барлық құқықтар қорғалған.",
};
