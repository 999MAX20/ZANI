    ...
    <Modal title={t("deals.createModalTitle")} open={open} onClose={onClose}>
      ...
      >
        ...
        <Select
          value={form.client}
          onChange={(event) =>
            onFormChange({ ...form, client: event.target.value })
          }
          options={[
        ...
        <Select
          ...
          onChange={(event) =>
            onFormChange({ ...form, pipeline: event.target.value, stage: "" })
          }
        ...
        <Select
          value={form.stage}
          onChange={(event) =>
            onFormChange({ ...form, stage: event.target.value })
          }
          options={[
      ...
      {actionFlow ? (
        ...
        >
          ...
          {actionFlow.type === "won" ? (
            ...
            <Input
              label={t("deals.lossReason")}
              value={draft.lost_reason}
              onChange={(event) =>
                onDraftChange({ ...draft, lost_reason: event.target.value })
              }
              required
            />
          )}
    ...
    >
      {deal ? (
        ...
        >
          ...
          />
          <Input
            label={t("deals.deadline")}
            type="datetime-local"
            value={draft.due_at}
            onChange={(event) =>
              onDraftChange({ ...draft, due_at: event.target.value })
            }
            required
          />
          <div className="grid gap-3 sm:grid-cols-2">
            <Select
              ...
              onChange={(event) =>
                onDraftChange({ ...draft, assignee: event.target.value })
              }
              options={[
