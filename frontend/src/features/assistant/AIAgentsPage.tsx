    ...
    <div className="mx-auto grid w-full max-w-[1320px] gap-6 xl:grid-cols-[300px_minmax(0,1fr)]">
      <aside className="rounded-card border border-slate-200 bg-white p-4 shadow-card">
        <div className="mb-4 flex items-center justify-between gap-3">
          <div>
            <p className="text-xs font-black uppercase tracking-[0.18em] text-ai-700">{t("aiAgents.eyebrow")}</p>
              ...
              <div key={bot.id} className="rounded-2xl">
                <Link
                  ...
                  className={cn(
                    ...
                    active ? "bg-ai-50 text-ai-700" : "text-slate-700 hover:bg-slate-50 hover:text-midnight",
                  )}
                >
                  <span className={cn("grid h-8 w-8 shrink-0 place-items-center rounded-xl", active ? "bg-ai-600 text-white" : "bg-slate-100 text-slate-500")}>
                    <Bot size={17} />
                  </span>
                      ...
                      return (
                        <Link
                          ...
                          className={cn(
                            ...
                            sectionActive ? "bg-ai-50 text-ai-700" : "text-slate-600 hover:bg-slate-50 hover:text-midnight",
                          )}
                        >
                          <Icon size={16} />
        ...
        <div className="mb-5 flex flex-col gap-4 border-b border-slate-200 pb-5 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <div className="mt-3 flex flex-wrap items-center gap-2 text-sm font-bold text-zani-muted">
              <Link to="/app/ai-agents" className="hover:text-ai-700">{t("aiAgents.title")}</Link>
              {selectedBot ? (
                <>
